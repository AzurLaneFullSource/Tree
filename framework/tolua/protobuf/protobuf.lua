...
local var12 = require("protobuf.wire_format")
local var13 = require("protobuf.type_checkers")
local var14 = require("protobuf.encoder")
local var15 = require("protobuf.decoder")
local var16 = require("protobuf.listener")
local var17 = require("protobuf.containers")
local var18 = require("protobuf.descriptor").FieldDescriptor
local var19 = require("protobuf.text_format")
...
local function var31(arg0)
	...
	if arg0.cpp_type == var18.CPPTYPE_MESSAGE then
		...
		return function(arg0)
			result = var2._concrete_class()

			result._SetListener(arg0._listener_for_children)
...
local function var38(arg0, arg1)
	constant_name = arg0.name:upper() .. "_FIELD_NUMBER"
	arg1._member[constant_name] = arg0.number
...
local function var46(arg0, arg1)
	...
	function arg1._member.HasField(arg0, arg1)
		...
		if field.cpp_type == var18.CPPTYPE_MESSAGE then
			value = arg0._fields[field]

			return value ~= nil and value._is_present_in_parent
		else
			return arg0._fields[field] ~= nil
		end
	end
end
		...
		for iter2, iter3 in arg1._member.ListFields(arg0) do
			if iter2.cpp_type == var18.CPPTYPE_MESSAGE then
				if iter2.is_extension then
					name = var8.format("(%s)", iter2.full_name)
				else
					name = iter2.name
				end
				...
				if iter2.label == var18.LABEL_REPEATED then
					for iter4, iter5 in var4(iter3) do
						prefix = var8.format("%s[%d].", name, iter4)
						sub_errors = iter5:FindInitializationErrors()

						for iter6, iter7 in var4(sub_errors) do
							var0[#var0 + 1] = prefix .. iter7
						end
					end
				else
					prefix = name .. "."
					sub_errors = iter3:FindInitializationErrors()

					for iter8, iter9 in var4(sub_errors) do
						var0[#var0 + 1] = prefix .. iter9
					end
				end
			end
		end
	...
	function arg0._member.MergeFrom(arg0, arg1)
		...
		for iter0, iter1 in var5(arg1._fields) do
			if iter0.label == var0 or iter0.cpp_type == var1 then
				field_value = var0[iter0]

				if field_value == nil then
					field_value = iter0._default_constructor(arg0)
					var0[iter0] = field_value
				end

				field_value:MergeFrom(iter1)
			else
