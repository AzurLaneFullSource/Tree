...
function PrintTable(arg0_13)
	...
	local function var1_13(arg0_14, arg1_14)
		...
		if #var0_14 == 0 then
			...
			return string.format("{\n%s\n%s}", table.concat(var0_14, "\n"), arg1_14)
		end
	end

	return var1_13(arg0_13, "")
end
...
local function var8_0(arg0_35, arg1_35)
	return arg0_35 ~= nil and type(arg0_35) == arg1_35
end

function injectClassProcess(arg0_36, arg1_36, arg2_36)
	local var0_36 = setmetatable({
		__index = function(arg0_37, arg1_37)
			local var0_37 = rawget(arg0_37, "class")

			if var8_0(arg1_36[arg1_37], "function") then
				return var0_37[arg1_37]
			elseif var8_0(var0_37[arg1_37], "function") then
				return function(...)
					return arg2_36(var0_37[arg1_37], ...)
				end
			else
				local var1_37 = rawget(arg0_37, arg1_37)
	...
	setmetatable(arg0_36, var0_36)
end

function cloneRawTableFormClass(arg0_39)
	local var0_39 = {}
	local var1_39 = getmetatable(arg0_39)

	setmetatable(arg0_39, nil)

	for iter0_39, iter1_39 in pairs(arg0_39) do
		var0_39[iter0_39] = iter1_39
	end

	setmetatable(arg0_39, var1_39)

	return var0_39
end

function noEmptyStr(arg0_40)
	if arg0_40 and arg0_40 == "" then
		return nil
	else
		return arg0_40
	end
