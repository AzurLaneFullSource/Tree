		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_1)
					...
					return Vector3(math.sin(var0_1) * 2, 0.75, math.cos(var0_1) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_3)
					...
					return Vector3(math.sin(var0_3) * 2, 0.75, math.cos(var0_3) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_5)
					...
					return Vector3(math.sin(var0_5) * 2, 0.75, math.cos(var0_5) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_7)
					...
					return Vector3(math.sin(var0_7) * 2, 0.75, math.cos(var0_7) * 2)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_9)
					...
					return Vector3(math.sin(var0_9) * 2, 0.75, math.cos(var0_9) * 2)
				end,
