	...
	effect_list = {
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_1)
					...
					return Vector3(math.sin(var0_1) * 3, 0.75, math.cos(var0_1) * 5)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_3)
					...
					return Vector3(math.sin(var0_3) * 3, 0.75, math.cos(var0_3) * 5)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg0_5)
					...
					return Vector3(math.sin(var0_5) * 3, 0.75, math.cos(var0_5) * 5)
				end,
