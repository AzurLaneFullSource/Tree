return {
	...
	events = {
		...
		},
		{
			...
			style = {
				text = "Lora's personality is already showing changes based on the choice you just made.",
				mode = 2,
				dir = -1,
				char = 1,
				posY = 0,
		...
		},
		{
			...
			style = {
				text = "When the personality value enters the red range, Lora will be Outgoing. When it enters the blue range, she'll be Shy.",
				mode = 2,
				dir = -1,
				char = 1,
				posY = 0,
