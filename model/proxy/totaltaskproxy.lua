...
function var0_0.register(arg0_1)
	...
	arg0_1:on(20202, function(arg0_3)
		for iter0_3, iter1_3 in ipairs(arg0_3.info) do
			...
			local var3_3 = getProxy(ActivityProxy):getActivityById(var0_3)

			arg0_1:sendNotification(ActivityProxy.ACTIVITY_UPDATED, var3_3:clone())
		end
	...
	arg0_1:on(20203, function(arg0_4)
		for iter0_4, iter1_4 in ipairs(arg0_4.info) do
			...
			local var3_4 = getProxy(ActivityProxy):getActivityById(var0_4)

			arg0_1:sendNotification(ActivityProxy.ACTIVITY_UPDATED, var3_4:clone())
		end
	...
	arg0_1:on(20204, function(arg0_5)
		for iter0_5, iter1_5 in ipairs(arg0_5.info) do
			...
			local var3_5 = getProxy(ActivityProxy):getActivityById(var0_5)

			arg0_1:sendNotification(ActivityProxy.ACTIVITY_UPDATED, var3_5:clone())
		end
