...
function var0_0.addSkin(arg0_9, arg1_9)
	...
	if ShipSkin.IsChangeSkin(arg1_9.id) then
		arg0_9.changeSkinGroupDic[ShipSkin.GetChangeSkinGroupId(arg1_9.id)] = true
	end
...
function var0_0.addExpireTimer(arg0_11, arg1_11)
	...
	local function var0_11()
		...
		underscore.each(var0_12:CanUseShareSkinPhantoms(arg1_11.id), function(arg0_13)
			if arg0_13:getSkinId() == arg1_11.id then
				var0_12:updateShipSkin(arg0_13.id, arg0_13.phantomId, arg0_13:getConfig("skin_id"))
			end
		end)
...
function var0_0.hasSkin(arg0_16, arg1_16)
	if ShipSkin.IsChangeSkin(arg1_16) then
		local var0_16 = ShipSkin.GetChangeSkinGroupId(arg1_16)

		return arg0_16.changeSkinGroupDic[var0_16]
	end
...
function var0_0.GetAllSkinForShip(arg0_35, arg1_35)
	...
	for iter5_35 = #var1_35, 1, -1 do
		local var7_35 = var1_35[iter5_35]
		local var8_35 = ShipSkin.GetChangeSkinGroupId(var7_35.id)

		if var8_35 then
			local var9_35 = ShipSkin.GetStoreChangeSkinId(var8_35, arg1_35:GetShipPhantomMark())

			if not var9_35 then
				if var7_35.change_skin.index ~= 1 then
					print("没有缓存的id ，" .. "移除了id" .. var7_35.id)
					table.remove(var1_35, iter5_35)
				end
			elseif var9_35 ~= var7_35.id then
				print("有缓存的id = " .. var9_35 .. "移除了id" .. var7_35.id)
				table.remove(var1_35, iter5_35)
			end
		end
	end
...
function var0_0.GetAllSkinForARCamera(arg0_38, arg1_38)
	...
	for iter6_38 = #var0_38, 1, -1 do
		local var6_38 = var0_38[iter6_38]

		if var6_38 and var6_38.change_skin and var6_38.change_skin.index and var6_38.change_skin.index ~= 1 then
			table.remove(var0_38, iter6_38)
		end
	end
...
function var0_0.GetEncoreSkins(arg0_41)
	local var0_41 = {}
	local var1_41 = getProxy(ActivityProxy):getActivitiesByType(ActivityConst.ACTIVITY_TYPE_PT_BUFF)

	local function var2_41(arg0_42)
	...
	for iter0_41, iter1_41 in ipairs(var1_41) do
		if iter1_41:getDataConfig("type") == 5 and not var2_41(iter1_41) then
			for iter2_41, iter3_41 in ipairs(iter1_41:getConfig("config_data")) do
				table.insert(var0_41, iter3_41)
			end
		end
	end

	local var3_41 = getProxy(ActivityProxy):getActivitiesByType(ActivityConst.ACTIVITY_TYPE_SKIN_COUPON_COUNTING)

	for iter4_41, iter5_41 in ipairs(var3_41) do
		if iter5_41 and not iter5_41:isEnd() then
			for iter6_41, iter7_41 in ipairs(iter5_41:getConfig("config_data")[2]) do
				if not table.contains(var0_41, iter7_41) then
					table.insert(var0_41, iter7_41)
				end
			end
		end
	end
...
function var0_0.GetInTimeSkins(arg0_49)
	local var0_49 = arg0_49:GetAllSkins()

	for iter0_49 = #var0_49, 1, -1 do
		local var1_49 = var0_49[iter0_49]

		if var1_49.type == Goods.TYPE_SKIN then
			if var1_49:getConfig("time") == "always" then
				table.remove(var0_49, iter0_49)
			end
		elseif var1_49.type == Goods.TYPE_ACTIVITY_EXTRA and pg.activity_shop_extra[var1_49.id].shop_tag ~= 1 then
			table.remove(var0_49, iter0_49)
		end
	end
...
function var0_0.GetPermanentSkins(arg0_50)
	local var0_50 = arg0_50:GetAllSkins()

	for iter0_50 = #var0_50, 1, -1 do
		local var1_50 = var0_50[iter0_50]

		if var1_50.type == Goods.TYPE_SKIN then
			if var1_50:getConfig("time") ~= "always" then
				table.remove(var0_50, iter0_50)
			end
		elseif var1_50.type == Goods.TYPE_ACTIVITY_EXTRA then
			if pg.activity_shop_extra[var1_50.id].shop_tag ~= 2 then
				table.remove(var0_50, iter0_50)
			end
		elseif var1_50.type == Goods.TYPE_ACTIVITY then
			table.remove(var0_50, iter0_50)
		end
	end
