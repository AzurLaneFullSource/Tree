local var0 = class("GoldResourceField", import(".BaseResourceField"))
...
function var0.Ctor(arg0, arg1)
	...
	table.insert(arg0.attrs, ResourceFieldLevelProductAttr.New(var0, i18n("class_label_goldfield"), "production", 1))
end
