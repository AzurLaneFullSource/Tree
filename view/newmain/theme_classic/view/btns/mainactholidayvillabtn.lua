local var0_0 = class("MainActHolidayVillaBtn", import(".MainBaseActivityBtn"))
...
function var0_0.CustomOnClick(arg0_4)
	...
	if getProxy(ActivityProxy):getActivityById(var0_4) then
		if not pg.NewStoryMgr.GetInstance():IsPlayed("JIARIBIESHUCHOUBEIZHONG5") then
			arg0_4:emit(NewMainMediator.SKIP_ACTIVITY, tonumber(arg0_4.config.param[2]))
		else
			arg0_4:emit(NewMainMediator.GO_SCENE, arg0_4.config.param[1])
		end
	end
end
