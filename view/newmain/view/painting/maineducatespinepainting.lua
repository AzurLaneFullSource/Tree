local var0_0 = class("MainEducateSpinePainting", import(".MainSpinePainting"))
local var1_0
...
function var0_0.OnDisplayWorld(arg0_17, arg1_17)
	...
	if expressionAnimName ~= "" then
		arg0_17.spinePainting:SetAction(var0_17, 1)
		arg0_17.spinePainting:displayWord(true)
	end
end
...
function var0_0.CollectIdleEvents(arg0_23, arg1_23)
	...
	if getProxy(EventProxy):hasFinishState() and arg1_23 ~= "event_complete" then
		...
		if #var0_23 == 0 then
			var0_23 = arg0_23:FilterExistEvents(var1_0.GetShipMainEvents(arg0_23.ship:getSkinId(), arg0_23.ship:getCVIntimacy()))
...
function var0_0.FilterExistEvents(arg0_24, arg1_24)
	...
	for iter0_24, iter1_24 in pairs(arg1_24) do
		local var1_24 = pg.AssistantInfo.GetAssistantEvents(iter1_24)
...
function var0_0.CollectTouchEvents(arg0_25)
	return (arg0_25:FilterExistEvents(var1_0.GetShipTouchEvents(arg0_25.ship:getSkinId(), arg0_25.ship:getCVIntimacy())))
end
