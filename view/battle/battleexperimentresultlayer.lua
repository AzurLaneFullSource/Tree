...
function var0_0.displayBG(arg0_3)
	...
	setActive(arg0_3._bg:Find("jieuan01/Bomb"), false)
end
...
function var0_0.displayShips(arg0_6)
	...
	for iter6_6, iter7_6 in ipairs(var3_6) do
		...
		if var2_6[iter7_6.id] then
			...
			local var12_6 = table.contains(ShipType.SubShipType, var11_6)
			local var13_6
			local var14_6
			local var15_6 = 0
			local var16_6
			...
			local var19_6 = var17_6:Find("result/mask/icon")
			local var20_6 = var17_6:Find("result/type")
