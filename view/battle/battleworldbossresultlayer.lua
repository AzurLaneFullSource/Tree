...
function var0_0.displayShips(arg0_28)
	...
	for iter4_28, iter5_28 in ipairs(var5_28) do
		...
		if var2_28[iter5_28.id] then
			...
			local var13_28 = table.contains(ShipType.SubShipType, var12_28)
			local var14_28
			local var15_28
			local var16_28 = 0
			local var17_28
...
function var0_0.willExit(arg0_72)
	...
	if arg0_72._atkBG.gameObject.activeSelf then
		pg.UIMgr.GetInstance():UnOverlayPanel(arg0_72._blurConatiner, arg0_72._tf)
	end
	...
	pg.UIMgr.GetInstance():UnOverlayPanel(arg0_72._tf)
