...
function var0_0.NeedCloseCamera(arg0_1)
	return arg0_1 ~= SYSTEM_BOSS_RUSH and arg0_1 ~= SYSTEM_BOSS_RUSH_EX and arg0_1 ~= SYSTEM_ACT_BOSS and arg0_1 ~= SYSTEM_WORLD_BOSS and arg0_1 ~= SYSTEM_BOSS_SINGLE and arg0_1 ~= SYSTEM_BOSS_SINGLE_VARIABLE
end
...
local function var7_0(arg0_15)
	...
	local var3_15 = var1_15:GetFleetIds()
	local var4_15 = var3_15[var2_15]

	if var1_15:GetMode() == BossRushSeriesData.MODE.SINGLE then
		var4_15 = var3_15[1]
	end

	local var5_15 = getProxy(FleetProxy):getActivityFleets()[var0_15][var4_15]

	return (getProxy(BayProxy):getShipsByFleet(var5_15))
end
...
function var0_0.GetNewMainShips(arg0_18)
	...
	elseif var0_18 == SYSTEM_GUILD then
		var1_18 = var6_0()
	elseif var0_18 == SYSTEM_BOSS_RUSH or var0_18 == SYSTEM_BOSS_RUSH_EX then
