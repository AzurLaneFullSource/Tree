...
function var0_0.OnLoaded(arg0_2)
	arg0_2.uilist = UIItemList.New(arg0_2._tf:Find("window/sliders/scrollrect/content"), arg0_2._tf:Find("window/sliders/scrollrect/content/tpl"))
end
...
function var0_0.OnDestroy(arg0_10)
	pg.UIMgr.GetInstance():UnOverlayPanel(arg0_10._tf, pg.UIMgr.GetInstance()._normalUIMain)
end
