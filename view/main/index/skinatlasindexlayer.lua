local var0 = class("SkinAtlasIndexLayer", import("...common.CustomIndexLayer"))

var0.ExtraL2D = bit.lshift(1, 0)
var0.ExtraDBG = bit.lshift(1, 1)
var0.ExtraBG = bit.lshift(1, 2)
var0.ExtraBGM = bit.lshift(1, 3)
var0.ExtraCANTUSE = bit.lshift(1, 4)
var0.ExtraUNUSE = bit.lshift(1, 5)
var0.ExtraIndexs = {
	var0.ExtraL2D,
	var0.ExtraDBG,
	var0.ExtraBG,
