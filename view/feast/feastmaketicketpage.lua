...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.finishTr = arg0_2._tf:Find("finish")
	...
	arg0_2.failedTip = arg0_2._tf:Find("failed_tip")
	arg0_2.descTr = arg0_2._tf:Find("desc_panel")
	...
	arg0_2.tipTopTr = arg0_2._tf:Find("tip")

	setText(arg0_2._tf:Find("tip/Text"), i18n("feast_label_make_ticket_tip"))
	setText(arg0_2._tf:Find("tip/label"), i18n("feast_label_make_ticket_click_tip"))
	setText(arg0_2._tf:Find("failed_tip/Text"), i18n("feast_label_make_ticket_failed_tip"))
end
...
function var0_0.HideDesc(arg0_35)
	...
	pg.UIMgr.GetInstance():UnOverlayPanel(arg0_35.descTr, arg0_35._tf)
...
function var0_0.ClearEvent(arg0_37, arg1_37)
	...
	local var1_37 = arg1_37:GetComponentsInChildren(typeof(Image)):ToTable()

	for iter0_37, iter1_37 in ipairs(var1_37) do
		iter1_37.raycastTarget = false
	end
end
