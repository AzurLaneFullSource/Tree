...
function var0_0.init(arg0_3)
	arg0_3.listTF = arg0_3:findTF("list")
	arg0_3.mainTF = arg0_3:findTF("main")
	arg0_3.closeBtn = arg0_3:findTF("closeBtn")
	arg0_3.noMsgTF = arg0_3:findTF("list/bg/no_msg")
	arg0_3.scrollBarTF = arg0_3:findTF("list/bg/scroll_bar")
	arg0_3.list = arg0_3:findTF("list/bg/scrollrect"):GetComponent("LScrollRect")
	arg0_3.mainBg = arg0_3:findTF("main/left_panel/bg")
	arg0_3.imageTF = arg0_3:findTF("main/left_panel/mask/Image"):GetComponent(typeof(Image))
	arg0_3.likeBtn = arg0_3:findTF("main/left_panel/heart")
	arg0_3.bubbleTF = arg0_3:findTF("main/left_panel/bubble")
	arg0_3.planeTF = arg0_3:findTF("main/left_panel/plane")
	arg0_3.likeCntTxt = arg0_3:findTF("main/left_panel/zan"):GetComponent(typeof(Text))
	arg0_3.pushTimeTxt = arg0_3:findTF("main/left_panel/time"):GetComponent(typeof(Text))
	arg0_3.iconTF = arg0_3:findTF("main/right_panel/top/head/icon")
	arg0_3.nameTxt = arg0_3:findTF("main/right_panel/top/name"):GetComponent(typeof(Text))
	arg0_3.centerTF = arg0_3:findTF("main/right_panel/center")
	arg0_3.contentTxt = arg0_3:findTF("main/right_panel/center/Text/Text"):GetComponent(typeof(Text))
	arg0_3.commentList = UIItemList.New(arg0_3:findTF("main/right_panel/center/bottom/scroll/content"), arg0_3:findTF("main/right_panel/center/bottom/scroll/content/tpl"))
	arg0_3.commentPanel = arg0_3:findTF("main/right_panel/last/bg2")
	arg0_3.optionalPanel = arg0_3:findTF("main/right_panel/last/bg2/option")
	arg0_3.scroll = arg0_3:findTF("main/right_panel/center/bottom/scroll")

	if arg0_3.contextData.tf then
		SetParent(arg0_3._tf, arg0_3.contextData.tf)
	end

	setText(arg0_3:findTF("main_bg/Text"), i18n("dorm3d_privatechat_topics"))
