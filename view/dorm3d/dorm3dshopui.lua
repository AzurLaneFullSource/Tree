...
function var0_0.SetGiftCard(arg0_25)
	...
	if var1_25.type == 1 then
		...
		updateDorm3dIcon(arg0_25:findTF("Dorm3dIconTpl", var0_25), var9_25)
	...
	elseif var1_25.type == 2 then
		...
		updateDorm3dIcon(arg0_25:findTF("Dorm3dIconTpl", var0_25), var12_25)
		...
		if arg0_42 == UIItemList.EventInit then
			...
			onToggle(arg0_41, arg2_42, function(arg0_43)
				...
				onButton(arg0_41, arg0_41.mask, function()
					setActive(arg2_42:Find("icon/select"), false)
					setActive(arg2_42:Find("icon/unselect"), true)
					setActive(arg2_42:Find("bubble"), false)
					setActive(arg0_41.mask, false)
				end, SFX_PANEL)
			end)
		end
	end)
