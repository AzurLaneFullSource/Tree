...
function var0_0.OnLoaded(arg0_2)
	arg0_2.titleTxt = arg0_2._tf:Find("frame/title/text"):GetComponent(typeof(Text))
	arg0_2.iconImg = arg0_2._tf:Find("frame/title/icon"):GetComponent(typeof(Image))
	arg0_2.closeBtn = arg0_2._tf:Find("frame/btnBack")
	arg0_2.descTxt = arg0_2._tf:Find("frame/content/describe/class"):GetComponent(typeof(Text))
	arg0_2.levelTxt = arg0_2._tf:Find("frame/title/icon/current"):GetComponent(typeof(Text))
	arg0_2.currentLevelTxt = arg0_2._tf:Find("frame/content/info/level/curr"):GetComponent(typeof(Text))
	arg0_2.nextLevelTxt = arg0_2._tf:Find("frame/content/info/level/next"):GetComponent(typeof(Text))
	arg0_2.costTxt = arg0_2._tf:Find("frame/content/upgrade_btn/cost"):GetComponent(typeof(Text))
	arg0_2.spendTimeTxt = arg0_2._tf:Find("frame/upgrade_duration/Text"):GetComponent(typeof(Text))
	arg0_2.upgradeBtn = arg0_2._tf:Find("frame/content/upgrade_btn")
	arg0_2.upgradingBtn = arg0_2._tf:Find("frame/content/upgrading_block")
	arg0_2.attrUIlist = UIItemList.New(arg0_2._tf:Find("frame/content/info/conent"), arg0_2._tf:Find("frame/content/info/conent/tpl"))

	setText(arg0_2.upgradeBtn:Find("Image"), i18n("word_levelup"))
	setText(arg0_2.upgradingBtn:Find("Image"), i18n("class_label_upgrading"))
	setText(arg0_2._tf:Find("frame/content/upgrade_btn/costback/label"), i18n("text_consume"))
	setText(arg0_2._tf:Find("frame/upgrade_duration/Image/Text"), i18n("class_label_upgradetime"))
end
