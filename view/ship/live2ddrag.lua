...
function var0_0.onListenerTrigger(arg0_3, arg1_3, arg2_3)
	if arg1_3 == Live2D.ON_ACTION_DRAG_CLICK then
...
function var0_0.onEventCallback(arg0_22, arg1_22, arg2_22, arg3_22)
	if arg1_22 == Live2D.EVENT_ACTION_APPLY then
		local var0_22 = {}
		local var1_22
		local var2_22 = false
		local var3_22
	...
	elseif arg1_22 == Live2D.EVENT_ACTION_ABLE then
		-- block empty
	elseif arg1_22 == Live2D.EVENT_CHANGE_IDLE_INDEX then
		print("change idle")
	elseif arg1_22 == Live2D.EVENT_GET_PARAMETER then
		arg2_22.callback = arg3_22
	elseif arg1_22 == Live2D.EVENT_GET_DRAG_PARAMETER then
		arg2_22.callback = arg3_22
	elseif arg1_22 == Live2D.EVENT_GET_WORLD_POSITION then
		arg2_22.callback = arg3_22
	elseif arg1_22 == Live2D.EVENT_GAME_XIAQI then
		arg2_22.callback = arg3_22
	end
...
function var0_0.isApplyStopDrag(arg0_25)
	if arg0_25.actionTrigger and arg0_25.actionTrigger.type == Live2D.DRAG_MOVE_DOWN_UP then
		return false
	end
...
function var0_0.updateParameterUpdateFlag(arg0_37)
	if arg0_37.actionTrigger.type == Live2D.DRAG_CLICK_ACTION then
		arg0_37._parameterUpdateFlag = true
	elseif arg0_37.actionTrigger.type == Live2D.DRAG_RELATION_IDLE then
	...
	elseif arg0_37.actionTrigger.type == Live2D.DRAG_DOWN_TOUCH then
		arg0_37._parameterUpdateFlag = true
	elseif arg0_37.actionTrigger.type == Live2D.DRAG_LISTENER_EVENT then
		arg0_37._parameterUpdateFlag = true
	elseif arg0_37.actionTrigger.type == Live2D.DRAG_ANIMATION_PLAY then
		arg0_37._parameterUpdateFlag = true
	elseif arg0_37.actionTrigger.type == Live2D.DRAG_WITH_PARAMETER_MOVE then
		arg0_37._parameterUpdateFlag = true
	elseif arg0_37.actionTrigger.type == Live2D.DRAG_MOVE_DOWN_UP then
		arg0_37._parameterUpdateFlag = true
	elseif arg0_37.actionTrigger.type == Live2D.DRAG_GAME_XIAQI then
		arg0_37._parameterUpdateFlag = true
	else
		arg0_37._parameterUpdateFlag = false
	end
...
function var0_0.changeParameComAble(arg0_38, arg1_38)
	...
	if arg1_38 then
		arg0_38:onEventCallback(Live2D.EVENT_ADD_PARAMETER_COM, {
			com = arg0_38._parameterCom,
			start = arg0_38.startValue,
			mode = arg0_38.mode
		})
	else
		arg0_38:onEventCallback(Live2D.EVENT_REMOVE_PARAMETER_COM, {
			com = arg0_38._parameterCom,
			mode = arg0_38.mode
		})
	end
...
function var0_0.updateCircleDrag(arg0_40)
	...
	if arg0_40._active and arg0_40.mouseWorld ~= nil then
		if not arg0_40.circleDragWorld then
			arg0_40:onEventCallback(Live2D.EVENT_GET_WORLD_POSITION, {
...
function var0_0.updateTrigger(arg0_52)
	...
	if var0_52 == Live2D.DRAG_TIME_ACTION then
		if arg0_52._active then
			if var3_52 and math.abs(arg0_52.parameterValue - var3_52) < math.abs(var3_52) * 0.25 then
				...
				if var2_52 < arg0_52.triggerActionTime and not arg0_52.l2dIsPlaying then
					arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_53)
						if arg0_53 then
							arg0_52:onEventNotice(Live2D.ON_ACTION_DRAG_TRIGGER)
						end
					end)
				end
			else
	...
	elseif var0_52 == Live2D.DRAG_CLICK_ACTION then
		if arg0_52:checkClickAction() then
			arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_54)
				arg0_52:onEventNotice(Live2D.ON_ACTION_DRAG_CLICK)
			end)
		end
	elseif var0_52 == Live2D.DRAG_CLICK_RANGE then
		if arg0_52:checkClickAction() then
			...
			arg0_52:onEventCallback(Live2D.EVENT_GET_PARAMETER, {
				name = var4_52
			}, function(arg0_55)
	...
	elseif var0_52 == Live2D.DRAG_DOWN_ACTION then
		if arg0_52._active then
			...
			if var2_52 <= Time.time - arg0_52.mouseInputDownTime and not arg0_52.l2dIsPlaying then
				...
				arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_57)
					if arg0_57 then
						arg0_52:onEventNotice(Live2D.ON_ACTION_DOWN)
					end
				end)
		...
		elseif arg0_52.actionTrigger.last and arg0_52.actionListIndex ~= 1 then
			...
			arg0_52:setAbleWithFlag(false)
			arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_58)
				return
			end)
	...
	elseif var0_52 == Live2D.DRAG_RELATION_XY then
		if arg0_52._active then
			...
			if math.abs(var6_52 - var8_52) <= math.abs(var8_52) * 0.25 and math.abs(var7_52 - var9_52) <= math.abs(var9_52) * 0.25 then
				...
				if var2_52 < arg0_52.triggerActionTime and not arg0_52.l2dIsPlaying then
					arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_59)
						if arg0_59 then
							arg0_52:onEventNotice(Live2D.ON_ACTION_XY_TRIGGER)
						end
					end)
				end
			else
	...
	elseif var0_52 == Live2D.DRAG_RELATION_IDLE then
	...
	elseif var0_52 == Live2D.DRAG_CLICK_MANY then
		if arg0_52:checkClickAction() then
			arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY)
		end
	elseif var0_52 == Live2D.DRAG_LISTENER_EVENT then
		if arg0_52._listenerTrigger then
			arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY)
		end
	elseif var0_52 == Live2D.DRAG_DOWN_TOUCH then
	...
	elseif var0_52 == Live2D.DRAG_CLICK_PARAMETER then
		if arg0_52:checkClickAction() then
			...
			arg0_52:onEventCallback(Live2D.EVENT_GET_PARAMETER, {
				...
				if math.abs(var14_52 - arg0_60) <= 0.05 then
					...
					arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_61)
						arg0_52:onEventNotice(Live2D.ON_ACTION_DRAG_CLICK)
					end)
				end
			end)
		end
	elseif var0_52 == Live2D.DRAG_ANIMATION_PLAY then
		...
		if arg0_52.stateInfo:IsName(var16_52) and arg0_52.l2dIdleIndex == arg0_52.actionTrigger.trigger_index then
			...
			if var17_52 and arg0_52.normalTime >= arg0_52.actionTrigger.trigger_rate and not arg0_52.animationPlayApply then
				arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function()
					return
				end)
				arg0_52:setTriggerActionFlag(false)
	...
	elseif var0_52 == Live2D.DRAG_EXTEND_ACTION_RULE then
		if not arg0_52.extendActionFlag then
			arg0_52.extendActionFlag = true
		end
	elseif var0_52 == Live2D.DRAG_WITH_PARAMETER_MOVE then
		if not arg0_52.l2dIsPlaying then
			...
			if var3_52 and var21_52 <= var22_52 and not arg0_52.parameterMoveTrigger then
				...
				arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_64)
					return
				end)
			else
	...
	elseif var0_52 == Live2D.DRAG_MOVE_DOWN_UP then
		...
		if arg0_52._active and arg0_52.actionTrigger.active == 1 then
			if not arg0_52.dragMoveUp and arg0_52.parameterValue > var27_52[1] and arg0_52.parameterValue <= var27_52[2] then
				...
				arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_66)
					return
				end)
			end
		elseif arg0_52.firstStop and arg0_52.actionTrigger.active == 0 then
			arg0_52:onEventCallback(Live2D.EVENT_GET_PARAMETER, {
				...
				if arg0_67 > var27_52[1] and arg0_67 <= var27_52[2] then
					arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_68)
						return
					end)
				end
			end)
	...
	elseif var0_52 == Live2D.DRAG_GAME_XIAQI then
		if arg0_52:checkClickAction() then
			arg0_52:onEventCallback(Live2D.EVENT_GAME_XIAQI, {
	...
	elseif var0_52 == Live2D.DRAG_GAME_XIAQI_RESULT and arg0_52.commonData and arg0_52.commonData[Live2D.COMMON_XIAQI_RESULT] ~= nil and (arg0_52.actionTrigger.win == 1 and true or false) == arg0_52.commonData[Live2D.COMMON_XIAQI_RESULT] then
		arg0_52:onEventCallback(Live2D.EVENT_ACTION_APPLY, nil, function(arg0_70)
			if arg0_70 then
				arg0_52:setTriggerActionFlag(false)
				arg0_52:setCommonData(Live2D.COMMON_XIAQI_RESULT, nil)
			end
		end)
	end
end

function var0_0.setCommonData(arg0_71, arg1_71, arg2_71)
	arg0_71.commonData[arg1_71] = arg2_71
end

function var0_0.getExtendAction(arg0_72)
	return arg0_72.extendActionFlag
end

function var0_0.checkActionInExtendFlag(arg0_73, arg1_73)
	local var0_73 = false
	local var1_73 = false

	if not arg0_73.extendActionFlag then
		return var0_73, var1_73
	end

	local var2_73 = arg0_73.actionTrigger.parameter
	local var3_73 = arg0_73.actionTrigger.num
	local var4_73 = false

	arg0_73:onEventCallback(Live2D.EVENT_GET_DRAG_PARAMETER, {
		name = var2_73
	}, function(arg0_74)
		if arg0_74 > var3_73[1] and arg0_74 <= var3_73[2] then
			var4_73 = true
		end
	end)

	if not var4_73 then
		return var0_73, var0_73
	end

	local var5_73 = arg0_73.actionTriggerActive.ignore
	local var6_73 = arg0_73.actionTriggerActive.enable

	if var5_73 and table.contains(var5_73, arg1_73) then
		var0_73 = true
	end

	if var6_73 and table.contains(var6_73, arg1_73) then
		var1_73 = true
	end
...
function var0_0.setAbleWithFlag(arg0_75, arg1_75)
	if arg0_75.ableFlag ~= arg1_75 then
		arg0_75.ableFlag = arg1_75

		arg0_75:onEventCallback(Live2D.EVENT_ACTION_ABLE, {
			ableFlag = arg1_75
		})
	end
end

function var0_0.triggerAction(arg0_76)
	arg0_76.nextTriggerTime = arg0_76.limitTime

	arg0_76:setTriggerActionFlag(true)
end

function var0_0.isActionTriggerAble(arg0_77)
	if arg0_77.actionTrigger.type == nil then
		return false
	end

	if not arg0_77.actionTrigger or arg0_77.actionTrigger == "" then
		return false
	end

	if arg0_77.nextTriggerTime - Time.deltaTime >= 0 then
		arg0_77.nextTriggerTime = arg0_77.nextTriggerTime - Time.deltaTime

		return false
	end

	if arg0_77.isTriggerAtion then
		return false
	end
...
function var0_0.updateStateData(arg0_78, arg1_78)
	if arg0_78.l2dIdleIndex ~= arg1_78.idleIndex then
		if type(arg0_78.revertIdleIndex) == "boolean" and arg0_78.revertIdleIndex == true then
			arg0_78:setTargetValue(arg0_78.startValue)
		elseif type(arg0_78.revertIdleIndex) == "table" and table.contains(arg0_78.revertIdleIndex, arg1_78.idleIndex) then
			arg0_78:setTargetValue(arg0_78.startValue)
		end
	end

	arg0_78.lastActionIndex = arg0_78.actionListIndex

	if arg1_78.isPlaying and arg0_78.actionTrigger.reset_index_action and arg1_78.actionName and table.contains(arg0_78.actionTrigger.reset_index_action, arg1_78.actionName) then
		arg0_78.actionListIndex = 1
	end

	if arg0_78.revertActionIndex and arg0_78.lastActionIndex ~= arg0_78.actionListIndex then
		arg0_78:setTargetValue(arg0_78.startValue)
	end

	arg0_78.l2dIdleIndex = arg1_78.idleIndex
	arg0_78.l2dIsPlaying = arg1_78.isPlaying
	arg0_78.l2dIgnoreReact = arg1_78.ignoreReact
	arg0_78.l2dPlayActionName = arg1_78.actionName

	if not arg0_78.l2dIsPlaying and arg0_78.isTriggerAtion then
		arg0_78:setTriggerActionFlag(false)
	end

	if arg0_78.l2dIdleIndex and arg0_78.idleOn and #arg0_78.idleOn > 0 then
		arg0_78.reactConditionFlag = not table.contains(arg0_78.idleOn, arg0_78.l2dIdleIndex)
	end

	if arg0_78.l2dIdleIndex and arg0_78.idleOff and #arg0_78.idleOff > 0 then
		arg0_78.reactConditionFlag = table.contains(arg0_78.idleOff, arg0_78.l2dIdleIndex)
	end
end

function var0_0.checkClickAction(arg0_79)
	if arg0_79.firstActive then
		if arg0_79.actionTrigger.down then
			...
			arg0_79:setAbleWithFlag(true)
		end
	elseif arg0_79.firstStop then
		local var0_79 = math.abs(arg0_79.mouseInputUp.x - arg0_79.mouseInputDown.x) < 30 and math.abs(arg0_79.mouseInputUp.y - arg0_79.mouseInputDown.y) < 30
		local var1_79 = arg0_79.mouseInputUpTime - arg0_79.mouseInputDownTime < 0.5
	...
	elseif arg0_79.clickTriggerTime and arg0_79.clickTriggerTime > 0 and Time.realtimeSinceStartup >= arg0_79.clickTriggerTime then
		...
		if Time.realtimeSinceStartup - arg0_79.clickTriggerTime <= 0.5 then
...
function var0_0.saveData(arg0_80)
	local var0_80 = arg0_80.id
	local var1_80 = arg0_80.live2dData.skinId
	local var2_80 = arg0_80.live2dData.ship.id

	if arg0_80.revert == -1 and arg0_80.saveParameterFlag then
		Live2dConst.SaveDragData(var0_80, var1_80, var2_80, arg0_80.parameterTargetValue)
	end

	if arg0_80.actionTrigger.type == Live2D.DRAG_CLICK_MANY then
		Live2dConst.SetDragActionIndex(var0_80, var1_80, var2_80, arg0_80.actionListIndex)
	end

	if arg0_80._relationFlag then
		Live2dConst.SetRelationData(var0_80, var1_80, var2_80, arg0_80:getRelationSaveData())
	end
end

function var0_0.getActionTriggerType(arg0_81)
	if arg0_81.actionTrigger and arg0_81.actionTrigger.type then
		return arg0_81.actionTrigger.type
	end

	return nil
end

function var0_0.loadData(arg0_82)
	local var0_82 = arg0_82.id
	local var1_82 = arg0_82.live2dData:GetShipSkinConfig().id
	local var2_82 = arg0_82.live2dData.ship.id

	if arg0_82.revert == -1 and arg0_82.saveParameterFlag then
		local var3_82 = Live2dConst.GetDragData(arg0_82.id, arg0_82.live2dData:GetShipSkinConfig().id, arg0_82.live2dData.ship.id)

		if var3_82 then
			arg0_82:setParameterValue(var3_82)
			arg0_82:setTargetValue(var3_82)
		end

		if var3_82 == arg0_82.startValue and arg0_82._relationParameterList and #arg0_82._relationParameterList > 0 then
			arg0_82:clearRelationValue()
		end
	end

	if arg0_82.actionTrigger.type == Live2D.DRAG_CLICK_MANY then
		arg0_82.actionListIndex = Live2dConst.GetDragActionIndex(arg0_82.id, arg0_82.live2dData:GetShipSkinConfig().id, arg0_82.live2dData.ship.id) or 1
	end

	if arg0_82._relationFlag then
		local var4_82 = Live2dConst.GetRelationData(var0_82, var1_82, var2_82)

		arg0_82.offsetDragX = var4_82.drag_x and var4_82.drag_x or arg0_82.startValue
		arg0_82.offsetDragY = var4_82.drag_y and var4_82.drag_y or arg0_82.startValue
	end
end

function var0_0.getRelationSaveData(arg0_83)
	return {
		[Live2dConst.RELATION_DRAG_X] = arg0_83.offsetDragX,
		[Live2dConst.RELATION_DRAG_Y] = arg0_83.offsetDragY
	}
end

function var0_0.clearRelationValue(arg0_84)
	if arg0_84._relationParameterList and #arg0_84._relationParameterList > 0 then
		for iter0_84 = 1, #arg0_84._relationParameterList do
			local var0_84 = arg0_84._relationParameterList[iter0_84]

			if var0_84.data.type == Live2D.relation_type_drag_x or var0_84.data.type == Live2D.relation_type_drag_y then
				var0_84.value = var0_84.start or arg0_84.startValue or 0
				var0_84.enable = true
			end

			arg0_84.offsetDragX, arg0_84.offsetDragY = arg0_84.startValue, arg0_84.startValue
		end
	end
end

function var0_0.loadL2dFinal(arg0_85)
	arg0_85.loadL2dStep = true
end

function var0_0.clearData(arg0_86)
	if arg0_86.revert == -1 then
		arg0_86.actionListIndex = 1
		arg0_86.delayTargetTime = nil

		arg0_86:setParameterValue(arg0_86.startValue)
		arg0_86:setTargetValue(arg0_86.startValue)
		arg0_86:clearRelationValue()
	end
end

function var0_0.setTriggerActionFlag(arg0_87, arg1_87)
	arg0_87.isTriggerAtion = arg1_87
end

function var0_0.dispose(arg0_88)
	arg0_88._active = false
	arg0_88._parameterCom = nil
	arg0_88.parameterValue = arg0_88.startValue
