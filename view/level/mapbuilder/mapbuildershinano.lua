...
function var0_0.UpdateCustomButtons(arg0_16)
	local var0_16 = arg0_16.contextData.map
	local var1_16 = var0_16:getConfig("type") == Map.ACT_EXTRA
	local var2_16 = arg0_16._tf:Find("rumeng")
	local var3_16 = arg0_16._tf:Find("huigui")
	...
	if not var1_16 then
		...
		local var4_16 = getProxy(ChapterProxy):getMapById(var0_16.id + 1)
		local var5_16 = getProxy(ChapterProxy):getMapById(var0_16.id - 1)

		setActive(var2_16, var4_16)
		setActive(var3_16, var5_16)
		LeanTween.cancel(go(var2_16), true)
		LeanTween.cancel(go(var3_16), true)

		if var4_16 then
			local var6_16 = tf(var2_16).localScale
			local var7_16 = tf(var2_16):GetChild(0):Find("Quad"):GetComponent(typeof(MeshRenderer)).sharedMaterial
			local var8_16 = var7_16:GetColor("_MainColor")
			local var9_16 = Clone(var8_16)
			local var10_16 = LeanTween.value(go(var2_16), 0, 1, 0.8):setOnUpdate(System.Action_float(function(arg0_17)
				var9_16.a = var8_16.a * arg0_17

				var7_16:SetColor("_MainColor", var9_16)
			end)):setEase(LeanTweenType.easeInCubic):setOnComplete(System.Action(function()
				var7_16:SetColor("_MainColor", var8_16)
			end))

			arg0_16:RecordTween("rumengAlphaTween", var10_16.id)
		elseif var5_16 then
			local var11_16 = tf(var3_16).localScale
			local var12_16 = tf(var3_16):GetChild(0):Find("Quad"):GetComponent(typeof(MeshRenderer)).sharedMaterial
			local var13_16 = var12_16:GetColor("_MainColor")
			local var14_16 = Clone(var13_16)
			local var15_16 = LeanTween.value(go(var3_16), 0, 1, 0.8):setOnUpdate(System.Action_float(function(arg0_19)
				var14_16.a = var13_16.a * arg0_19

				var12_16:SetColor("_MainColor", var14_16)
			end)):setEase(LeanTweenType.easeInCubic):setOnComplete(System.Action(function()
				var12_16:SetColor("_MainColor", var13_16)
			end))

			arg0_16:RecordTween("huiguiAlphaTween", var15_16.id)
		end
	end
end

function var0_0.UpdateMapItems(arg0_21)
	var0_0.super.UpdateMapItems(arg0_21)
...
function var0_0.UpdateMapItem(arg0_27, arg1_27, arg2_27)
	...
	if var23_27 then
		...
		local var26_27 = arg0_27.contextData.map:getConfig("type") == Map.ACTIVITY_HARD and "bonus_us_hard" or "bonus_us"
	...
	onButton(arg0_27, var1_27, function()
		...
		local var0_30 = arg1_27.localPosition

		arg0_27:TryOpenChapterInfo(var28_27, Vector3(var0_30.x - 10, var0_30.y + 150))
	end, SFX_UI_WEIGHANCHOR_SELECT)
end

function var0_0.PlayChapterItemAnimation(arg0_31, arg1_31, arg2_31, arg3_31)
...
function var0_0.PlayChapterItemAnimationBackward(arg0_33, arg1_33, arg2_33, arg3_33)
...
function var0_0.UpdateChapterTF(arg0_35, arg1_35)
...
function var0_0.TryOpenChapter(arg0_36, arg1_36)
	local var0_36 = arg0_36.chapterTFsById[arg1_36]

	if var0_36 then
		local var1_36 = var0_36:Find("main")

		triggerButton(var1_36)
	end
end

function var0_0.HideFloat(arg0_37)
	setActive(arg0_37.itemHolder, false)
end

function var0_0.ShowFloat(arg0_38)
	setActive(arg0_38.itemHolder, true)
end
