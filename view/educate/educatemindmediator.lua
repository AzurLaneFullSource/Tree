local var0 = class("EducateMindMediator", import(".base.EducateContextMediator"))

var0.ON_TASK_SUBMIT = "EducateMindMediator:ON_TASK_SUBMIT"
...
function var0.handleNotification(arg0, arg1)
	...
	if var0 == GAME.EDUCATE_SUBMIT_TASK_DONE then
