...
function var0_0.OnInit(arg0_2)
	...
	arg0_2.blurBg = arg0_2.showPanelTF:Find("panel")
	arg0_2.foldBtn = arg0_2.showPanelTF:Find("fold_btn")
	arg0_2.pageSnap = arg0_2.showPanelTF:Find("panel/event"):GetComponent("HScrollSnap")

	arg0_2.pageSnap:Init()

	arg0_2.page1 = arg0_2.showPanelTF:Find("panel/event/content/page1")

	setText(arg0_2.page1:Find("title/name_title/name"), i18n("child_archive_name"))
	setText(arg0_2.page1:Find("attr_title/Text"), i18n("child_attr_name1"))
	setText(arg0_2.page1:Find("buff_title/Text"), i18n("child_buff_name"))

	arg0_2.avatarImageTF = arg0_2.page1:Find("title/avatar")
	arg0_2.attrsList1 = UIItemList.New(arg0_2.page1:Find("attrs/content"), arg0_2.page1:Find("attrs/tpl"))
	arg0_2.gradientBgTF = arg0_2.page1:Find("attrs/bg_gradient")
	arg0_2.buffContentTF = arg0_2.page1:Find("buff/content")
	arg0_2.buffItemList = UIItemList.New(arg0_2.page1:Find("buff/content/content"), arg0_2.page1:Find("buff/tpl"))
	arg0_2.buffLockTF = arg0_2.page1:Find("buff/lock")
	arg0_2.page2 = arg0_2.showPanelTF:Find("panel/event/content/page2")

	setText(arg0_2.page2:Find("attr_title/Text"), i18n("child_attr_name2"))

	arg0_2.attr3UnlockTF = arg0_2.page2:Find("attrs/unlock")
	arg0_2.attr3LockTF = arg0_2.page2:Find("attrs/lock")
	arg0_2.attrsList2 = UIItemList.New(arg0_2.attr3UnlockTF:Find("content"), arg0_2.attr3UnlockTF:Find("tpl"))
	arg0_2.attr2UnlockTF = arg0_2.page2:Find("nature/unlock")
	arg0_2.attr2LockTF = arg0_2.page2:Find("nature/lock")
	arg0_2.natureContent = arg0_2.attr2UnlockTF:Find("content")
	arg0_2.avatarTF = arg0_2.page2:Find("avatar")
...
function var0_0.updateAttr1Item(arg0_14, arg1_14, arg2_14)
	...
	GetImageSpriteFromAtlasAsync("ui/educatecommonui_atlas", "attr_" .. var0_14, arg2_14:Find("icon_bg/icon"), true)
	setScrollText(arg2_14:Find("name_mask/name"), var1_14.name)

	local var2_14, var3_14 = arg0_14.char:GetAttrInfo(var0_14)

	setText(arg2_14:Find("grade/Text"), var2_14)
	setText(arg2_14:Find("value"), var3_14)
	...
	setImageColor(arg2_14:Find("grade"), Color.NewHex(var5_14))
end

function var0_0.updateBuffItem(arg0_15, arg1_15, arg2_15)
	local var0_15 = arg0_15.buffList[arg1_15 + 1]

	LoadImageSpriteAsync("educateprops/" .. var0_15:getConfig("icon"), arg2_15:Find("icon"))
	setText(arg2_15:Find("time/Text"), var0_15:GetReaminWeek() .. i18n("word_week"))
...
function var0_0.updateAttr2Item(arg0_18, arg1_18, arg2_18)
	...
	GetImageSpriteFromAtlasAsync("ui/educatecommonui_atlas", "attr_" .. var0_18, arg2_18:Find("icon"), true)
	setText(arg2_18:Find("name"), var1_18.name)
	setText(arg2_18:Find("value"), arg0_18.char:GetAttrById(var0_18))
end
...
function var0_0.updateNature(arg0_19)
	for iter0_19, iter1_19 in ipairs(arg0_19.char:GetAttrGroupByType(EducateChar.ATTR_TYPE_PERSONALITY)) do
		...
		setScrollText(var0_19:Find("Text"), arg0_19.config[iter1_19[1]].name .. " " .. iter1_19[2])
	end
end
...
function var0_0.Flush(arg0_20)
	...
	setImageSprite(arg0_20.avatarTF:Find("mask/Image"), LoadSprite("squareicon/" .. var0_20), true)
	setText(arg0_20.page1:Find("title/name/Text"), arg0_20.char:GetName())
	...
	setActive(arg0_20.showPanelTF:Find("pagination"), var4_20)
