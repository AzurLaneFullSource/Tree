...
function var0_0.updateItem(arg0_4, arg1_4, arg2_4)
	...
	if var0_4 then
		...
		setText(arg2_4:Find("unlock/name"), arg1_4.name)
		...
		local var1_4 = arg2_4:Find("lock/conditions")
...
function var0_0.updateConditions(arg0_6, arg1_6, arg2_6)
	...
	for iter0_6 = 1, #arg1_6 do
		...
		if var1_6[1] == EducateConst.DROP_TYPE_ATTR then
			...
			setActive(var2_6:Find("icon/unlock"), var3_6)

			local var5_6 = var3_6 and "F59F48" or "888888"

			setTextColor(var2_6:Find("Text"), Color.NewHex(var5_6))
			setText(var2_6:Find("Text"), var4_6)
		end
	end
...
function var0_0.showPerformWindow(arg0_7, arg1_7)
	local var0_7 = arg0_7.performTF:Find("Image")
	...
	onButton(arg0_7, arg0_7.performTF:Find("review_btn"), function()
