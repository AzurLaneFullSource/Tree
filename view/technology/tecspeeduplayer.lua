...
function var0_0.findUI(arg0_7)
	local var0_7 = arg0_7._tf:Find("Window/top/bg/obtain/title")

	setText(var0_7, i18n("tec_speedup_title"))

	local var1_7 = arg0_7._tf:Find("Window")

	arg0_7.backBtn = var1_7:Find("top/btnBack")
	arg0_7.bg = arg0_7._tf:Find("BG")

	local var2_7 = var1_7:Find("Panel")
	local var3_7 = var2_7:Find("Task")

	arg0_7.taskNameText = var3_7:Find("Name/Text")
	arg0_7.expProgressText = var3_7:Find("ExpProgressText")
	arg0_7.expProgressSlider = var3_7:Find("Slider")
	arg0_7.taskText = var3_7:Find("TaskText")
	arg0_7.progressNumText = var3_7:Find("ProgressNumText")

	local var4_7 = var2_7:Find("ItemPanel")

	arg0_7.itemIcon = var4_7:Find("Item/Icon")
	arg0_7.itemCountText = var4_7:Find("Item/CountText")
	arg0_7.itemNameText = var4_7:Find("NameText")
	arg0_7.minusBtn = var4_7:Find("UsePanel/MinusBtn")
	arg0_7.addBtn = var4_7:Find("UsePanel/AddBtn")
	arg0_7.maxBtn = var4_7:Find("UsePanel/MaxBtn")
	arg0_7.useCountText = var4_7:Find("UsePanel/UseCountText")
	arg0_7.confirmBtn = var1_7:Find("ConfirmBtn")
	arg0_7.helpBtn = var1_7:Find("HelpBtn")
	arg0_7.helpPanel = var1_7:Find("HelpPanel")
	arg0_7.helpText = arg0_7.helpPanel:Find("Text")
