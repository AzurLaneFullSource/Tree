...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.toggle = arg0_2._tf:Find("frame/toggle")
	arg0_2.upgradeList = UIItemList.New(arg0_2._tf:Find("frame/upgrade/content"), arg0_2._tf:Find("frame/upgrade/content/tpl"))
	arg0_2.breakOutList = UIItemList.New(arg0_2._tf:Find("frame/breakout/content"), arg0_2._tf:Find("frame/upgrade/content/tpl"))
	arg0_2.breakoutListPanel = arg0_2._tf:Find("frame/breakout")
	arg0_2.upgradePanel = arg0_2._tf:Find("frame/upgrade")
	arg0_2.inDevelopmentPanel = arg0_2._tf:Find("frame/dev")
	arg0_2.inDevelopmentIcon = arg0_2.inDevelopmentPanel:Find("item/icon"):GetComponent(typeof(Image))
	arg0_2.inDevelopmentName = arg0_2.inDevelopmentPanel:Find("item/name"):GetComponent(typeof(Text))
	arg0_2.inDevelopmentLevel1Txt = arg0_2.inDevelopmentPanel:Find("level1/Text"):GetComponent(typeof(Text))
	arg0_2.inDevelopmentLevel2Txt = arg0_2.inDevelopmentPanel:Find("level2/Text"):GetComponent(typeof(Text))
	arg0_2.inDevelopmentLevel1Desc = arg0_2.inDevelopmentPanel:Find("level1/level/Text"):GetComponent(typeof(Text))
	arg0_2.inDevelopmentLevel2Desc = arg0_2.inDevelopmentPanel:Find("level2/level/Text"):GetComponent(typeof(Text))
	arg0_2.inDevelopmentProgress = arg0_2.inDevelopmentPanel:Find("progress/bar")
	arg0_2.inDevelopmentProgressTxt = arg0_2.inDevelopmentPanel:Find("progress/Text"):GetComponent(typeof(Text))
	arg0_2.donateBtn = arg0_2.inDevelopmentPanel:Find("skin_btn")
	arg0_2.cancelBtn = arg0_2.inDevelopmentPanel:Find("cancel_btn")

	setText(arg0_2.inDevelopmentPanel:Find("level1/level/label"), i18n("guild_tech_label_max_level"))
	setText(arg0_2.inDevelopmentPanel:Find("level2/level/label"), i18n("guild_tech_label_max_level"))
	setText(arg0_2.inDevelopmentPanel:Find("progress/title/Text"), i18n("guild_tech_label_dev_progress"))
	setText(arg0_2.inDevelopmentPanel:Find("progress/title/label"), i18n("guild_tech_label_condition"))
end
