...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.taskTF = arg0_2._tf:Find("TaskPanel")
	arg0_2.taskUnOpenTF = arg0_2._tf:Find("TaskPanel/unopen")
	arg0_2.unOpenAdmin = arg0_2.taskUnOpenTF:Find("select")
	arg0_2.unOpenUnAdmin = arg0_2.taskUnOpenTF:Find("lock")
	arg0_2.taskOpenTF = arg0_2._tf:Find("TaskPanel/open")
	arg0_2.taskDescTxt = arg0_2.taskOpenTF:Find("top/desc/Text"):GetComponent(typeof(Text))
	arg0_2.taskAwardTxt = arg0_2.taskOpenTF:Find("top/desc1/Text"):GetComponent(typeof(Text))
	arg0_2.taskProgressTxt = arg0_2.taskOpenTF:Find("top/progress"):GetComponent(typeof(Text))
	arg0_2.taskProgressBar = arg0_2.taskOpenTF:Find("top/progress_bar")
	arg0_2.privateTaskDesc = arg0_2.taskOpenTF:Find("bottom/desc"):GetComponent(typeof(Text))
	arg0_2.privateTaskGetBtn = arg0_2.taskOpenTF:Find("bottom/get")
	arg0_2.privateTaskAcceptBtn = arg0_2.taskOpenTF:Find("bottom/accept")
	arg0_2.privateTaskProgressTxt = arg0_2.taskOpenTF:Find("bottom/progress/Text"):GetComponent(typeof(Text))
	arg0_2.privateTaskReapeatFlag = arg0_2.taskOpenTF:Find("bottom/reapeat")
	arg0_2.privateTaskResTxt = arg0_2.taskOpenTF:Find("bottom/res/Text"):GetComponent(typeof(Text))
	arg0_2.taskMaskAll = arg0_2._tf:Find("TaskPanel/open/mask_all")
	arg0_2.taskMaskTop = arg0_2._tf:Find("TaskPanel/open/mask_top")
	arg0_2.contributionList = UIItemList.New(arg0_2._tf:Find("TaskPanel/SubmitPanel/list"), arg0_2._tf:Find("TaskPanel/SubmitPanel/list/tpl"))
	arg0_2.contributionCntTxt = arg0_2._tf:Find("TaskPanel/SubmitPanel/cnt/Text"):GetComponent(typeof(Text))
	arg0_2.supplyFrame = arg0_2._tf:Find("TaskPanel/SupplyPanel/frame")
	arg0_2.supplyOpenTF = arg0_2._tf:Find("TaskPanel/SupplyPanel/frame/open")
	arg0_2.supplyOpenTimeTxt = arg0_2.supplyOpenTF:Find("time"):GetComponent(typeof(Text))
	arg0_2.supplyOpenLetfCntTxt = arg0_2.supplyOpenTF:Find("Text"):GetComponent(typeof(Text))
	arg0_2.supplyOpenGetBtn = arg0_2.supplyOpenTF:Find("get")
	arg0_2.supplyOpenGotBtn = arg0_2.supplyOpenTF:Find("got")
	arg0_2.supplyUnOpenTF = arg0_2._tf:Find("TaskPanel/SupplyPanel/frame/unopen")
	arg0_2.supplyUnOpenAdminTF = arg0_2.supplyUnOpenTF:Find("purchase")
	arg0_2.supplyUnOpenResTF = arg0_2.supplyUnOpenAdminTF:Find("Text"):GetComponent(typeof(Text))
	arg0_2.supplyUnOpenLockTF = arg0_2.supplyUnOpenTF:Find("lock")
end
