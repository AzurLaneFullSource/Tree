...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.descTxt = arg0_2._tf:Find("frame/bottom/target/scrollrect/Text"):GetComponent(typeof(Text))
	arg0_2.awardList = UIItemList.New(arg0_2._tf:Find("frame/bottom/award/list"), arg0_2._tf:Find("frame/bottom/award/list/item"))
	arg0_2.titleTxt = arg0_2._tf:Find("frame/title"):GetComponent(typeof(Text))
	arg0_2.goBtn = arg0_2._tf:Find("frame/bottom/go")
	arg0_2.consumeTxt = arg0_2.goBtn:Find("oil/Text"):GetComponent(typeof(Text))
	arg0_2.recomBtn = arg0_2._tf:Find("frame/recom")
	arg0_2.clearBtn = arg0_2._tf:Find("frame/clear")
	arg0_2.grids = arg0_2._tf:Find("frame/double")
	arg0_2.subGrids = arg0_2._tf:Find("frame/single")
	arg0_2.nextBtn = arg0_2._tf:Find("frame/next")
	arg0_2.prevBtn = arg0_2._tf:Find("frame/prev")
	arg0_2._autoToggle = arg0_2._tf:Find("frame/auto_toggle")
	arg0_2._autoSubToggle = arg0_2._tf:Find("frame/sub_toggle")
	arg0_2.commanderPage = GuildCommanderFormationPage.New(arg0_2._tf:Find("frame/commanders"), arg0_2.event, arg0_2.contextData)

	setText(arg0_2.goBtn:Find("oil/label"), i18n("text_consume"))

	arg0_2.flag = arg0_2._tf:Find("frame/double/1/flag")
	arg0_2.subFlag = arg0_2._tf:Find("frame/single/1/flag")
	arg0_2.shipCards = {}
end
