...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.icon = arg0_2._tf:Find("frame/icon"):GetComponent(typeof(Image))
	arg0_2.goBtn = arg0_2._tf:Find("frame/go_btn")
	arg0_2.joinBtn = arg0_2._tf:Find("frame/join_btn")
	arg0_2.descTxt = arg0_2._tf:Find("frame/desc"):GetComponent(typeof(Text))
	arg0_2.consumeTF = arg0_2._tf:Find("frame/consume")
	arg0_2.consumeTxt = arg0_2._tf:Find("frame/consume/Text"):GetComponent(typeof(Text))
	arg0_2.cntTF = arg0_2._tf:Find("frame/cnt")
	arg0_2.cntTxt = arg0_2._tf:Find("frame/cnt/Text"):GetComponent(typeof(Text))
	arg0_2.nameTxt = arg0_2._tf:Find("frame/title/Text"):GetComponent(typeof(Text))
	arg0_2.scaleTxt = arg0_2._tf:Find("frame/title/scale"):GetComponent(typeof(Text))
	arg0_2.scaleCntTxt = arg0_2._tf:Find("frame/title/scale/Text"):GetComponent(typeof(Text))
	arg0_2.progressTF = arg0_2._tf:Find("frame/cnt/progress")
	arg0_2.progressTxt = arg0_2._tf:Find("frame/cnt/progress/Text"):GetComponent(typeof(Text))
	arg0_2.missionList = UIItemList.New(arg0_2._tf:Find("frame/events/icons"), arg0_2._tf:Find("frame/events/icons/tpl"))
	arg0_2.awardList = UIItemList.New(arg0_2._tf:Find("frame/award/displays"), arg0_2._tf:Find("frame/award/displays/item"))

	setText(arg0_2._tf:Find("frame/events/Text"), i18n("guild_word_may_happen_event"))
	setText(arg0_2._tf:Find("frame/award/Text"), i18n("guild_battle_award"))
	setText(arg0_2._tf:Find("frame/consume/label"), i18n("guild_word_consume"))
	setText(arg0_2._tf:Find("frame/cnt/label"), i18n("guild_join_event_cnt_label"))
	setText(arg0_2._tf:Find("frame/cnt/progress/label"), i18n("guild_join_event_progress_label"))
end
