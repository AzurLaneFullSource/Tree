...
function var0_0.OnLoaded(arg0_2)
	arg0_2.eventList = UIItemList.New(arg0_2._tf:Find("eventlist/content"), arg0_2._tf:Find("eventlist/content/tpl"))
	arg0_2.reportBtn = arg0_2._tf:Find("report_btn")
	arg0_2.reportTip = arg0_2.reportBtn:Find("tip")
	arg0_2.reportTipTxt = arg0_2.reportBtn:Find("tip/Text"):GetComponent(typeof(Text))
	arg0_2.formationBtn = arg0_2._tf:Find("formation_btn")
	arg0_2.missionList = arg0_2._tf:Find("missionlist")
	arg0_2.pathContains = arg0_2._tf:Find("missionlist/path")
	arg0_2.tpl = arg0_2:getTpl("tpl", arg0_2.pathContains)
	arg0_2.line = arg0_2._tf:Find("resource/line")
	arg0_2.lineHead = arg0_2._tf:Find("resource/head")
	arg0_2.adapter = arg0_2._tf:Find("resource/adapter")
	arg0_2.bg = arg0_2._tf:Find("bg"):GetComponent(typeof(Image))
	arg0_2.titleTF = arg0_2._tf:Find("title")
	arg0_2.nameTxt = arg0_2._tf:Find("title/Text"):GetComponent(typeof(Text))
	arg0_2.descPanel = arg0_2._tf:Find("missionlist/path/desc_panel")
	arg0_2.descPanelTag = arg0_2.descPanel:Find("Image"):GetComponent(typeof(Image))

	setText(arg0_2._tf:Find("title/timer/label"), i18n("guild_time_remaining_tip"))

	arg0_2.endEventTimerTxt = arg0_2._tf:Find("title/timer/Text"):GetComponent(typeof(Text))
