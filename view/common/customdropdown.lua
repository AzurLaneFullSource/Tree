...
function var0_0.OnInit(arg0_4)
	...
	arg0_4.btnList = {}
	arg0_4.greySprite = arg0_4._tf:Find("resource/grey"):GetComponent(typeof(Image)).sprite
	arg0_4.yellowSprite = arg0_4._tf:Find("resource/yellow"):GetComponent(typeof(Image)).sprite
	...
	for iter0_4 = 1, #arg0_4.options do
		...
		if iter0_4 == 1 then
			...
			local var4_4 = var3_4:Find("Image")

			go(var3_4).name = i18n(arg0_4.names[iter0_4])

			setActive(var3_4, true)
			setActive(var3_4:Find("dropdown"), false)
