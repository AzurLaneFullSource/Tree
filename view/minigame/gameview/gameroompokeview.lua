local var0_0 = class("GameRoomPokeView", import("..BaseMiniGameView"))
local var1_0 = 1
local var2_0 = 2
local var3_0 = 3
local var4_0 = {
...
function var0_0.initUI(arg0_96)
	...
	onButton(arg0_96, findTF(arg0_96.menuUI, "btnRule"), function()
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			...
			helps = arg0_96:getGameRoomData().game_help
		})
	end, SFX_CANCEL)
