local var0 = class("CastleGameView", import("..BaseMiniGameView"))
...
function var0.initData(arg0)
	CastleGameVo.Init(arg0:GetMGData().id, arg0:GetMGHubData().id)

	local var0 = CastleGameVo.frameRate
...
function var0.initUI(arg0)
	...
	arg0.popUI = CastleGamePopUI.New(arg0._tf, arg0)

	arg0.popUI:clearUI()

	arg0.gameUI = CastleGamingUI.New(arg0._tf, arg0)
	arg0.menuUI = CastleGameMenuUI.New(arg0._tf, arg0)
...
function var0.initController(arg0)
	arg0.gameScene = CastleGameScene.New(arg0._tf, arg0)
end
...
function var0.stepRunTimeData(arg0)
	...
	CastleGameVo.gameTime = CastleGameVo.gameTime - var0
	CastleGameVo.gameStepTime = CastleGameVo.gameStepTime + var0
	CastleGameVo.deltaTime = var0
end

function var0.addScore(arg0, arg1)
	CastleGameVo.scoreNum = CastleGameVo.scoreNum + arg1
end
