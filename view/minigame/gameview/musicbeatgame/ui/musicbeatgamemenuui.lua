local var0_0 = class("MusicBeatGameMenuUI")
...
function var0_0.Ctor(arg0_1, arg1_1, arg2_1, arg3_1)
	...
	arg0_1.totalTimes = arg0_1._gameVo.totalTimes
	arg0_1.battleItems = {}
	arg0_1.dropItems = {}
	...
	for iter0_1 = 1, 7 do
		...
		local var7_1 = arg0_1._gameVo:getGameUseTimes()
		local var8_1 = arg0_1._gameVo:getGameTimes()
	end

	setText(findTF(arg0_1.menuUI, "btnRule/text"), i18n("beat_game_rule"))
	setText(findTF(arg0_1.menuUI, "btnStart/text"), i18n("beat_game_start"))
	setText(findTF(arg0_1.menuUI, "btnRank/text"), i18n("beat_game_rank"))
end
...
function var0_0.update(arg0_13, arg1_13)
	...
	for iter0_13 = 1, 7 do
		setActive(findTF(arg0_13.battleItems[iter0_13], "lock"), false)
		setActive(findTF(arg0_13.battleItems[iter0_13], "clear"), false)

		if iter0_13 <= var0_13 then
			setActive(findTF(arg0_13.battleItems[iter0_13], "clear"), true)
		elseif iter0_13 == var0_13 + 1 and var1_13 >= 1 then
			-- block empty
		elseif var0_13 < iter0_13 and iter0_13 <= var0_13 + var1_13 then
			-- block empty
		else
			setActive(findTF(arg0_13.battleItems[iter0_13], "lock"), true)
		end
	end
	...
	local var3_13 = getProxy(MiniGameProxy):GetHighScore(arg0_13._gameVo.gameId)
	local var4_13 = var3_13 and #var3_13 > 0 and var3_13[1] or 0

	setText(arg0_13.highScore, var4_13)
end
...
function var0_0.CheckGet(arg0_14)
	...
	elseif var1_14 == 0 and arg0_14._gameVo.totalTimes <= arg0_14:getGameUsedTimes(var0_14) then
...
function var0_0.showRankUI(arg0_15)
	triggerButton(arg0_15.btnRank)
end
