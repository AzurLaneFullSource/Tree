local var0_0 = class("GameRoomRollingView", import("..BaseMiniGameView"))
...
function var0_0.checkSuccessGrid(arg0_42)
	...
	seriesAsync({
		...
		function(arg0_44)
			if var0_42 then
				LeanTween.delayedCall(go(arg0_42.rollingUI), 0.2, System.Action(function()
					arg0_44()
				end))
...
function var0_0.updateScore(arg0_50, arg1_50)
	...
	LeanTween.delayedCall(go(arg0_50.labelGameScore), 0.2, System.Action(function()
