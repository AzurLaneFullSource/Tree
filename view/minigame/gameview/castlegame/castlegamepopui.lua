local var0_0 = class("CastleGamePopUI")
...
function var0_0.initCountUI(arg0_2)
	...
	arg0_2.countDft:SetEndEvent(function()
		arg0_2._event:emit(CastleGameView.COUNT_DOWN)
	end)
end
...
function var0_0.initLeavelUI(arg0_5)
	...
	onButton(arg0_5._event, findTF(arg0_5.leaveUI, "ad/btnOk"), function()
		arg0_5:resumeGame()
		arg0_5._event:emit(CastleGameView.LEVEL_GAME, true)
	end, SFX_CANCEL)
	onButton(arg0_5._event, findTF(arg0_5.leaveUI, "ad/btnCancel"), function()
		arg0_5:resumeGame()
		arg0_5._event:emit(CastleGameView.LEVEL_GAME, false)
	end, SFX_CANCEL)
end
...
function var0_0.initPauseUI(arg0_8)
	...
	onButton(arg0_8._event, findTF(arg0_8.pauseUI, "ad/btnOk"), function()
		arg0_8:resumeGame()
		arg0_8._event:emit(CastleGameView.PAUSE_GAME, false)
	end, SFX_CANCEL)
end
...
function var0_0.initSettlementUI(arg0_10)
	...
	onButton(arg0_10._event, findTF(arg0_10.settlementUI, "ad/btnOver"), function()
		arg0_10:clearUI()
		arg0_10._event:emit(CastleGameView.BACK_MENU)
	end, SFX_CANCEL)
end
...
function var0_0.updateSettlementUI(arg0_12)
	...
	local var0_12 = CastleGameVo.GetMiniGameData():GetRuntimeData("elements")
	local var1_12 = CastleGameVo.scoreNum
	...
	if var2_12 < var1_12 then
		...
		arg0_12._event:emit(CastleGameView.STORE_SERVER, var2_12)
	end
	...
	local var5_12 = CastleGameVo.GetGameTimes()

	if var5_12 and var5_12 > 0 and not arg0_12.sendSuccessFlag then
		arg0_12._event:emit(CastleGameView.SUBMIT_GAME_SUCCESS)
	end
end
...
function var0_0.backPressed(arg0_13)
	if isActive(arg0_13.pauseUI) then
		arg0_13:resumeGame()
		arg0_13._event:emit(CastleGameView.PAUSE_GAME, false)
	elseif isActive(arg0_13.leaveUI) then
		arg0_13:resumeGame()
		arg0_13._event:emit(CastleGameView.LEVEL_GAME, false)
	elseif not isActive(arg0_13.pauseUI) and not isActive(arg0_13.pauseUI) then
		arg0_13:popPauseUI()
		arg0_13._event:emit(CastleGameView.PAUSE_GAME, true)
	else
		arg0_13:resumeGame()
	end
end
