local var0 = class("CastleGamePopUI")
...
function var0.initCountUI(arg0)
	...
	arg0.countDft:SetEndEvent(function()
		arg0._event:emit(CastleGameView.COUNT_DOWN)
	end)
end
...
function var0.initLeavelUI(arg0)
	...
	onButton(arg0._event, findTF(arg0.leaveUI, "ad/btnOk"), function()
		arg0:resumeGame()
		arg0._event:emit(CastleGameView.LEVEL_GAME, true)
	end, SFX_CANCEL)
	onButton(arg0._event, findTF(arg0.leaveUI, "ad/btnCancel"), function()
		arg0:resumeGame()
		arg0._event:emit(CastleGameView.LEVEL_GAME, false)
	end, SFX_CANCEL)
end
...
function var0.initPauseUI(arg0)
	...
	onButton(arg0._event, findTF(arg0.pauseUI, "ad/btnOk"), function()
		arg0:resumeGame()
		arg0._event:emit(CastleGameView.PAUSE_GAME, false)
	end, SFX_CANCEL)
end
...
function var0.initSettlementUI(arg0)
	...
	onButton(arg0._event, findTF(arg0.settlementUI, "ad/btnOver"), function()
		arg0:clearUI()
		arg0._event:emit(CastleGameView.BACK_MENU)
	end, SFX_CANCEL)
end
...
function var0.updateSettlementUI(arg0)
	...
	local var0 = CastleGameVo.GetMiniGameData():GetRuntimeData("elements")
	local var1 = CastleGameVo.scoreNum
	...
	if var2 < var1 then
		...
		arg0._event:emit(CastleGameView.STORE_SERVER, var2)
	end
	...
	local var5 = CastleGameVo.GetGameTimes()

	if var5 and var5 > 0 and not arg0.sendSuccessFlag then
		arg0._event:emit(CastleGameView.SUBMIT_GAME_SUCCESS)
	end
end
