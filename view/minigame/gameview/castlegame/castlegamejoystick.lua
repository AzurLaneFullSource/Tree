local var0 = class("CastleGameJoyStick")
...
function var0.step(arg0)
	...
	arg0.angle = math.atan(math.abs(arg0.currentY - arg0.startPos.y) / math.abs(arg0.currentX - arg0.startPos.x))
	arg0.offsetX = arg0.currentPos.x / arg0.maxDistance
	arg0.offsetY = arg0.currentPos.y / arg0.maxDistance

	if arg0.callback then
		arg0.callback(arg0:getValue())
	end
end
