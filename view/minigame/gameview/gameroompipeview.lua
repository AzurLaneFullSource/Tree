local var0_0 = class("GameRoomPipeView", import("..BaseMiniGameView"))
local var1_0 = import("view.miniGame.gameView.PipeGame.PipeGameVo")

function var0_0.getUIName(arg0_1)
	return var1_0.game_room_ui
end
...
function var0_0.initEvent(arg0_6)
	...
	arg0_6:bind(PipeGameEvent.SUBMIT_GAME_SUCCESS, function(arg0_20, arg1_20, arg2_20)
		if not arg0_6.sendSuccessFlag then
			...
			arg0_6:SendSuccess(var1_0.scoreNum)
		end
	end)
...
function var0_0.initUI(arg0_22)
	...
	arg0_22.menuUI:setGameRoomUI(arg0_22:getGameRoomData() and true or false)
...
function var0_0.getRankData(arg0_41)
	pg.m02:sendNotification(GAME.MINI_GAME_FRIEND_RANK, {
		id = var1_0.game_id,
		callback = function(arg0_42)
			local var0_42 = {}

			for iter0_42 = 1, #arg0_42 do
				local var1_42 = {}

				for iter1_42, iter2_42 in pairs(arg0_42[iter0_42]) do
					var1_42[iter1_42] = iter2_42
				end
			...
			table.sort(var0_42, function(arg0_43, arg1_43)
				if arg0_43.score ~= arg1_43.score then
					return arg0_43.score > arg1_43.score
				elseif arg0_43.time_data ~= arg1_43.time_data then
					return arg0_43.time_data > arg1_43.time_data
				else
					return arg0_43.player_id < arg1_43.player_id
				end
			end)
			arg0_41.popUI:updateRankData(var0_42)
		end
	})
end

function var0_0.onBackPressed(arg0_44)
	if arg0_44.readyStartFlag then
		return
	end

	if not arg0_44.gameStartFlag then
		return
	else
		if arg0_44.settlementFlag then
			return
		end

		arg0_44.popUI:backPressed()
	end
end

function var0_0.OnSendMiniGameOPDone(arg0_45, arg1_45)
	return
end
...
function var0_0.willExit(arg0_46)
	...
	if arg0_46.timer and arg0_46.timer.running then
		arg0_46.timer:Stop()
	end
