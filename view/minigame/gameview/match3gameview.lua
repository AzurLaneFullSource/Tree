local var0 = class("Match3GameView", import("..BaseMiniGameView"))
local var1 = 6
local var2 = 7
local var3 = -405
local var4 = -275
...
function var0.stopGame(arg0)
	...
	arg0:managedTween(LeanTween.value, function()
		...
		arg0:managedTween(LeanTween.value, function()
			...
			if arg0.infinite or arg0.timer and arg0.timer.time <= 0 then
				if not arg0.infinite then
					arg0:SendSuccess(0)
				end

				if arg0.score > arg0.best then
