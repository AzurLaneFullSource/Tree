local var0_0 = class("GameRoomHideSeekView", import("..BaseMiniGameView"))
...
function var0_0.initUI(arg0_57)
	...
	onButton(arg0_57, findTF(arg0_57.menuUI, "btnRule"), function()
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			...
			helps = arg0_57:getGameRoomData().game_help
		})
	end, SFX_CANCEL)
...
function var0_0.showSettlement(arg0_100)
	...
	local var0_100 = arg0_100.scoreNum
	local var1_100 = getProxy(GameRoomProxy):getRoomScore(arg0_100:getGameRoomData().id)

	setActive(findTF(arg0_100.settlementUI, "ad/new"), var1_100 < var0_100)

	if var1_100 <= var0_100 then
		var1_100 = var0_100
	...
	local var2_100 = findTF(arg0_100.settlementUI, "ad/highText")
	local var3_100 = findTF(arg0_100.settlementUI, "ad/currentText")

	setText(var2_100, var1_100)
	setText(var3_100, var0_100)

	arg0_100.sendSuccessFlag = true

	arg0_100:SendSuccess(var0_100)
end
