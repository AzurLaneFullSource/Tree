local var0_0 = class("IslandCatchTreasureGameView", import("..BaseMiniGameView"))
...
local var7_0 = 60
local var8_0 = "ui/islandcatchtreasuregameui_atlas"
...
function var0_0.initUI(arg0_70)
	...
	local var0_70 = ActivityConst.ISLAND_GAME_ID
	local var1_70 = pg.activity_template[var0_70].config_client.item_id

	arg0_70.itemConfig = Item.getConfigData(var1_70)

	LoadImageSpriteAsync(arg0_70.itemConfig.icon, findTF(arg0_70.menuUI, "item/img"), true)

	arg0_70.hub_id = pg.activity_template[var0_70].config_id

	onButton(arg0_70, findTF(arg0_70.menuUI, "item"), function()
		local var0_77 = {
		...
		arg0_70:emit(BaseMiniGameMediator.OPEN_SUB_LAYER, var0_77)
	end, SFX_CANCEL)
...
function var0_0.initGameUI(arg0_81)
	arg0_81.gameUI = findTF(arg0_81._tf, "ui/gameUI")

	onButton(arg0_81, findTF(arg0_81.gameUI, "topRight/btnStop"), function()
		arg0_81:stopGame()
		setActive(arg0_81.pauseUI, true)
	end)
	onButton(arg0_81, findTF(arg0_81.gameUI, "btnLeave"), function()
		arg0_81:stopGame()
		setActive(arg0_81.leaveUI, true)
	end)

	arg0_81.dragDelegate = GetOrAddComponent(arg0_81.sceneTf, "EventTriggerListener")
	arg0_81.dragDelegate.enabled = true

	arg0_81.dragDelegate:AddPointDownFunc(function(arg0_84, arg1_84)
		if arg0_81.boatController then
			arg0_81.boatController:throw()
		end
	end)

	arg0_81.gameTimeS = findTF(arg0_81.gameUI, "top/time/s")
	arg0_81.scoreTf = findTF(arg0_81.gameUI, "top/score")
	arg0_81.boatController = var56_0(arg0_81.sceneTf, arg0_81)
	arg0_81.itemController = var57_0(arg0_81.sceneTf, arg0_81.backSceneTf, arg0_81:getGameUsedTimes(), arg0_81)
	arg0_81.catchController = var58_0(arg0_81.boatController, arg0_81.itemController)
	arg0_81.charController = var59_0(arg0_81.backSceneTf, arg0_81)
	arg0_81.sceneScoreTf = findTF(arg0_81.sceneTf, "scoreTf")

	setActive(arg0_81.sceneScoreTf, false)
end

function var0_0.Update(arg0_85)
	arg0_85:AddDebugInput()
end

function var0_0.AddDebugInput(arg0_86)
	if arg0_86.gameStop or arg0_86.settlementFlag then
		return
	end
...
function var0_0.updateMenuUI(arg0_87)
	arg0_87.itemNums = getProxy(MiniGameProxy):GetHubByHubId(arg0_87.hub_id).count or 0

	setText(findTF(arg0_87.menuUI, "item/num"), arg0_87.itemNums)
end

function var0_0.openMenuUI(arg0_88)
	setActive(findTF(arg0_88._tf, "scene_container"), false)
	setActive(findTF(arg0_88.bgTf, "on"), true)
	setActive(arg0_88.gameUI, false)
	setActive(arg0_88.menuUI, true)
	arg0_88:updateMenuUI()
end

function var0_0.clearUI(arg0_89)
	setActive(arg0_89.sceneTf, false)
	setActive(arg0_89.settlementUI, false)
	setActive(arg0_89.countUI, false)
	setActive(arg0_89.menuUI, false)
	setActive(arg0_89.gameUI, false)
end

function var0_0.readyStart(arg0_90)
	setActive(arg0_90.countUI, true)
	arg0_90.countAnimator:Play("count")
	pg.CriMgr.GetInstance():PlaySoundEffect_V3(var2_0)
end

function var0_0.getGameTimes(arg0_91)
	return arg0_91:GetMGHubData().count
end

function var0_0.getGameUsedTimes(arg0_92)
	return arg0_92:GetMGHubData().usedtime
end

function var0_0.getUltimate(arg0_93)
	return arg0_93:GetMGHubData().ultimate
end

function var0_0.gameStart(arg0_94)
	setActive(findTF(arg0_94._tf, "scene_container"), true)
	setActive(findTF(arg0_94.bgTf, "on"), false)
	setActive(arg0_94.gameUI, true)

	arg0_94.gameStartFlag = true
	arg0_94.scoreNum = 0
	arg0_94.playerPosIndex = 2
	arg0_94.gameStepTime = 0
	arg0_94.heart = 3
	arg0_94.gameTime = var7_0

	SetActive(arg0_94.sceneScoreTf, false)

	if arg0_94.boatController then
		arg0_94.boatController:start()
	end

	if arg0_94.itemController then
		arg0_94.itemController:start()
	end

	if arg0_94.catchController then
		arg0_94.catchController:start()
	end

	if arg0_94.charController then
		arg0_94.charController:start()
	end
...
function var0_0.transformColor(arg0_95, arg1_95)
	local var0_95 = tonumber(string.sub(arg1_95, 1, 2), 16)
	local var1_95 = tonumber(string.sub(arg1_95, 3, 4), 16)
	local var2_95 = tonumber(string.sub(arg1_95, 5, 6), 16)

	return Color.New(var0_95 / 255, var1_95 / 255, var2_95 / 255)
end

function var0_0.addScore(arg0_96, arg1_96, arg2_96)
	if arg1_96 and arg1_96 > 0 or arg2_96 and arg2_96 > 0 then
		pg.CriMgr.GetInstance():PlaySoundEffect_V3(var5_0)
	elseif arg1_96 and arg1_96 < 0 then
		pg.CriMgr.GetInstance():PlaySoundEffect_V3(var6_0)
	end

	setActive(arg0_96.sceneScoreTf, false)

	local var0_96 = findTF(arg0_96.sceneScoreTf, "img")
	local var1_96 = GetComponent(var0_96, typeof(Text))
	local var2_96 = "6f1807"

	if arg1_96 then
		local var3_96

		for iter0_96 = 1, #var47_0 do
			if arg1_96 and arg1_96 >= var47_0[iter0_96].score then
				var2_96 = var47_0[iter0_96].color
				var3_96 = var47_0[iter0_96].font

				break
			end
		end

		local var4_96 = arg0_96:transformColor(var2_96)

		arg0_96.scoreNum = arg0_96.scoreNum + arg1_96

		local var5_96 = arg1_96 >= 0 and "+" or ""

		setText(var0_96, var5_96 .. arg1_96)

		var1_96.fontSize = var3_96 or 40

		setTextColor(var0_96, var4_96)
	elseif arg2_96 then
		local var6_96 = arg0_96:transformColor("66f2fb")

		var1_96.fontSize = 40

		setTextColor(var0_96, var6_96)

		if arg0_96.gameTime > 0 then
			arg0_96.gameTime = arg0_96.gameTime + arg2_96
		end

		local var7_96 = arg2_96 > 0 and "+" or ""

		setText(var0_96, var7_96 .. arg2_96 .. "s")
	end

	setActive(arg0_96.sceneScoreTf, true)
end

function var0_0.onTimer(arg0_97)
	arg0_97:gameStep()
end

function var0_0.gameStep(arg0_98)
	arg0_98.gameTime = arg0_98.gameTime - Time.deltaTime
	arg0_98.gameStepTime = arg0_98.gameStepTime + Time.deltaTime

	if arg0_98.boatController then
		arg0_98.boatController:step()
	end

	if arg0_98.itemController then
		arg0_98.itemController:step()
	end

	if arg0_98.catchController then
		arg0_98.catchController:step()
	end

	if arg0_98.charController then
		arg0_98.charController:step()
	end

	if arg0_98.gameTime < 0 then
		arg0_98.gameTime = 0
	end
...
function var0_0.timerStart(arg0_99)
	if not arg0_99.timer.running then
		arg0_99.timer:Start()
	end
end

function var0_0.timerStop(arg0_100)
	if arg0_100.timer.running then
		arg0_100.timer:Stop()
	end
end

function var0_0.updateGameUI(arg0_101)
	setText(arg0_101.scoreTf, arg0_101.scoreNum)
	setText(arg0_101.gameTimeS, math.ceil(arg0_101.gameTime))
end

function var0_0.onGameOver(arg0_102)
	if arg0_102.settlementFlag then
		return
	end

	arg0_102:timerStop()

	arg0_102.settlementFlag = true

	setActive(arg0_102.clickMask, true)

	if arg0_102.boatController then
		arg0_102.boatController:gameOver()
	end

	LeanTween.delayedCall(go(arg0_102._tf), 2, System.Action(function()
		arg0_102.settlementFlag = false
		arg0_102.gameStartFlag = false

		setActive(arg0_102.clickMask, false)
		arg0_102:showSettlement()
	end))
end

function var0_0.showSettlement(arg0_104)
	setActive(arg0_104.settlementUI, true)
	GetComponent(findTF(arg0_104.settlementUI, "ad"), typeof(Animator)):Play("settlement", -1, 0)

	local var0_104 = arg0_104:GetMGData():GetRuntimeData("elements")
	local var1_104 = arg0_104.scoreNum
	local var2_104 = var0_104 and #var0_104 > 0 and var0_104[1] or 0

	setActive(findTF(arg0_104.settlementUI, "ad/new"), var2_104 < var1_104)

	if var2_104 <= var1_104 then
		var2_104 = var1_104

		arg0_104:StoreDataToServer({
			var2_104
		})
	end

	local var3_104 = findTF(arg0_104.settlementUI, "ad/highText")
	local var4_104 = findTF(arg0_104.settlementUI, "ad/currentText")

	setText(var3_104, var2_104)
	setText(var4_104, var1_104)

	if arg0_104:getGameTimes() and arg0_104:getGameTimes() > 0 then
		arg0_104.sendSuccessFlag = true

		arg0_104:SendSuccess(0)
	end
end

function var0_0.resumeGame(arg0_105)
	arg0_105.gameStop = false

	setActive(arg0_105.leaveUI, false)
	arg0_105:timerStart()
end

function var0_0.stopGame(arg0_106)
	arg0_106.gameStop = true

	arg0_106:timerStop()
end

function var0_0.onBackPressed(arg0_107)
	if not arg0_107.gameStartFlag then
		arg0_107:emit(var0_0.ON_BACK_PRESSED)
	else
		if arg0_107.settlementFlag then
			return
		end

		if isActive(arg0_107.pauseUI) then
			setActive(arg0_107.pauseUI, false)
		end

		arg0_107:stopGame()
		setActive(arg0_107.leaveUI, true)
	end
end

function var0_0.willExit(arg0_108)
	if arg0_108.handle then
		UpdateBeat:RemoveListener(arg0_108.handle)
	end

	if arg0_108._tf and LeanTween.isTweening(go(arg0_108._tf)) then
		LeanTween.cancel(go(arg0_108._tf))
	end

	if arg0_108.timer and arg0_108.timer.running then
		arg0_108.timer:Stop()
	end
