local var0_0 = class("GameRoomTreasureView", import("..BaseMiniGameView"))
...
local var7_0 = 60
local var8_0 = "ui/minigameui/islandcatchtreasuregameui_atlas"
...
function var0_0.initUI(arg0_70)
	...
	onButton(arg0_70, findTF(arg0_70.menuUI, "btnStart"), function()
		...
		arg0_70:openCoinLayer(false)
		arg0_70:readyStart()
	end, SFX_CANCEL)
	onButton(arg0_70, findTF(arg0_70.menuUI, "btnRule"), function()
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			type = MSGBOX_TYPE_HELP,
			helps = arg0_70:getGameRoomData().game_help
		})
	end, SFX_CANCEL)
...
function var0_0.initGameUI(arg0_80)
	arg0_80.gameUI = findTF(arg0_80._tf, "ui/gameUI")

	onButton(arg0_80, findTF(arg0_80.gameUI, "topRight/btnStop"), function()
		arg0_80:stopGame()
		setActive(arg0_80.pauseUI, true)
	end)
	onButton(arg0_80, findTF(arg0_80.gameUI, "btnLeave"), function()
		arg0_80:stopGame()
		setActive(arg0_80.leaveUI, true)
	end)

	arg0_80.dragDelegate = GetOrAddComponent(arg0_80.sceneTf, "EventTriggerListener")
	arg0_80.dragDelegate.enabled = true

	arg0_80.dragDelegate:AddPointDownFunc(function(arg0_83, arg1_83)
		if arg0_80.boatController then
			arg0_80.boatController:throw()
		end
	end)

	arg0_80.gameTimeS = findTF(arg0_80.gameUI, "top/time/s")
	arg0_80.scoreTf = findTF(arg0_80.gameUI, "top/score")
	arg0_80.boatController = var56_0(arg0_80.sceneTf, arg0_80)
	arg0_80.itemController = var57_0(arg0_80.sceneTf, arg0_80.backSceneTf, arg0_80:getGameUsedTimes(), arg0_80)
	arg0_80.catchController = var58_0(arg0_80.boatController, arg0_80.itemController)
	arg0_80.charController = var59_0(arg0_80.backSceneTf, arg0_80)
	arg0_80.sceneScoreTf = findTF(arg0_80.sceneTf, "scoreTf")

	setActive(arg0_80.sceneScoreTf, false)
end

function var0_0.Update(arg0_84)
	arg0_84:AddDebugInput()
end

function var0_0.AddDebugInput(arg0_85)
	if arg0_85.gameStop or arg0_85.settlementFlag then
		return
	end
...
function var0_0.updateMenuUI(arg0_86)
	return
end

function var0_0.openMenuUI(arg0_87)
	setActive(findTF(arg0_87._tf, "scene_container"), false)
	setActive(findTF(arg0_87.bgTf, "on"), true)
	setActive(arg0_87.gameUI, false)
	setActive(arg0_87.menuUI, true)
	arg0_87:openCoinLayer(true)
	arg0_87:updateMenuUI()
end

function var0_0.clearUI(arg0_88)
	setActive(arg0_88.sceneTf, false)
	setActive(arg0_88.settlementUI, false)
	setActive(arg0_88.countUI, false)
	setActive(arg0_88.menuUI, false)
	setActive(arg0_88.gameUI, false)
end

function var0_0.readyStart(arg0_89)
	setActive(arg0_89.countUI, true)
	arg0_89.countAnimator:Play("count")
	pg.CriMgr.GetInstance():PlaySoundEffect_V3(var2_0)
end

function var0_0.getGameTimes(arg0_90)
	return arg0_90:GetMGHubData().count
end

function var0_0.getGameUsedTimes(arg0_91)
	return arg0_91:GetMGHubData().usedtime
end

function var0_0.getUltimate(arg0_92)
	return arg0_92:GetMGHubData().ultimate
end

function var0_0.gameStart(arg0_93)
	setActive(findTF(arg0_93._tf, "scene_container"), true)
	setActive(findTF(arg0_93.bgTf, "on"), false)
	setActive(arg0_93.gameUI, true)

	arg0_93.gameStartFlag = true
	arg0_93.scoreNum = 0
	arg0_93.playerPosIndex = 2
	arg0_93.gameStepTime = 0
	arg0_93.heart = 3
	arg0_93.gameTime = var7_0

	SetActive(arg0_93.sceneScoreTf, false)

	if arg0_93.boatController then
		arg0_93.boatController:start()
	end

	if arg0_93.itemController then
		arg0_93.itemController:start()
	end

	if arg0_93.catchController then
		arg0_93.catchController:start()
	end

	if arg0_93.charController then
		arg0_93.charController:start()
	end

	arg0_93:updateGameUI()
	arg0_93:timerStart()
end

function var0_0.transformColor(arg0_94, arg1_94)
	local var0_94 = tonumber(string.sub(arg1_94, 1, 2), 16)
	local var1_94 = tonumber(string.sub(arg1_94, 3, 4), 16)
	local var2_94 = tonumber(string.sub(arg1_94, 5, 6), 16)

	return Color.New(var0_94 / 255, var1_94 / 255, var2_94 / 255)
end

function var0_0.addScore(arg0_95, arg1_95, arg2_95)
	if arg1_95 and arg1_95 > 0 or arg2_95 and arg2_95 > 0 then
		pg.CriMgr.GetInstance():PlaySoundEffect_V3(var5_0)
	elseif arg1_95 and arg1_95 < 0 then
		pg.CriMgr.GetInstance():PlaySoundEffect_V3(var6_0)
	end

	setActive(arg0_95.sceneScoreTf, false)

	local var0_95 = findTF(arg0_95.sceneScoreTf, "img")
	local var1_95 = GetComponent(var0_95, typeof(Text))
	local var2_95 = "6f1807"

	if arg1_95 then
		local var3_95

		for iter0_95 = 1, #var47_0 do
			if arg1_95 and arg1_95 >= var47_0[iter0_95].score then
				var2_95 = var47_0[iter0_95].color
				var3_95 = var47_0[iter0_95].font

				break
			end
		end

		local var4_95 = arg0_95:transformColor(var2_95)

		arg0_95.scoreNum = arg0_95.scoreNum + arg1_95

		local var5_95 = arg1_95 >= 0 and "+" or ""

		setText(var0_95, var5_95 .. arg1_95)

		var1_95.fontSize = var3_95 or 40

		setTextColor(var0_95, var4_95)
	elseif arg2_95 then
		local var6_95 = arg0_95:transformColor("66f2fb")

		var1_95.fontSize = 40

		setTextColor(var0_95, var6_95)

		if arg0_95.gameTime > 0 then
			arg0_95.gameTime = arg0_95.gameTime + arg2_95
		end

		local var7_95 = arg2_95 > 0 and "+" or ""

		setText(var0_95, var7_95 .. arg2_95 .. "s")
	end

	setActive(arg0_95.sceneScoreTf, true)
end

function var0_0.onTimer(arg0_96)
	arg0_96:gameStep()
end

function var0_0.gameStep(arg0_97)
	arg0_97.gameTime = arg0_97.gameTime - Time.deltaTime
	arg0_97.gameStepTime = arg0_97.gameStepTime + Time.deltaTime

	if arg0_97.boatController then
		arg0_97.boatController:step()
	end

	if arg0_97.itemController then
		arg0_97.itemController:step()
	end

	if arg0_97.catchController then
		arg0_97.catchController:step()
	end

	if arg0_97.charController then
		arg0_97.charController:step()
	end

	if arg0_97.gameTime < 0 then
		arg0_97.gameTime = 0
	end

	arg0_97:updateGameUI()
...
function var0_0.timerStart(arg0_98)
	if not arg0_98.timer.running then
		arg0_98.timer:Start()
	end
end

function var0_0.timerStop(arg0_99)
	if arg0_99.timer.running then
		arg0_99.timer:Stop()
	end
end

function var0_0.updateGameUI(arg0_100)
	setText(arg0_100.scoreTf, arg0_100.scoreNum)
	setText(arg0_100.gameTimeS, math.ceil(arg0_100.gameTime))
end

function var0_0.onGameOver(arg0_101)
	if arg0_101.settlementFlag then
		return
	end

	arg0_101:timerStop()

	arg0_101.settlementFlag = true

	setActive(arg0_101.clickMask, true)

	if arg0_101.boatController then
		arg0_101.boatController:gameOver()
	end

	LeanTween.delayedCall(go(arg0_101._tf), 2, System.Action(function()
		arg0_101.settlementFlag = false
		arg0_101.gameStartFlag = false

		setActive(arg0_101.clickMask, false)
		arg0_101:showSettlement()
	end))
end

function var0_0.showSettlement(arg0_103)
	setActive(arg0_103.settlementUI, true)
	GetComponent(findTF(arg0_103.settlementUI, "ad"), typeof(Animator)):Play("settlement", -1, 0)

	local var0_103 = arg0_103:GetMGData():GetRuntimeData("elements")
	local var1_103 = arg0_103.scoreNum
	local var2_103 = var0_103 and #var0_103 > 0 and var0_103[1] or 0

	setActive(findTF(arg0_103.settlementUI, "ad/new"), var2_103 < var1_103)

	if var2_103 <= var1_103 then
		var2_103 = var1_103

		arg0_103:StoreDataToServer({
			var2_103
		})
	end

	local var3_103 = findTF(arg0_103.settlementUI, "ad/highText")
	local var4_103 = findTF(arg0_103.settlementUI, "ad/currentText")

	setText(var3_103, var2_103)
	setText(var4_103, var1_103)

	if arg0_103:getGameTimes() and arg0_103:getGameTimes() > 0 then
		arg0_103.sendSuccessFlag = true

		arg0_103:SendSuccess(0)
	end
end

function var0_0.resumeGame(arg0_104)
	arg0_104.gameStop = false

	setActive(arg0_104.leaveUI, false)
	arg0_104:timerStart()
end

function var0_0.stopGame(arg0_105)
	arg0_105.gameStop = true

	arg0_105:timerStop()
end

function var0_0.onBackPressed(arg0_106)
	if not arg0_106.gameStartFlag then
		arg0_106:emit(var0_0.ON_BACK_PRESSED)
	else
		if arg0_106.settlementFlag then
			return
		end

		if isActive(arg0_106.pauseUI) then
			setActive(arg0_106.pauseUI, false)
		end

		arg0_106:stopGame()
		setActive(arg0_106.leaveUI, true)
	end
end

function var0_0.willExit(arg0_107)
	if arg0_107.handle then
		UpdateBeat:RemoveListener(arg0_107.handle)
	end

	if arg0_107._tf and LeanTween.isTweening(go(arg0_107._tf)) then
		LeanTween.cancel(go(arg0_107._tf))
	end

	if arg0_107.timer and arg0_107.timer.running then
		arg0_107.timer:Stop()
	end
