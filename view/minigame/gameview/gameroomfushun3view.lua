local var0_0 = class("GameRoomFushun3View", import("..BaseMiniGameView"))
...
function var0_0.showSettlement(arg0_67)
	...
	local var0_67 = arg0_67.scoreNum
	local var1_67 = getProxy(GameRoomProxy):getRoomScore(arg0_67:getGameRoomData().id)

	setActive(findTF(arg0_67.settlementUI, "ad/new"), var1_67 < var0_67)

	if var1_67 <= var0_67 then
		var1_67 = var0_67
	...
	local var2_67 = findTF(arg0_67.settlementUI, "ad/highText")
	local var3_67 = findTF(arg0_67.settlementUI, "ad/currentText")

	setText(var2_67, var1_67)
	setText(var3_67, var0_67)
	arg0_67:SendSuccess(var0_67 or 0)
end
