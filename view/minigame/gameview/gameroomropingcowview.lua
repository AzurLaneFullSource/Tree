...
function var0_0.initGameUI(arg0_54)
	arg0_54.gameUI = findTF(arg0_54._tf, "ui/gameUI")

	onButton(arg0_54, findTF(arg0_54.gameUI, "topRight/btnStop"), function()
		arg0_54:stopGame()
		setActive(arg0_54.pauseUI, true)
	end)
	onButton(arg0_54, findTF(arg0_54.gameUI, "btnLeave"), function()
		arg0_54:stopGame()
		setActive(arg0_54.leaveUI, true)
	end)

	arg0_54.gameTimeS = findTF(arg0_54.gameUI, "top/time/s")
	arg0_54.scoreTf = findTF(arg0_54.gameUI, "top/score")
	arg0_54.btnCapture = findTF(arg0_54.gameUI, "btnCapture")
	arg0_54.captureButton = GetOrAddComponent(arg0_54.btnCapture, "EventTriggerListener")

	arg0_54.captureButton:AddPointDownFunc(function(arg0_57, arg1_57)
		if arg0_54._playerController then
			arg0_54._playerController:throw()
		end
	end)

	local var0_54 = findTF(arg0_54.sceneTf, "cowContainer")
	local var1_54 = {}

	for iter0_54 = 1, var12_0 do
		local var2_54 = findTF(arg0_54.sceneTf, "cow" .. iter0_54)

		table.insert(var1_54, var2_54)
	end

	arg0_54.sceneScoreTf = findTF(arg0_54.sceneTf, "score")
	arg0_54._playerController = var32_0(findTF(arg0_54.sceneTf, "player"), arg0_54)
	arg0_54._cowController = var31_0(var1_54, var0_54, arg0_54)
	arg0_54._sceneItemController = var33_0(arg0_54.backSceneTf)
end

function var0_0.Update(arg0_58)
	arg0_58:AddDebugInput()
end

function var0_0.AddDebugInput(arg0_59)
	if arg0_59.gameStop or arg0_59.settlementFlag then
		return
	end

	if IsUnityEditor and Input.GetKeyDown(KeyCode.S) and arg0_59._playerController then
		arg0_59._playerController:throw()
	end
end

function var0_0.updateMenuUI(arg0_60)
	local var0_60 = arg0_60:getGameUsedTimes()
	local var1_60 = arg0_60:getGameTimes()
end

function var0_0.CheckGet(arg0_61)
	setActive(findTF(arg0_61.menuUI, "got"), false)

	if arg0_61:getUltimate() and arg0_61:getUltimate() ~= 0 then
		setActive(findTF(arg0_61.menuUI, "got"), true)
	end

	if arg0_61:getUltimate() == 0 then
		if arg0_61:getGameTotalTime() > arg0_61:getGameUsedTimes() then
			return
		end

		pg.m02:sendNotification(GAME.SEND_MINI_GAME_OP, {
			hubid = arg0_61:GetMGHubData().id,
...
function var0_0.openMenuUI(arg0_62)
	setActive(findTF(arg0_62._tf, "scene_front"), false)
	setActive(findTF(arg0_62._tf, "scene_background"), false)
	setActive(findTF(arg0_62._tf, "scene"), false)
	setActive(arg0_62.gameUI, false)
	setActive(arg0_62.menuUI, true)
	arg0_62:openCoinLayer(true)
	arg0_62:updateMenuUI()
end

function var0_0.clearUI(arg0_63)
	setActive(arg0_63.sceneTf, false)
	setActive(arg0_63.settlementUI, false)
	setActive(arg0_63.countUI, false)
	setActive(arg0_63.menuUI, false)
	arg0_63:openCoinLayer(false)
	setActive(arg0_63.gameUI, false)
end

function var0_0.readyStart(arg0_64)
	setActive(arg0_64.countUI, true)
	arg0_64.countAnimator:Play("count")
	pg.CriMgr.GetInstance():PlaySoundEffect_V3(var2_0)
end

function var0_0.gameStart(arg0_65)
	setActive(findTF(arg0_65._tf, "scene_front"), true)
	setActive(findTF(arg0_65._tf, "scene_background"), true)
	setActive(findTF(arg0_65._tf, "scene"), true)
	setActive(arg0_65.gameUI, true)

	arg0_65.gameStartFlag = true
	arg0_65.scoreNum = 0
	arg0_65.playerPosIndex = 2
	arg0_65.gameStepTime = 0
	arg0_65.heart = 3
	arg0_65.gameTime = var5_0

	if arg0_65._cowController then
		arg0_65._cowController:start()
	end

	if arg0_65._playerController then
		arg0_65._playerController:start()
	end

	arg0_65:updateGameUI()
	arg0_65:timerStart()
end

function var0_0.getGameTimes(arg0_66)
	return arg0_66:GetMGHubData().count
end

function var0_0.getGameUsedTimes(arg0_67)
	return arg0_67:GetMGHubData().usedtime
end

function var0_0.getUltimate(arg0_68)
	return arg0_68:GetMGHubData().ultimate
end

function var0_0.getGameTotalTime(arg0_69)
	return (arg0_69:GetMGHubData():getConfig("reward_need"))
end

function var0_0.changeSpeed(arg0_70, arg1_70)
	return
end

function var0_0.onTimer(arg0_71)
	arg0_71:gameStep()
end

function var0_0.gameStep(arg0_72)
	arg0_72.gameTime = arg0_72.gameTime - Time.deltaTime

	if arg0_72.gameTime < 0 then
		arg0_72.gameTime = 0
	end

	arg0_72.gameStepTime = arg0_72.gameStepTime + Time.deltaTime

	if arg0_72._cowController then
		arg0_72._cowController:step(arg0_72.gameStepTime)
	end

	if arg0_72._playerController then
		arg0_72._playerController:step(arg0_72.gameStepTime)
	end

	if arg0_72._sceneItemController then
		arg0_72._sceneItemController:step(arg0_72.gameStepTime)
	end

	arg0_72:updateGameUI()
...
function var0_0.updateGameUI(arg0_75)
	...
	if not arg0_75.captureCdMaskImg then
		arg0_75.captureCdMaskImg = GetComponent(findTF(arg0_75.btnCapture, "cd"), typeof(Image))
	end

	if arg0_75._playerController then
		local var0_75 = arg0_75._playerController:getThrowTime()

		if var0_75 and var0_75 > 0 then
			local var1_75 = var0_75 / var10_0

			arg0_75.captureCdMaskImg.fillAmount = var1_75
		else
			arg0_75.captureCdMaskImg.fillAmount = 0
		end
	end
end

function var0_0.addScore(arg0_76, arg1_76)
	...
	setActive(arg0_76.sceneScoreTf, false)

	for iter0_76 = 0, arg0_76.sceneScoreTf.childCount - 1 do
		local var0_76 = arg0_76.sceneScoreTf:GetChild(iter0_76)

		if var0_76.name == tostring(arg1_76) then
			setActive(var0_76, true)
		else
			setActive(var0_76, false)
		end
	end

	setActive(arg0_76.sceneScoreTf, true)
end
...
function var0_0.onGameOver(arg0_77)
	...
	setActive(arg0_77.sceneScoreTf, false)
	setActive(arg0_77.clickMask, true)

	if arg0_77._cowController then
		arg0_77._cowController:clear()
	end
...
function var0_0.showSettlement(arg0_79)
	...
	local var2_79 = findTF(arg0_79.settlementUI, "ad/highText")
	local var3_79 = findTF(arg0_79.settlementUI, "ad/currentText")

	setText(var2_79, var1_79)
	setText(var3_79, var0_79)

	arg0_79.sendSuccessFlag = true

	arg0_79:SendSuccess(var0_79 or 0)
end

function var0_0.resumeGame(arg0_80)
	arg0_80.gameStop = false

	setActive(arg0_80.leaveUI, false)
	arg0_80:changeSpeed(1)
	arg0_80:timerStart()
end

function var0_0.stopGame(arg0_81)
	arg0_81.gameStop = true

	arg0_81:timerStop()
	arg0_81:changeSpeed(0)
end

function var0_0.checkOverflow(arg0_82, arg1_82, arg2_82)
	local var0_82 = getProxy(PlayerProxy):getRawData()
	local var1_82 = pg.gameset.urpt_chapter_max.description[1]
	local var2_82 = LOCK_UR_SHIP and 0 or getProxy(BagProxy):GetLimitCntById(var1_82)
	local var3_82, var4_82 = Task.StaticJudgeOverflow(var0_82.gold, var0_82.oil, var2_82, true, true, {
		arg1_82
	})
...
function var0_0.onBackPressed(arg0_83)
	if not arg0_83.gameStartFlag then
		arg0_83:emit(var0_0.ON_BACK_PRESSED)
	else
		if arg0_83.settlementFlag then
			return
		end

		if isActive(arg0_83.pauseUI) then
			setActive(arg0_83.pauseUI, false)
		end

		arg0_83:stopGame()
		setActive(arg0_83.leaveUI, true)
	end
end

function var0_0.willExit(arg0_84)
	if arg0_84.handle then
		UpdateBeat:RemoveListener(arg0_84.handle)
	end
	...
	if arg0_84.timer and arg0_84.timer.running then
		arg0_84.timer:Stop()
	end
