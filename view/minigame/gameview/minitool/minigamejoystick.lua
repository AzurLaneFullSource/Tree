local var0 = class("MiniGameJoyStick")
...
function var0.setting(arg0, arg1)
	arg0.smoothX = arg1.smoothX
	arg0.smoothY = arg1.smoothY
	arg0.maxDistance = arg1.maxDistance
	arg0.minDeadNum = arg1.minDeadNum
	arg0.maxDeadNum = arg1.maxDeadNum
end
...
function var0.step(arg0)
	...
	if math.abs(arg0.offsetX) > arg0.minDeadNum then
		if arg0.offsetX > 0 then
			arg0.directX = 1
		elseif arg0.offsetX < 0 then
			arg0.directX = -1
		end
	else
		arg0.directX = 0
	...
	if math.abs(arg0.offsetY) > arg0.minDeadNum then
		if arg0.offsetY > 0 then
			arg0.directY = 1
		elseif arg0.offsetY < 0 then
			arg0.directY = -1
		end
	else
		arg0.directY = 0
...
function var0.getValue(arg0)
	...
	return {
		...
		y = arg0.offsetY,
		active = arg0.active,
		directX = arg0.directX,
		directY = arg0.directY
	}
end
