local var0 = class("LaunchBallGamePopUI")
...
function var0.initCountUI(arg0)
	...
	arg0.countDft:SetEndEvent(function()
		arg0._event:emit(LaunchBallGameView.COUNT_DOWN)
	end)
end
...
function var0.initLeavelUI(arg0)
	...
	onButton(arg0._event, findTF(arg0.leaveUI, "ad/btnOk"), function()
		arg0:resumeGame()
		arg0._event:emit(LaunchBallGameView.LEVEL_GAME, true)
	end, SFX_CANCEL)
	onButton(arg0._event, findTF(arg0.leaveUI, "ad/btnCancel"), function()
		arg0:resumeGame()
		arg0._event:emit(LaunchBallGameView.LEVEL_GAME, false)
	end, SFX_CANCEL)
end
...
function var0.initPauseUI(arg0)
	...
	onButton(arg0._event, findTF(arg0.pauseUI, "ad/btnOk"), function()
		arg0:resumeGame()
		arg0._event:emit(LaunchBallGameView.PAUSE_GAME, false)
	end, SFX_CANCEL)
end
...
function var0.initSettlementUI(arg0)
	...
	onButton(arg0._event, findTF(arg0.settlementUI, "ad/btnOver"), function()
		arg0:clearUI()
		arg0._event:emit(LaunchBallGameView.BACK_MENU)
	end, SFX_CANCEL)
end
...
function var0.updateSettlementUI(arg0)
	...
	local var0 = LaunchBallGameVo.GetMiniGameData():GetRuntimeData("elements")
	local var1 = LaunchBallGameVo.scoreNum
	...
	if var2 < var1 then
		...
		arg0._event:emit(LaunchBallGameView.STORE_SERVER, var2)
	end
	...
	setText(var3, var2)
	setText(var4, var1)
	arg0._event:emit(LaunchBallGameView.SUBMIT_GAME_SUCCESS)
end
