local var0_0 = class("LaunchBallGamePopUI")
...
function var0_0.initCountUI(arg0_2)
	...
	arg0_2.countDft:SetEndEvent(function()
		arg0_2._event:emit(LaunchBallGameView.COUNT_DOWN)
	end)
end
...
function var0_0.initLeavelUI(arg0_5)
	...
	onButton(arg0_5._event, findTF(arg0_5.leaveUI, "ad/btnOk"), function()
		arg0_5:resumeGame()
		arg0_5._event:emit(LaunchBallGameView.LEVEL_GAME, true)
	end, SFX_CANCEL)
	onButton(arg0_5._event, findTF(arg0_5.leaveUI, "ad/btnCancel"), function()
		arg0_5:resumeGame()
		arg0_5._event:emit(LaunchBallGameView.LEVEL_GAME, false)
	end, SFX_CANCEL)
end
...
function var0_0.initPauseUI(arg0_8)
	...
	onButton(arg0_8._event, findTF(arg0_8.pauseUI, "ad/btnOk"), function()
		arg0_8:resumeGame()
		arg0_8._event:emit(LaunchBallGameView.PAUSE_GAME, false)
	end, SFX_CANCEL)
end
...
function var0_0.initSettlementUI(arg0_10)
	...
	onButton(arg0_10._event, findTF(arg0_10.settlementUI, "ad/btnOver"), function()
		arg0_10:clearUI()
		arg0_10._event:emit(LaunchBallGameView.BACK_MENU)
	end, SFX_CANCEL)
end

function var0_0.updateSettlementUI(arg0_12)
	GetComponent(findTF(arg0_12.settlementUI, "ad"), typeof(Animator)):Play("settlement", -1, 0)

	local var0_12 = LaunchBallGameVo.GetMiniGameData():GetRuntimeData("elements")
	local var1_12 = LaunchBallGameVo.scoreNum
	...
	if var2_12 < var1_12 then
		...
		arg0_12._event:emit(LaunchBallGameView.STORE_SERVER, var2_12)
	end
	...
	arg0_12._event:emit(LaunchBallGameView.SUBMIT_GAME_SUCCESS)
end

function var0_0.backPressed(arg0_13)
	if isActive(arg0_13.pauseUI) then
		arg0_13:resumeGame()
		arg0_13._event:emit(LaunchBallGameView.PAUSE_GAME, false)
	elseif isActive(arg0_13.leaveUI) then
		arg0_13:resumeGame()
		arg0_13._event:emit(LaunchBallGameView.LEVEL_GAME, false)
	elseif not isActive(arg0_13.pauseUI) and not isActive(arg0_13.pauseUI) then
		arg0_13:popPauseUI()
		arg0_13._event:emit(LaunchBallGameView.PAUSE_GAME, true)
	else
		arg0_13:resumeGame()
	end
end
...
function var0_0.popSettlementUI(arg0_20, arg1_20)
