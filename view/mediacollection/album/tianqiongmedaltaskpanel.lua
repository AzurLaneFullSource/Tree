local var0_0 = class("TianqiongMedalTaskPanel")
...
function var0_0.UpdateList(arg0_10, arg1_10)
	arg0_10.UIlist:make(function(arg0_11, arg1_11, arg2_11)
		if arg0_11 == UIItemList.EventUpdate then
			...
			local var1_11 = arg2_11:Find("frame/progressContent")
			local var2_11 = arg2_11:Find("frame/slider"):GetComponent(typeof(Slider))
			local var3_11 = arg2_11:Find("frame/progressContent/progress")
			local var4_11 = arg2_11:Find("frame/progressContent/progress_1")
			local var5_11 = arg2_11:Find("frame/awards")
			local var6_11 = arg2_11:Find("frame/desc")
			local var7_11 = arg2_11:Find("frame/get_btn")
			local var8_11 = arg2_11:Find("frame/got_btn")
			local var9_11 = arg2_11:Find("frame/go_btn")

			setText(var6_11, var0_11:getConfig("desc"))

			local var10_11, var11_11 = arg0_10:getTaskProgress(var0_11)
			local var12_11, var13_11 = arg0_10:getTaskTarget(var0_11)

			var2_11.value = var10_11 / var12_11

			setText(var4_11, var11_11 .. "/" .. var13_11)

			local var14_11 = var5_11:GetChild(0)

			arg0_10:updateAwards(var0_11:getConfig("award_display"), var5_11, var14_11)
			setActive(var8_11, var0_11:getTaskStatus() == 2)
			setActive(var7_11, var0_11:getTaskStatus() == 1)
			setActive(var9_11, var0_11:getTaskStatus() == 0)
			onButton(arg0_10, var9_11, function()
