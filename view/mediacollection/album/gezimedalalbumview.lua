local var0_0 = class("GeZiMedalAlbumView", import(".MedalAlbumTemplateView"))

var0_0.GROUP_ID = 50607
...
function var0_0.FindUI(arg0_2)
	...
	arg0_2.medalDetailView = MedalDetailPanel.New(arg0_2._tf:Find("DetailView"), arg0_2)

	arg0_2.medalDetailView:SetIconScale(arg0_2.ICON_SCALE)

	arg0_2.medalTaskView = TianqiongMedalTaskPanel.New(arg0_2._tf:Find("TaskView"), arg0_2)

	setActive(arg0_2._tf:Find("Desk"), true)
	setActive(arg0_2._tf:Find("DetailView"), false)
	setActive(arg0_2._tf:Find("TaskView"), false)
end
