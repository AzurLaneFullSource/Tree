local var0_0 = class("ShadowCityMedalAlbumView", import(".MedalAlbumTemplateView"))

var0_0.GROUP_ID = 51143
...
function var0_0.FindUI(arg0_2)
	...
	arg0_2.medalDetailView = ShadowCityMedalDetailPanel.New(arg0_2._tf:Find("DetailView"), arg0_2)
