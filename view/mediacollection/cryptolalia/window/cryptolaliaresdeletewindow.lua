...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.contentTxt = arg0_2._tf:Find("window/content/Text"):GetComponent(typeof(Text))
	arg0_2.icon = arg0_2._tf:Find("window/content/cover/icon"):GetComponent(typeof(Image))
	arg0_2.signature = arg0_2._tf:Find("window/content/cover/signature"):GetComponent(typeof(Image))
	arg0_2.name = arg0_2._tf:Find("window/content/cover/name"):GetComponent(typeof(Text))
	arg0_2.shipname = arg0_2._tf:Find("window/content/cover/shipname"):GetComponent(typeof(Text))
	...
	setText(arg0_2._tf:Find("window/top/title"), i18n("cryptolalia_delete_res_title"))
