...
function var0_0.OnLoaded(arg0_2)
	arg0_2.icon = arg0_2._tf:Find("window/cover/icon"):GetComponent(typeof(Image))
	arg0_2.signature = arg0_2._tf:Find("window/cover/signature"):GetComponent(typeof(Image))
	arg0_2.name = arg0_2._tf:Find("window/cover/name"):GetComponent(typeof(Text))
	arg0_2.shipname = arg0_2._tf:Find("window/cover/shipname"):GetComponent(typeof(Text))
	arg0_2.gemToggle = arg0_2._tf:Find("window/gem")
	arg0_2.ticketToggle = arg0_2._tf:Find("window/ticket")
	...
	arg0_2.exchangeBtn = arg0_2._tf:Find("exchange")
