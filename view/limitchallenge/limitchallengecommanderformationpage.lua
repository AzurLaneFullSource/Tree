local var0 = class("LimitChallengeCommanderFormationPage", import("view.base.BaseSubView"))
...
function var0.updateSkillTF(arg0, arg1, arg2)
	...
	if arg1 then
		...
		onButton(arg0, arg2, function()
			arg0:emit(LimitChallengePreCombatMediator.ON_CMD_SKILL, var0)
		end, SFX_PANEL)
	else
		removeOnButton(arg2)
	end
...
function var0.updateCommander(arg0, arg1, arg2, arg3, arg4)
	...
	if arg4 then
		onButton(arg0, var1, function()
			arg0:emit(LimitChallengePreCombatMediator.ON_SELECT_COMMANDER, arg2, arg0.fleet.id)
		end, SFX_PANEL)
