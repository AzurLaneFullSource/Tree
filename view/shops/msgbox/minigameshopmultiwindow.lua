local var0_0 = class("MiniGameShopMultiWindow", import("...base.BaseSubView"))
...
function var0_0.OnLoaded(arg0_2)
	arg0_2.topItem = arg0_2._tf:Find("item/panel_bg")
	...
	arg0_2.bottomItem = arg0_2._tf:Find("got/panel_bg/list/item")
	arg0_2.itemCountTF = arg0_2.bottomItem:Find("icon_bg/count"):GetComponent(typeof(Text))
	arg0_2.maxBtn = arg0_2._tf:Find("count/max")
	arg0_2.leftBtn = arg0_2._tf:Find("count/number_panel/left")
	arg0_2.rightBtn = arg0_2._tf:Find("count/number_panel/right")
	arg0_2.countTF = arg0_2._tf:Find("count/number_panel/value"):GetComponent(typeof(Text))
	arg0_2.cancelBtn = arg0_2._tf:Find("actions/cancel_button")
	arg0_2.confirmBtn = arg0_2._tf:Find("actions/confirm_button")

	setText(arg0_2._tf:Find("got/panel_bg/got_text"), i18n("shops_msgbox_output"))
	setText(arg0_2._tf:Find("count/image_text"), i18n("shops_msgbox_exchange_count"))
	setText(arg0_2._tf:Find("actions/cancel_button/label"), i18n("shop_word_cancel"))
	setText(arg0_2._tf:Find("actions/confirm_button/label"), i18n("shop_word_exchange"))
end
