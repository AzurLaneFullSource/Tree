local var0 = class("MedalShopMultiWindow", import("...base.BaseSubView"))
...
function var0.InitWindow(arg0, arg1, arg2)
	...
	local var1 = getProxy(BagProxy):getItemCountById(ITEM_ID_SILVER_HOOK)
	local var2 = math.max(math.floor(var1 / arg1:getConfig("price")), 1)

	if arg1:GetLimit() ~= 0 then
		var2 = math.min(var2, arg1:GetMaxCnt())
	end

	local function var3(arg0)
		arg0 = math.max(arg0, 1)
		arg0 = math.min(arg0, var2)
