...
function var0_0.Ctor(arg0_1, arg1_1)
	...
	arg0_1.levelTagText = findTF(arg0_1.tf, "mask/tag/level_tag/TextGo/Text")
	arg0_1.limitTag = findTF(arg0_1.tf, "mask/tag/limit_tag")
	...
	setActive(arg0_1.itemTF:Find("group_locked"), false)

	arg0_1.groupLocked = findTF(arg0_1.tf, "group_locked")

	setActive(arg0_1.groupLocked, false)
	setText(findTF(arg0_1.tf, "group_locked/Text"), i18n("shop_item_unobtained"))
	...
	setScrollText(arg0_1.tf:Find("mask/tag/limit_tag/TextGo/Text"), i18n("quota_shop_good_limit"))
	setScrollText(arg0_1.tf:Find("mask/tag/sellout_tag/TextGo/Text"), i18n("word_sell_out"))
	setScrollText(arg0_1.tf:Find("mask/tag/unexchange_tag/TextGo/Text"), i18n("meta_shop_exchange_limit"))
	setScrollText(arg0_1.sellEndTag:Find("TextGo/Text"), i18n("shop_sell_ended"))
	setScrollText(arg0_1.selloutTag:Find("TextGo/Text"), i18n("common_sale_out"))
	setScrollText(arg0_1.levelTag:Find("TextGo/Text"), i18n("shop_charge_level_limit"))
