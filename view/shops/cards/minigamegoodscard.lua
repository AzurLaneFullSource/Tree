local var0 = class("MiniGameGoodsCard", import(".BaseGoodsCard"))
...
function var0.Ctor(arg0, arg1)
	...
	arg0.countContainTf = findTF(arg0.tr, "item/count_contain/count")

	setText(findTF(arg0.tr, "item/count_contain/label"), i18n("activity_shop_exchange_count"))

	arg0.maskTip = i18n("buy_countLimit")

	setText(arg0.tr:Find("mask/tag/sellout_tag"), i18n("word_sell_out"))
...
function var0.update(arg0, arg1)
	...
	local var3 = ""
	local var4 = arg1:getConfig("price")
	local var5 = arg1:GetMaxCnt()
	local var6 = arg1:getConfig("goods_purchase_limit")

	setText(arg0.countContainTf, var5 .. "/" .. var6)
	setActive(arg0.discountTF, false)

	arg0.countTF.text = math.ceil(var4)

	GetSpriteFromAtlasAsync("ui/ShopsUI_atlas", "minigameRes", function(arg0)
		arg0.resIconTF:GetComponent(typeof(Image)).sprite = arg0
	end)
end
