...
function var0_0.update(arg0_1, arg1_1, arg2_1, arg3_1, arg4_1)
	...
	if var1_1.type == DROP_TYPE_SKIN then
		var2_1 = pg.ship_skin_template[var1_1.id].name or "??"
	else
		var2_1 = var1_1:getConfig("name") or "??"
	end
	...
	GetImageSpriteFromAtlasAsync(var3_1, "", arg0_1.resIconTF)

	local var4_1 = arg1_1:GetLimitGoodCount()
	local var5_1 = math.min(arg1_1:GetOwnedGoodCount(), var4_1)

	setText(arg0_1.limitCountLabelTF, i18n("quota_shop_owned") .. var4_1 - var5_1 .. "/" .. var4_1)
