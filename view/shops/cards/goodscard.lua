local var0_0 = class("GoodsCard", import(".BaseGoodsCard"))
...
function var0_0.update(arg0_5, arg1_5, arg2_5)
	...
	setActive(arg0_5.selloutTag, not var0_5)
	...
	if arg1_5:getConfig("genre") == ShopArgs.ShoppingStreetLimit then
		var3_5 = 100 - arg1_5.discount .. "%OFF"
	...
	}):getIcon(), "", tf(arg0_5.resIconTF))
	setActive(arg0_5.groupLocked, arg0_5.itemTF:Find("group_locked").gameObject.activeSelf)
end
