...
function var0_0.OnLoaded(arg0_2)
	arg0_2.purchaseBtn = arg0_2._tf:Find("frame")
	arg0_2.tipTxt = arg0_2._tf:Find("tip/Text"):GetComponent(typeof(Text))
	arg0_2.icon = arg0_2._tf:Find("frame/icon/Image"):GetComponent(typeof(Image))
	arg0_2.tag = arg0_2._tf:Find("frame/icon/tag"):GetComponent(typeof(Image))
	arg0_2.nameTxt = arg0_2._tf:Find("frame/name/Text"):GetComponent(typeof(Text))
	arg0_2.priceTxt = arg0_2._tf:Find("frame/price"):GetComponent(typeof(Text))
	arg0_2.descTxt = arg0_2._tf:Find("frame/desc"):GetComponent(typeof(Text))
	arg0_2.limitTxt = arg0_2._tf:Find("frame/count"):GetComponent(typeof(Text))
	arg0_2.uiList = UIItemList.New(arg0_2._tf:Find("frame/awards"), arg0_2._tf:Find("frame/awards/award"))
