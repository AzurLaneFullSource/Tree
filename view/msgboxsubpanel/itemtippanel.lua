...
function var0_0.ShowOilBuyTip(arg0_7, arg1_7)
	...
	local var2_7 = ShopConst.GetShopConfig(var1_7)
...
function var0_0.OnInit(arg0_10)
	arg0_10.list = arg0_10._tf:Find("skipable_list")
	arg0_10.tpl = arg0_10.list:Find("tpl")
	arg0_10.title = arg0_10._tf:Find("name")
end
...
function var0_0.ConfigGoScene(arg0_15, arg1_15, arg2_15)
	...
	elseif arg0_15 == SCENE.MILITARYEXERCISE then
	...
	elseif arg0_15 == BaseUI.ON_ITEM then
		existCall(arg2_15)

		local var16_15 = getProxy(ContextProxy):getCurrentContext()

		pg.m02:retrieveMediator(var16_15.mediator.__cname):addSubLayers(Context.New({
