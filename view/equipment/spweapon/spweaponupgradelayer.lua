...
function var0_0.InitUI(arg0_3)
	arg0_3.rightPanel = arg0_3._tf:Find("Right")
	arg0_3.leftPanel = arg0_3._tf:Find("Left")
	arg0_3.equipmentPanel = arg0_3.rightPanel:Find("EquipmentPanel")
	arg0_3.equipmentPanelTitleStrengthen = arg0_3.equipmentPanel:Find("Title/Strengthen")
	arg0_3.equipmentPanelTitleUpgrade = arg0_3.equipmentPanel:Find("Title/Upgrade")
	arg0_3.equipmentPanelTitleComposite = arg0_3.equipmentPanel:Find("Title/Composite")
	arg0_3.equipmentPanelIcon1 = arg0_3.equipmentPanel:Find("Container/Equiptpl")
	arg0_3.equipmentPanelIcon2 = arg0_3.equipmentPanel:Find("Container/Equiptpl2")
	arg0_3.equipmentPanelArrow = arg0_3.equipmentPanel:Find("Container/Slot")
	arg0_3.craftTargetCount = arg0_3.equipmentPanel:Find("TotalCount")
	arg0_3.materialPanel = arg0_3.rightPanel:Find("MaterialPanel")
	arg0_3.materialPanelAttrList = arg0_3.materialPanel:Find("ScrollView/List")
	arg0_3.materialPanelExpLv = arg0_3.materialPanel:Find("ExpLv")
	arg0_3.materialPanelExpLvText = arg0_3.materialPanel:Find("ExpLv/Number")

	setActive(arg0_3.materialPanelExpLvText, false)

	arg0_3.materialPanelExpFullText = arg0_3.materialPanel:Find("ExpFull")
	arg0_3.materialPanelExpBar = arg0_3.materialPanel:Find("ExpBar")
	arg0_3.materialPanelExpBarFill = arg0_3.materialPanel:Find("ExpBar/Fill")
	arg0_3.materialPanelExpBarFull = arg0_3.materialPanel:Find("ExpBar/Full")

	setText(arg0_3.materialPanel:Find("ExpFull"), i18n("spweapon_ui_levelmax"))

	arg0_3.materialPanelExpTotalText = arg0_3.materialPanel:Find("ExpTotal")
	arg0_3.materialPanelExpCurrentText = arg0_3.materialPanel:Find("ExpTotal/ExpCurrent")
	arg0_3.materialPanelMaterialList = arg0_3.materialPanel:Find("Materials/List")
	arg0_3.materialPanelMaterialListLimit = arg0_3.materialPanel:Find("Materials/Limit")
	arg0_3.materialPanelMaterialItems = CustomIndexLayer.Clone2Full(arg0_3.materialPanelMaterialList, 3)

	setText(arg0_3.materialPanel:Find("Materials/Title"), i18n("spweapon_ui_need_resource"))
	setText(arg0_3.materialPanel:Find("Materials/Limit/text"), i18n("spweapon_ui_levelmax2"))

	arg0_3.materialPanelCostText = arg0_3.materialPanel:Find("Cost/Consume")
	arg0_3.materialPanelButton = arg0_3.materialPanel:Find("Button")
	arg0_3.materialPanelButtonUpgrade = arg0_3.materialPanel:Find("Button/Upgrade")
	arg0_3.materialPanelButtonStrengthen = arg0_3.materialPanel:Find("Button/Strengthen")
	arg0_3.materialPanelButtonCreate = arg0_3.materialPanel:Find("Button/Create")
	...
	arg0_3.leftPanelAutoSelectButton = arg0_3.leftPanel:Find("Title/AutoSelect")
	arg0_3.leftPanelClearSelectButton = arg0_3.leftPanel:Find("Title/ClearSelect")
	arg0_3.leftPanelItem = arg0_3.leftPanel:Find("Items")

	local var0_3 = arg0_3.leftPanel:Find("Items/Content")
	local var1_3 = arg0_3.leftPanel:Find("Items/EquipItem")

	arg0_3.leftPanelItemRect = UIItemList.New(var0_3, var1_3)

	setText(arg0_3.leftPanel:Find("Items/Top/TextName"), i18n("spweapon_ui_ptitem"))
	setText(arg0_3.leftPanelAutoSelectButton:Find("On/Text"), i18n("spweapon_ui_autoselect"))
	setText(arg0_3.leftPanelAutoSelectButton:Find("Off/Text"), i18n("spweapon_ui_autoselect"))
	setText(arg0_3.leftPanelClearSelectButton:Find("On/Text"), i18n("spweapon_ui_cancelselect"))
	setText(arg0_3.leftPanelClearSelectButton:Find("Off/Text"), i18n("spweapon_ui_cancelselect"))

	arg0_3.LeftPanelEquip = arg0_3.leftPanel:Find("Equips")
	arg0_3.leftPanelEquipScrollComp = GetComponent(arg0_3.leftPanel:Find("Equips/Scroll View"), "LScrollRect")

	setText(arg0_3.leftPanel:Find("Equips/Top/TextName"), i18n("spweapon_ui_spweapon"))

	arg0_3.leftPanelFilterButton = arg0_3.leftPanel:Find("Equips/Top/Filter")

	setText(arg0_3.leftPanel:Find("TipText"), i18n("spweapon_ui_helptext"))
	setText(arg0_3.equipmentPanel:Find("Ship/Detail"), i18n("spweapon_tip_view"))
	setText(arg0_3.equipmentPanel:Find("Ship/Title"), i18n("spweapon_tip_ship"))
	setText(arg0_3.equipmentPanel:Find("ShipType/Title"), i18n("spweapon_tip_type"))
