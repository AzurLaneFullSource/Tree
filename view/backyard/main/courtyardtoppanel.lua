...
function var0_0.init(arg0_2)
	arg0_2.backBtn = arg0_2._tf:Find("btns/topleft/return")
	arg0_2.nameTxt = arg0_2._tf:Find("btns/topleft/name/Text"):GetComponent(typeof(Text))
	arg0_2.renameBtn = arg0_2._tf:Find("btns/topleft/name")
	arg0_2.comfortableBtn = arg0_2._tf:Find("btns/topright/comfortable")
	arg0_2.comfortableTxt = arg0_2._tf:Find("btns/topright/comfortable/Text"):GetComponent(typeof(Text))
	arg0_2.comfortableImg = arg0_2._tf:Find("btns/topright/comfortable/icon"):GetComponent(typeof(Image))
	arg0_2.switchBtn = arg0_2._tf:Find("btns/topright/switch")
	...
	arg0_2.cg = GetOrAddComponent(arg0_2._tf:Find("btns/topright"), typeof(CanvasGroup))

	setText(arg0_2._tf:Find("btns/topright/comfortable/label"), i18n("word_comfort_level"))
	setText(arg0_2._tf:Find("btns/topright/switch/label"), i18n("courtyard_label_floor"))
end
...
function var0_0.UnLockTip(arg0_8)
	...
	local var1_8 = ShopConst.GetShopConfig(var0_8).resource_num
