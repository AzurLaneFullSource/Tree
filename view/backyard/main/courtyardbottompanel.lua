...
function var0_0.init(arg0_2)
	arg0_2.granaryBtn = arg0_2._tf:Find("bottomleft/feed_btn")
	arg0_2.stockBar = arg0_2.granaryBtn:Find("progress"):GetComponent(typeof(Slider))
	arg0_2.stockTimeTxt = arg0_2.granaryBtn:Find("time"):GetComponent(typeof(Text))
	arg0_2.stockTxt = arg0_2.granaryBtn:Find("Text"):GetComponent(typeof(Text))
	arg0_2.stampBtn = arg0_2._tf:Find("stamp")
	arg0_2.shopBtn = arg0_2._tf:Find("bottomright/shop_btn")
	arg0_2.decorateBtn = arg0_2._tf:Find("bottomright/decorate_btn")
	arg0_2.templateBtn = arg0_2._tf:Find("bottomright/theme_template_btn")
	arg0_2.shareBtn = arg0_2._tf:Find("bottomright/share_btn")
	arg0_2.shopTip = arg0_2.shopBtn:Find("tip")
	arg0_2.trainBtn = arg0_2._tf:Find("bottomleft/train_btn")
	...
	arg0_2.icon1 = arg0_2._tf:Find("bottomleft/train_btn/icon")
	arg0_2.icon2 = arg0_2._tf:Find("bottomleft/train_btn/icon_1")
...
function var0_0.OnFlush(arg0_12, arg1_12)
	...
	if bit.band(arg1_12, BackYardConst.DORM_UPDATE_TYPE_UPDATEFOOD) > 0 or bit.band(arg1_12, BackYardConst.DORM_UPDATE_TYPE_LEVEL) > 0 or bit.band(arg1_12, BackYardConst.DORM_UPDATE_TYPE_USEFOOD) > 0 or bit.band(arg1_12, BackYardConst.DORM_UPDATE_TYPE_EXTENDFOOD) > 0 then
		...
		arg0_12.stockBar.value = var0_12.food / (var1_12 + var0_12:GetFoodMax())
		arg0_12.stockTxt.text = math.ceil(var0_12.food) .. "/" .. var1_12 + var0_12:GetFoodMax()
	end
...
function var0_0.UpdateTrainBtn(arg0_14)
	if arg0_14.contextData.floor == 1 then
		...
		arg0_14.trainBtnTxt.text = arg0_14.dorm:GetFloorShipCnt(DormShip.FLOOR_1) .. "/" .. arg0_14.dorm.exp_pos
	elseif arg0_14.contextData.floor == 2 then
		arg0_14.trainBtnLabel.text = i18n("courtyard_label_rest")
		arg0_14.trainBtnTxt.text = arg0_14.dorm:GetFloorShipCnt(DormShip.FLOOR_2) .. "/" .. arg0_14.dorm.rest_pos
	end
end
...
function var0_0.CalcStockLeftTime(arg0_17)
	...
	if var0_17:GetFloorShipCnt(DormShip.FLOOR_1) <= 0 or var0_17.food <= 0 then
		return
	end
