...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.subTitleTxt = arg0_2._tf:Find("frame/view/subtitle2/Text"):GetComponent(typeof(Text))

	setText(arg0_2._tf:Find("frame/view/subtitle1/Text"), i18n("backyard_backyardScene_comforChatContent1"))

	arg0_2.expressionTxt = arg0_2._tf:Find("frame/view/express/Text"):GetComponent(typeof(Text))
	arg0_2.comfortableImg = arg0_2._tf:Find("frame/view/express/icon"):GetComponent(typeof(Image))
	arg0_2.comfortableBg = arg0_2._tf:Find("frame/view/express"):GetComponent(typeof(Image))
	arg0_2.uiItemList = UIItemList.New(arg0_2._tf:Find("frame/view/list/content"), arg0_2._tf:Find("frame/view/list/content/tpl"))
	arg0_2.animation = arg0_2._tf:Find("frame/view"):GetComponent(typeof(Animation))
	arg0_2.dftAniEvent = arg0_2._tf:Find("frame/view"):GetComponent(typeof(DftAniEvent))
	arg0_2.foldBtn = arg0_2._tf:Find("frame/view/fold")
	arg0_2.arr = arg0_2._tf:Find("frame/view/fold/up")
	arg0_2.subTitle = arg0_2._tf:Find("frame/view/subtitle2")
	arg0_2.expAdditionTxt = arg0_2._tf:Find("frame/exp/Text"):GetComponent(typeof(Text))

	setText(arg0_2._tf:Find("frame/exp"), i18n("courtyard_label_comfortable_addition"))
	setText(arg0_2._tf:Find("frame/title"), i18n("word_comfort_level"))
end
