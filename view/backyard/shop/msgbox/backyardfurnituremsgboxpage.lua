...
function var0_0.OnLoaded(arg0_2)
	arg0_2.nameTxt = arg0_2._tf:Find("frame/name"):GetComponent(typeof(Text))
	arg0_2.themeTxt = arg0_2._tf:Find("frame/theme/Text"):GetComponent(typeof(Text))
	arg0_2.descTxt = arg0_2._tf:Find("frame/desc"):GetComponent(typeof(Text))
	arg0_2.iconContainer = arg0_2._tf:Find("frame/icon")
	arg0_2.icon = arg0_2._tf:Find("frame/icon/Image"):GetComponent(typeof(Image))
	arg0_2.playBtn = arg0_2._tf:Find("frame/icon/play")
	arg0_2.rawIcon = arg0_2._tf:Find("frame/icon/rawImage"):GetComponent(typeof(RawImage))
	arg0_2.shipTr = arg0_2._tf:Find("frame/ship")
	arg0_2.shipIcon = arg0_2._tf:Find("frame/ship/icon"):GetComponent(typeof(Image))
	arg0_2.shipTxt = arg0_2._tf:Find("frame/ship/Text"):GetComponent(typeof(Text))
	arg0_2.countPanel = arg0_2._tf:Find("frame/count")
	arg0_2.leftArr = arg0_2._tf:Find("frame/count/left_arr")
	arg0_2.rightArr = arg0_2._tf:Find("frame/count/right_arr")
	arg0_2.countTxt = arg0_2._tf:Find("frame/count/Text"):GetComponent(typeof(Text))
	arg0_2.gemIcon = arg0_2._tf:Find("frame/price/gem")
	arg0_2.gemCount = arg0_2._tf:Find("frame/price/gem_text"):GetComponent(typeof(Text))
	arg0_2.goldIcon = arg0_2._tf:Find("frame/price/gold")
	arg0_2.goldCount = arg0_2._tf:Find("frame/price/gold_text"):GetComponent(typeof(Text))
	arg0_2.line = arg0_2._tf:Find("frame/price/line")
	arg0_2.energyIcon = arg0_2._tf:Find("frame/energy"):GetComponent(typeof(Image))
	arg0_2.energyTxt = arg0_2._tf:Find("frame/energy/Text"):GetComponent(typeof(Text))
	arg0_2.energyAddition = arg0_2._tf:Find("frame/energy/Text/addition"):GetComponent(typeof(Image))
	arg0_2.energyAdditionTxt = arg0_2._tf:Find("frame/energy/Text/addition/Text"):GetComponent(typeof(Text))
	arg0_2.closeBtn = arg0_2._tf:Find("frame/close_btn")
	arg0_2.btns = arg0_2._tf:Find("frame/btns")
	arg0_2.goldPurchaseBtn = arg0_2._tf:Find("frame/btns/gold_purchase_btn")
	arg0_2.gemPurchaseBtn = arg0_2._tf:Find("frame/btns/gem_purchase_btn")
	arg0_2.goldPurchaseIcon = arg0_2._tf:Find("frame/btns/gold_purchase_btn/content/icon")
	arg0_2.gemPurchaseIcon = arg0_2._tf:Find("frame/btns/gem_purchase_btn/content/icon")
	arg0_2.maxCnt = arg0_2._tf:Find("frame/max_cnt"):GetComponent(typeof(Text))
	arg0_2.maxBtn = arg0_2._tf:Find("frame/count/max")
	arg0_2.maxBtnTxt = arg0_2.maxBtn:Find("Text"):GetComponent(typeof(Text))

	setText(arg0_2._tf:Find("frame/price/label"), i18n("backyard_theme_total_print"))
