...
function var0_0.OnLoaded(arg0_3)
	arg0_3.currentTr = arg0_3._tf:Find("current")
	arg0_3.pastTr = arg0_3._tf:Find("past")
	...
	arg0_3.currProgressTr = arg0_3._tf:Find("current_progress")
	arg0_3.pastProgressTr = arg0_3._tf:Find("past_progress")
	arg0_3.currProgressTxt = arg0_3._tf:Find("current_progress/value"):GetComponent(typeof(Text))
	arg0_3.pastProgressTxt = arg0_3._tf:Find("past_progress/value"):GetComponent(typeof(Text))
	arg0_3.backBtn = arg0_3._tf:Find("blur_panel/adapt/top/back")

	local var0_3 = WorldBossConst.GetCurrBossGroup()
	local var1_3 = arg0_3._tf:Find("current"):GetComponent(typeof(Image))

	var1_3.sprite = GetSpriteFromAtlas("MetaWorldboss/" .. var0_3, "cur")

	var1_3:SetNativeSize()
	setText(arg0_3._tf:Find("tip/Text"), i18n("world_boss_item_usage_tip"))
