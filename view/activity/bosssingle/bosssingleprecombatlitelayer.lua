local var0_0 = class("BossSinglePreCombatLiteLayer", import(".BossSinglePreCombatLayer"))
...
function var0_0.CommonInit(arg0_4)
	...
	arg0_4._continuousBtn = arg0_4:findTF("right/multiple")
	...
	setActive(arg0_4._checkBtn, false)
	setActive(arg0_4._continuousBtn, false)
end

function var0_0.Register(arg0_5)
	arg0_5._formationLogic:AddLoadComplete(function()
		if arg0_5._currentForm ~= PreCombatLayer.FORM_EDIT then
	...
	arg0_5._formationLogic:AddLongPress(function(arg0_8, arg1_8, arg2_8, arg3_8)
		arg0_5:emit(BossSinglePreCombatMediator.OPEN_SHIP_INFO, arg1_8.id, arg2_8)
	end)
	...
	arg0_5._formationLogic:AddShiftOnly(function(arg0_12)
		arg0_5:emit(BossSinglePreCombatMediator.CHANGE_FLEET_SHIPS_ORDER, arg0_12)
	end)
	...
	arg0_5._formationLogic:AddSwitchToDisplayMode(function()
		arg0_5._currentForm = PreCombatLayer.FORM_EDIT
	...
	arg0_5._formationLogic:AddSwitchToPreviewMode(function()
		arg0_5._currentForm = PreCombatLayer.FORM_PREVIEW
		arg0_5._checkBtn:GetComponent("Button").interactable = true
	...
	arg0_5._formationLogic:DisableTip()
end
...
function var0_0.quickExitFunc(arg0_35)
	if arg0_35._currentForm == PreCombatLayer.FORM_EDIT then
		arg0_35:emit(BossSinglePreCombatMediator.ON_ABORT_EDIT)
	end
...
function var0_0.didEnter(arg0_36)
		...
		if arg0_36._currentForm == PreCombatLayer.FORM_EDIT then
			table.insert(var0_37, function(arg0_38)
				pg.MsgboxMgr.GetInstance():ShowMsgBox({
					...
					onYes = function()
						arg0_36:emit(BossSinglePreCombatMediator.ON_COMMIT_EDIT, function()
	...
	onButton(arg0_36, arg0_36._startBtn, function()
		...
		seriesAsync(var0_44, function()
			arg0_36:emit(BossSinglePreCombatMediator.ON_START, arg0_36._currentFleetVO.id)
		end)
	...
	onToggle(arg0_36, arg0_36._autoToggle, function(arg0_51)
		arg0_36:emit(BossSinglePreCombatMediator.ON_AUTO, {
			isOn = not arg0_51,
		...
		if arg0_51 and arg0_36._subUseable == true then
			...
			onToggle(arg0_36, arg0_36._autoSubToggle, function(arg0_52)
				arg0_36:emit(BossSinglePreCombatMediator.ON_SUB_AUTO, {
					isOn = not arg0_52,
...
function var0_0.displayFleetInfo(arg0_54)
	local var0_54 = arg0_54._currentFleetVO:getFleetType()

	setActive(arg0_54._vanguardGS.parent, var0_54 == FleetType.Normal)
	setActive(arg0_54._mainGS.parent, var0_54 == FleetType.Normal)
	...
	setActive(arg0_54._subGS.parent, var0_54 == FleetType.Submarine)
	...
	local var5_54 = arg0_54.contextData.system
	local var6_54 = pg.battle_cost_template[var5_54].oil_cost == 0 and 0 or var4_54.oil

	setActive(arg0_54._costContainer, true)
	var1_0.tweenNumText(arg0_54._costText, var6_54)
	var1_0.tweenNumText(arg0_54._vanguardGS, var1_54)
	var1_0.tweenNumText(arg0_54._mainGS, var2_54)
	var1_0.tweenNumText(arg0_54._subGS, var3_54)
	setText(arg0_54._fleetNameText, arg0_54._currentFleetVO:GetName())
	setText(arg0_54._fleetNumText, arg0_54._currentFleetVO.id)

	local var7_54 = arg0_54.contextData.stageId

	if arg0_54.contextData.costLimit then
		local var8_54 = pg.battle_cost_template[var5_54].oil_cost > 0
		local var9_54 = 0
		local var10_54 = 0
		local var11_54 = false

		for iter0_54, iter1_54 in ipairs({
			arg0_54.contextData.fleets[1]
		}) do
			local var12_54 = iter1_54:GetCostSum().oil

			if not var8_54 then
				var12_54 = 0
			end

			var10_54 = var10_54 + var12_54

			local var13_54 = iter0_54 == 1
			local var14_54 = arg0_54.contextData.costLimit[var13_54 and 1 or 2]

			if var14_54 > 0 then
				var11_54 = var11_54 or var14_54 < var12_54
				var12_54 = math.min(var12_54, var14_54)
			end

			var9_54 = var9_54 + var12_54
		end

		setTextColor(arg0_54._costText, var11_54 and Color(0.980392156862745, 0.392156862745098, 0.392156862745098) or Color.white)
		var1_0.tweenNumText(arg0_54._costText, var9_54)
	end

	setActive(arg0_54._costTip, isCostOver)

	if isCostOver then
		onButton(arg0_54, arg0_54._costTip, function()
			pg.MsgboxMgr.GetInstance():ShowMsgBox({
				hideNo = true,
				content = i18n("use_oil_limit_help", baseCost, var4_54)
			})
		end)
	end
end

function var0_0.SetFleetStepper(arg0_56)
	SetActive(arg0_56._nextPage, false)
	SetActive(arg0_56._prevPage, false)
end

function var0_0.onBackPressed(arg0_57)
	pg.CriMgr.GetInstance():PlaySoundEffect_V3(SFX_CANCEL)
	triggerButton(arg0_57._backBtn)
end

function var0_0.willExit(arg0_58)
	pg.UIMgr.GetInstance():UnOverlayPanel(arg0_58._tf)
	arg0_58._formationLogic:Destroy()

	arg0_58._formationLogic = nil
end
