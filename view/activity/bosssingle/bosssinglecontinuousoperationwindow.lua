local var0 = class("BossSingleContinuousOperationWindow", import("view.activity.worldboss.ContinuousOperationWindow"))
local var1 = 15
...
function var0.didEnter(arg0)
	onButton(arg0, arg0.panel:Find("battle"), function()
		...
		arg0:emit(BossSinglePreCombatMediator.CONTINUOUS_OPERATION)
	end, SFX_PANEL)
