local var0 = class("BossSingleContinuousOperationMediator", import("view.base.ContextMediator"))

var0.CONTINUE_OPERATION = "BossSingleContinuousOperationMediator:CONTINUE_OPERATION"
var0.ON_REENTER = "BossSingleContinuousOperationMediator:ON_REENTER"
...
function var0.register(arg0)
	...
	arg0:bind(BattleMediator.HIDE_ALL_BUTTONS, function(arg0, arg1)
		...
		if not arg1 then
			...
			if not var0.IsAutoBotActive(SYSTEM_BOSS_SINGLE) then
				...
				var0:ActiveBot(var0.IsAutoBotActive(SYSTEM_BOSS_SINGLE))
			end
		end
	end)
end
