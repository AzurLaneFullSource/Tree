local var0 = class("BossSingleBattleFleetSelectSubPanel", import("view.base.BaseSubPanel"))
...
function var0.OnInit(arg0)
	...
	setText(arg0:findTF("sub/Text", arg0.tfLimitElite), i18n("ship_limit_notice"))
...
function var0.SetSettings(arg0, arg1, arg2, arg3, arg4, arg5)
	arg0.groupNum = arg1
	arg0.submarineNum = arg2
	arg0.showTryBtn = arg3
	arg0.propetyLimitation = arg4
	arg0.index = arg5
end
...
function var0.updateFleet(arg0, arg1, arg2)
	...
	if var0 and var1 then
		setText(var3, Fleet.DEFAULT_NAME_BOSS_SINGLE_ACT[var1.id] or "")
...
function var0.updatePropetyLimit(arg0)
	setActive(arg0.toggleMask, false)
	setActive(arg0.tfLimit, false)
	setActive(arg0.tfLimitTips, false)
	...
	if #arg0.propetyLimitation > 0 then
		local var0 = UIItemList.New(arg0.tfLimitContainer, arg0.tfLimitContainer:GetChild(0))
		...
		var0:make(function(arg0, arg1, arg2)
			...
			if arg0 == UIItemList.EventUpdate then
				...
				local var5 = AttributeType.EliteCondition2Name(var1, var4) .. AttributeType.eliteConditionCompareTip(var2) .. var3

				setText(arg0:findTF("Text", arg2), var5)
			end
		end)
		var0:align(#arg0.propetyLimitation)
	end
end
...
function var0.IsPropertyLimitationSatisfy(arg0)
	...
	local var1 = arg0.propetyLimitation
	local var2 = {}
	...
	for iter2 = 1, 2 do
		local var5 = arg0.fleets[FleetType.Normal][iter2]

		if var5 then
			for iter3, iter4 in pairs(var5.mainShips) do
				table.insert(var4, iter4)
			end

			for iter5, iter6 in pairs(var5.vanguardShips) do
				table.insert(var4, iter6)
			end
		end
	end
	...
	for iter7, iter8 in ipairs(var1) do
		local var8, var9, var10, var11 = unpack(iter8)

		if string.sub(var8, 1, 5) == "fleet" then
			var6[var8] = 0
			var7[var8] = var11
		end
	end

	for iter9, iter10 in ipairs(var4) do
		local var12 = var0[iter10]

		var3 = var3 + 1

		local var13 = intProperties(var12:getProperties())

		for iter11, iter12 in pairs(var2) do
			if string.sub(iter11, 1, 5) == "fleet" then
				if iter11 == "fleet_totle_level" then
					var6[iter11] = var6[iter11] + var12.level
				end
			elseif iter11 == "level" then
				var2[iter11] = iter12 + var12.level
			else
				var2[iter11] = iter12 + var13[iter11]
			end
		end
	end

	for iter13, iter14 in pairs(var6) do
		if iter13 == "fleet_totle_level" and iter14 > var7[iter13] then
			var2[iter13] = var2[iter13] + 1
		end
	end

	local var14 = {}

	for iter15, iter16 in ipairs(var1) do
		local var15, var16, var17 = unpack(iter16)

		if var15 == "level" and var3 > 0 then
			var2[var15] = math.ceil(var2[var15] / var3)
		end

		var14[iter15] = AttributeType.EliteConditionCompare(var16, var2[var15], var17) and 1 or 0
	end
...
function var0.CheckValid(arg0)
	local var0, var1 = arg0.viewParent.contextData.bossActivity:CheckCntByIdx(arg0.index)

	if not var0 then
		return var0, var1
	end

	local var2, var3 = arg0:IsPropertyLimitationSatisfy()
	local var4 = 1
