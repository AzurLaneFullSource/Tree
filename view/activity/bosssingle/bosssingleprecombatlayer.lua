local var0_0 = class("BossSinglePreCombatLayer", import("view.base.BaseUI"))
...
function var0_0.didEnter(arg0_36)
	...
	local var2_36 = var1_36:GetEnemyDataByStageId(var0_36):IsContinuousType()
	local var3_36 = var2_36 and var1_36:HasPassStage(var0_36)

	setActive(arg0_36._continuousBtn, var2_36)
	setActive(arg0_36._continuousBtn:Find("lock"), not var3_36)

	local var4_36 = var3_36 and Color.white or Color.New(0.298039215686275, 0.298039215686275, 0.298039215686275)

	setImageColor(arg0_36._continuousBtn, var4_36)
	setTextColor(arg0_36._continuousBtn:Find("text"), var4_36)
	setTextColor(arg0_36._continuousBtn:Find("text_en"), var4_36)
	onButton(arg0_36, arg0_36._continuousBtn, function()
		if var3_36 then
			arg0_36:emit(BossSinglePreCombatMediator.SHOW_CONTINUOUS_OPERATION_WINDOW, arg0_36._currentFleetVO.id)
		else
...
function var0_0.displayFleetInfo(arg0_55)
	...
	local var7_55 = getProxy(ActivityProxy):getActivityById(arg0_55.contextData.actId):getConfig("type") == ActivityConst.ACTIVITY_TYPE_BOSSSINGLE_VARIABLE and Fleet.DEFAULT_NAME_BOSS_SINGLE_VARIABLE_ACT or Fleet.DEFAULT_NAME_BOSS_SINGLE_ACT

	setText(arg0_55._fleetNameText, var7_55[arg0_55._currentFleetVO.id])
	setText(arg0_55._fleetNumText, arg0_55._currentFleetVO.id)

	local var8_55 = arg0_55.contextData.stageId
	local var9_55 = pg.battle_cost_template[var5_55].oil_cost > 0
	local var10_55 = 0
	local var11_55 = 0
	local var12_55 = false

	for iter0_55, iter1_55 in ipairs({
		arg0_55.contextData.fleets[1]
	}) do
		local var13_55 = iter1_55:GetCostSum().oil

		if not var9_55 then
			var13_55 = 0
		end

		var11_55 = var11_55 + var13_55

		local var14_55 = iter0_55 == 1
		local var15_55 = arg0_55.contextData.costLimit[var14_55 and 1 or 2]

		if var15_55 > 0 then
			var12_55 = var12_55 or var15_55 < var13_55
			var13_55 = math.min(var13_55, var15_55)
		end

		var10_55 = var10_55 + var13_55
	end

	setTextColor(arg0_55._costText, var12_55 and Color(0.980392156862745, 0.392156862745098, 0.392156862745098) or Color.white)
	var1_0.tweenNumText(arg0_55._costText, var10_55)
	setActive(arg0_55._costTip, var12_55)
