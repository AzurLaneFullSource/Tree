local var0 = class("BossSinglePreCombatLayer", import("view.base.BaseUI"))
...
function var0.Register(arg0)
	...
	arg0._formationLogic:AddLongPress(function(arg0, arg1, arg2, arg3)
		arg0:emit(BossSinglePreCombatMediator.OPEN_SHIP_INFO, arg1.id, arg2)
	end)
	...
	arg0._formationLogic:AddShiftOnly(function(arg0)
		arg0:emit(BossSinglePreCombatMediator.CHANGE_FLEET_SHIPS_ORDER, arg0)
	end)
...
function var0.quickExitFunc(arg0)
	if arg0._currentForm == PreCombatLayer.FORM_EDIT then
		arg0:emit(BossSinglePreCombatMediator.ON_ABORT_EDIT)
	end
...
function var0.didEnter(arg0)
		...
		if arg0._currentForm == PreCombatLayer.FORM_EDIT then
			table.insert(var0, function(arg0)
				pg.MsgboxMgr.GetInstance():ShowMsgBox({
					...
					onYes = function()
						arg0:emit(BossSinglePreCombatMediator.ON_COMMIT_EDIT, function()
	...
	onButton(arg0, arg0._startBtn, function()
		...
		seriesAsync(var0, function()
			arg0:emit(BossSinglePreCombatMediator.ON_START, arg0._currentFleetVO.id)
		end)
	...
	onToggle(arg0, arg0._autoToggle, function(arg0)
		arg0:emit(BossSinglePreCombatMediator.ON_AUTO, {
			isOn = not arg0,
		...
		if arg0 and arg0._subUseable == true then
			...
			onToggle(arg0, arg0._autoSubToggle, function(arg0)
				arg0:emit(BossSinglePreCombatMediator.ON_SUB_AUTO, {
					isOn = not arg0,
	...
	local var2 = var1:GetEnemyDataByStageId(var0):IsContinuousType()
	local var3 = var2 and var1:HasPassStage(var0)

	setActive(arg0._continuousBtn, var2)
	setActive(arg0._continuousBtn:Find("lock"), not var3)

	local var4 = var3 and Color.white or Color.New(0.298039215686275, 0.298039215686275, 0.298039215686275)

	setImageColor(arg0._continuousBtn, var4)
	setTextColor(arg0._continuousBtn:Find("text"), var4)
	setTextColor(arg0._continuousBtn:Find("text_en"), var4)
	onButton(arg0, arg0._continuousBtn, function()
		if var3 then
			arg0:emit(BossSinglePreCombatMediator.SHOW_CONTINUOUS_OPERATION_WINDOW, arg0._currentFleetVO.id)
		else
...
function var0.displayFleetInfo(arg0)
	...
	setText(arg0._fleetNameText, Fleet.DEFAULT_NAME_BOSS_SINGLE_ACT[arg0._currentFleetVO.id])
	...
	local var9 = pg.battle_cost_template[var5].oil_cost > 0
	local var10 = 0
	local var11 = 0
	local var12 = false
	...
	for iter0, iter1 in ipairs({
		...
		local var13 = iter1:GetCostSum().oil
		...
		local var14 = iter0 == 1
		local var15 = arg0.contextData.costLimit[var14 and 1 or 2]

		if var15 > 0 then
			var12 = var12 or var15 < var13
			var13 = math.min(var13, var15)
		end

		var10 = var10 + var13
	end

	setTextColor(arg0._costText, var12 and Color(0.980392156862745, 0.392156862745098, 0.392156862745098) or Color.white)
	var1.tweenNumText(arg0._costText, var10)
	...
	if var12 then
		onButton(arg0, arg0._costTip, function()
			pg.MsgboxMgr.GetInstance():ShowMsgBox({
				hideNo = true,
				content = i18n("use_oil_limit_help", var11, var10),
