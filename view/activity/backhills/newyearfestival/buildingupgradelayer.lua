...
function var0_0.init(arg0_2)
	arg0_2.btnUpgrade = arg0_2._tf:Find("window/frame/upgrade_btn")

	setText(arg0_2._tf:Find("window/frame/costback/label"), i18n("word_consume"))
	setText(arg0_2._tf:Find("window/frame/upgrade_btn/Image"), i18n("msgbox_text_upgrade"))
...
function var0_0.didEnter(arg0_4)
	...
	onButton(arg0_4, arg0_4._tf:Find("mengban"), function()
		arg0_4:closeView()
	end)
...
function var0_0.Set(arg0_7, arg1_7, arg2_7)
	...
	setText(arg0_7._tf:Find("window/top/name"), var0_7.name)
	setText(arg0_7._tf:Find("window/top/name/lv"), "Lv." .. var2_7)
	setScrollText(arg0_7._tf:Find("window/frame/describe/text"), var0_7.desc)
	setText(arg0_7._tf:Find("window/frame/content/title/lv/current"), "Lv." .. var2_7)
	setActive(arg0_7._tf:Find("window/frame/content/title/lv/next"), not var4_7)

	if not var4_7 then
		setText(arg0_7._tf:Find("window/frame/content/title/lv/next"), "Lv." .. var2_7 + 1)
	end
	...
	setText(arg0_7._tf:Find("window/frame/content/preview/current"), var9_7.desc)
	setActive(arg0_7._tf:Find("window/frame/content/preview/arrow"), not var4_7)
	setActive(arg0_7._tf:Find("window/frame/content/preview/next"), not var4_7)
	...
	if not var4_7 then
		...
		setText(arg0_7._tf:Find("window/frame/content/preview/next"), var11_7.desc)
		arg0_7.loader:GetSprite(Item.getConfigData(var5_7).icon, "", arg0_7._tf:Find("window/frame/costback/icon"))
	end

	setText(arg0_7._tf:Find("window/frame/costback/cost"), not var4_7 and var0_7.material[var2_7][1][3] or 0)
