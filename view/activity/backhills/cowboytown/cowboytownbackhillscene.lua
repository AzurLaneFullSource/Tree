...
function var0_0.didEnter(arg0_2)
	onButton(arg0_2, arg0_2._tf:Find("top/btn_back"), function()
		arg0_2:emit(var0_0.ON_BACK)
	end)
	onButton(arg0_2, arg0_2._tf:Find("top/btn_home"), function()
		arg0_2:emit(var0_0.ON_HOME)
	end)
	onButton(arg0_2, arg0_2._tf:Find("top/info/btn_help"), function()
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			type = MSGBOX_TYPE_HELP,
			helps = pg.gametip["0815_main_help"].tip
		})
	end, SFX_PANEL)
	onButton(arg0_2, arg0_2._tf:Find("btn/btn_game"), function()
		arg0_2:emit(CowboyTownMediator.MINI_GAME)
	end)
	onButton(arg0_2, arg0_2._tf:Find("btn/btn_skin"), function()
		arg0_2:emit(CowboyTownMediator.SKIN)
	end)
	onButton(arg0_2, arg0_2._tf:Find("btn/btn_expansion"), function()
		arg0_2:emit(CowboyTownMediator.EXPANSION)
	end)
	onButton(arg0_2, arg0_2._tf:Find("btn/btn_task"), function()
		arg0_2:emit(CowboyTownMediator.TASK)
	end)
	onButton(arg0_2, arg0_2._tf:Find("btn/btn_story"), function()
...
function var0_0.UpdateView(arg0_11)
	setActive(arg0_11._tf:Find("btn/btn_game/tip"), var0_0.MiniGameTip())
	setActive(arg0_11._tf:Find("btn/btn_expansion/tip"), var0_0.ExpansionTips())
...
function var0_0.UpdateStoryView(arg0_13)
	setActive(arg0_13._tf:Find("btn/btn_story/tip"), var0_0.StoryTips())
end
...
function var0_0.UpdateTaskTips(arg0_17)
	setActive(arg0_17._tf:Find("btn/btn_task/tip"), SixYearUsTaskMediator.GetTaskRedTip())
end
