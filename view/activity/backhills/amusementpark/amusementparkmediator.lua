local var0 = class("AmusementParkMediator", import("..TemplateMV.BackHillMediatorTemplate"))
...
function var0.handleNotification(arg0, arg1)
	...
	elseif var0 == ActivityProxy.ACTIVITY_UPDATED then
		if var1:getConfig("type") == ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF then
			arg0.activity = var1

			arg0.viewComponent:UpdateActivity(var1)
		elseif var1:getConfig("type") == ActivityConst.ACTIVITY_TYPE_SHOP_PROGRESS_REWARD then
			local var3 = var1
