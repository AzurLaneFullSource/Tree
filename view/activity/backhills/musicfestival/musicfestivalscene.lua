...
function var0_0.init(arg0_2)
	...
	arg0_2._map = arg0_2._tf:Find("scrollRect/map")
	...
	local var1_2 = LoadPrefabRequestPackage.New("ui/" .. var0_2, var0_2, function(arg0_3)
		...
		local var1_3 = arg0_3:GetComponentsInChildren(typeof(Renderer)):ToTable()

		for iter0_3, iter1_3 in ipairs(var1_3) do
			iter1_3.sortingOrder = var0_3 + 1
		end
	end):Start()
...
function var0_0.updateStageShip(arg0_27)
	...
	if var0_27 then
		local var2_27 = GetSpineRequestPackage.New(var0_27, function(arg0_28)
			arg0_28:SetLocalScale(Vector3(0.5, 0.5, 1))
			arg0_28:SetLocalPosition(Vector3.zero)
			arg0_28:SetParent(arg0_27._stageShip)
			arg0_28:SetSiblingIndex(1)
			setActive(arg0_27._stageShip, true)
			arg0_28:SetAction(var1_27, 0)
