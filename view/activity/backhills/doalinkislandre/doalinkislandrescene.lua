local var0_0 = class("DOALinkIslandReScene", import("..TemplateMV.BackHillTemplate"))
...
function var0_0.init(arg0_2)
	...
	local var6_2 = arg0_2._map:Find("DOAhoushan_hailang")

	pg.ViewUtils.SetSortingOrder(var6_2, var5_2 - 2)
...
function var0_0.didEnter(arg0_3)
	...
	local var0_3 = arg0_3:GetDOA2MiniGameId(ActivityConst.MINIGAME_VOLLEYBALL)

	arg0_3:InitFacilityCross(arg0_3._map, arg0_3._upper, "shatanpaiqiu", function()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, var0_3)
	end)

	local var1_3 = arg0_3:GetDOA2MiniGameId(ActivityConst.MINIGAME_PENGPENGDONG)

	onButton(arg0_3, arg0_3._upper:Find("pengpengdong"), function()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, var1_3)
	end, SFX_PANEL)
	arg0_3:InitFacilityCross(arg0_3._map, arg0_3._upper, "daoyvjianshe", function()
		arg0_3:emit(DOALinkIslandReMediator.GO_SCENE, SCENE.ACTIVITY, {
			id = ActivityConst.DOA_PT_ID
		})
	end)
	arg0_3:InitFacilityCross(arg0_3._map, arg0_3._upper, "bujishangdian", function()
		arg0_3:emit(DOALinkIslandReMediator.GO_SCENE, SCENE.SHOP, {
			warp = NewShopsScene.TYPE_ACTIVITY
		})
	end)
	arg0_3:InitFacilityCross(arg0_3._map, arg0_3._upper, "huanzhuangshangdian", function()
		arg0_3:emit(DOALinkIslandReMediator.GO_SCENE, SCENE.SKINSHOP)
	end)
	arg0_3:InitFacilityCross(arg0_3._map, arg0_3._upper, "xianshijianzao", function()
		arg0_3:emit(DOALinkIslandReMediator.GO_SCENE, SCENE.GETBOAT, {
			projectName = "new",
			page = 1
		})
	end)
	arg0_3:InitFacilityCross(arg0_3._map, arg0_3._upper, "jinianzhang", function()
		arg0_3:emit(DOALinkIslandReMediator.GO_SCENE, SCENE.DOA2_MEDAL_COLLECTION_SCENE)
	end)
	arg0_3:InitFacilityCross(arg0_3._map, arg0_3._upper, "tebiezuozhan", function()
		local var0_14 = pg.activity_template[ActivityConst.DOA_PT_ID].config_client.fightLinkActID
		local var1_14 = getProxy(ChapterProxy)
		local var2_14, var3_14 = var1_14:getLastMapForActivity(var0_14)

		if not var2_14 or not var1_14:getMapById(var2_14):isUnlock() then
			pg.TipsMgr.GetInstance():ShowTips(i18n("common_activity_end"))
		else
			arg0_3:emit(DOALinkIslandReMediator.GO_SCENE, SCENE.LEVEL, {
				chapterId = var3_14,
				mapIdx = var2_14
			})
		end
...
function var0_0.GetDOA2MiniGameId(arg0_22, arg1_22)
	local var0_22 = pg.activity_template[arg1_22]
	...
	local var1_22 = var0_22.config_id

	for iter0_22 = #pg.mini_game.all, 1, -1 do
		local var2_22 = pg.mini_game.all[iter0_22]
		local var3_22 = pg.mini_game[var2_22]

		if var3_22 and var3_22.hub_id == var1_22 then
			return var2_22
		end
	end
