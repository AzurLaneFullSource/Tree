local var0 = class("JiuJiuExpeditionCollectionLayer", import("...base.BaseUI"))

function var0.getUIName(arg0)
	return "JiuJiuExpeditionCollectionUI"
end

function var0.SetData(arg0, arg1, arg2, arg3, arg4)
	arg0.allDatas = arg1
	arg0.completeDatas = arg2
	arg0.getRewardIndex = arg3
	arg0.gotRewardIndex = arg4
end

local function var1(arg0, arg1, arg2)
	return table.contains(arg0.completeDatas, arg2)
end
...
function var0.IsGotAward(arg0, arg1)
	if arg1 <= arg0.gotRewardIndex then
		return true
	end
...
function var0.GetAwardState(arg0, arg1)
	if arg1 > arg0.gotRewardIndex + 1 then
		return var2
	elseif arg1 <= arg0.gotRewardIndex then
		return var4
	elseif arg1 == arg0.gotRewardIndex + 1 and arg1 <= arg0.getRewardIndex then
		return var3
	else
		return var2
	end
...
function var0.updateBooks(arg0)
	for iter0, iter1 in ipairs(arg0.books) do
		local var0 = iter0 <= arg0.gotRewardIndex + 1
...
function var0.OpenBook(arg0, arg1)
	...
	onButton(arg0, arg0.getBtn, function()
		arg0:emit(JiuJiuExpeditionCollectionMediator.ON_GET, arg1)
	end, SFX_PANEL)
...
function var0.UpdatePage(arg0, arg1, arg2, arg3)
	arg0.scoreList:make(function(arg0, arg1, arg2)
		if arg0 == UIItemList.EventUpdate then
			...
			local var1 = "JiuJiuExpeditionCollectionIcon/" .. arg1 .. "_" .. arg1 + 1 + arg3
