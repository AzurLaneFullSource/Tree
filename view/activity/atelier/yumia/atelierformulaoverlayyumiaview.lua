...
function var0_0.InitCustom(arg0_1)
	setText(arg0_1._tf:Find("closeBtn/Text"), i18n("yumia_atelier_tip6"))
	setText(arg0_1._tf:Find("RestCount/Text_1"), i18n("yumia_atelier_tip8"))
	setText(arg0_1._tf:Find("List/Text"), i18n("yumia_atelier_tip9"))
end

function var0_0.didEnter(arg0_2)
	var0_0.super.didEnter(arg0_2)
	onButton(arg0_2, arg0_2._tf:Find("closeBtn"), function()
...
function var0_0.RefreshFormulaInfo(arg0_4, arg1_4)
	...
	arg0_4._parentClass:UpdateRyzaDrop(arg0_4._tf:Find("Icon"), var0_4)
	setText(arg0_4._tf:Find("Name"), arg1_4:GetName())
	setText(arg0_4._tf:Find("Description/Text"), arg1_4:GetDesc())
	...
	setText(arg0_4._tf:Find("RestCount/cntText"), var1_4)
end
