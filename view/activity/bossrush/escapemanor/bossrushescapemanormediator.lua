local var0_0 = class("BossRushEscapeManorMediator", import("view.base.ContextMediator"))

var0_0.ON_FLEET_SELECT = "BossRushEscapeManorMediator.ON_FLEET_SELECT"
var0_0.ON_EXTRA_RANK = "BossRushEscapeManorMediator.ON_EXTRA_RANK"
var0_0.ON_TASK_SUBMIT = "BossRushEscapeManorMediator.ON_TASK_SUBMIT"
var0_0.ON_PERFORM_COMBAT = "BossRushEscapeManorMediator.ON_PERFORM_COMBAT"
var0_0.GO_SUBLAYER = "BossRushEscapeManorMediator.GO_SUBLAYER"
var0_0.GO_SCENE = "BossRushEscapeManorMediator.GO_SCENE"
...
function var0_0.register(arg0_1)
	...
	arg0_1:bind(var0_0.ON_FLEET_SELECT, function(arg0_4, arg1_4)
		BossRushEscapeManorPassedLayer.seriesId = arg1_4.configId
	...
	local var2_1 = getProxy(ActivityProxy):getActivityById(ActivityConst.ESCAPE_BOSS_RUSH_PT_ID)
...
function var0_0.handleNotification(arg0_11, arg1_11)
	...
	elseif var0_11 == ActivityProxy.ACTIVITY_UPDATED then
		...
		if var3_11 then
			...
			elseif var3_11.id == ActivityConst.ESCAPE_BOSS_RUSH_PT_ID then
