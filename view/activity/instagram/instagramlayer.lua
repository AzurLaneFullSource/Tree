...
function var0_0.init(arg0_6)
	...
	arg0_6.listTF = arg0_6._tf:Find("list")
	arg0_6.mainTF = arg0_6._tf:Find("main")
	arg0_6.closeBtn = arg0_6._tf:Find("closeBtn")
	arg0_6.noMsgTF = arg0_6._tf:Find("list/bg/no_msg")
	arg0_6.scrollBarTF = arg0_6._tf:Find("list/bg/scroll_bar")
	arg0_6.list = arg0_6._tf:Find("list/bg/scrollrect"):GetComponent("LScrollRect")
	arg0_6.imageTF = arg0_6._tf:Find("main/left_panel/mask/Image"):GetComponent(typeof(RawImage))
	arg0_6.likeBtn = arg0_6._tf:Find("main/left_panel/heart")
	arg0_6.bubbleTF = arg0_6._tf:Find("main/left_panel/bubble")
	arg0_6.planeTF = arg0_6._tf:Find("main/left_panel/plane")
	arg0_6.likeCntTxt = arg0_6._tf:Find("main/left_panel/zan"):GetComponent(typeof(Text))
	arg0_6.pushTimeTxt = arg0_6._tf:Find("main/left_panel/time"):GetComponent(typeof(Text))
	arg0_6.iconTF = arg0_6._tf:Find("main/right_panel/top/head/icon")
	arg0_6.nameTxt = arg0_6._tf:Find("main/right_panel/top/name"):GetComponent(typeof(Text))
	arg0_6.centerTF = arg0_6._tf:Find("main/right_panel/center")
	arg0_6.contentTxt = arg0_6._tf:Find("main/right_panel/center/Text/Text"):GetComponent(typeof(Text))
	arg0_6.commentList = UIItemList.New(arg0_6._tf:Find("main/right_panel/center/bottom/scroll/content"), arg0_6._tf:Find("main/right_panel/center/bottom/scroll/content/tpl"))
	arg0_6.commentPanel = arg0_6._tf:Find("main/right_panel/last/bg2")
	arg0_6.optionalPanel = arg0_6._tf:Find("main/right_panel/last/bg2/option")
	arg0_6.scroll = arg0_6._tf:Find("main/right_panel/center/bottom/scroll")

	setText(arg0_6._tf:Find("closeBtn/Text"), i18n("word_back"))
