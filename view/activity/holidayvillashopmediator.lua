local var0_0 = class("HolidayVillaShopMediator", import("..base.ContextMediator"))

var0_0.OPEN_GOODS_WINDOW = "HolidayVillaShopMediator.OPEN_GOODS_WINDOW"
...
function var0_0.initNotificationHandleDic(arg0_3)
	arg0_3.handleDic = {
		[GAME.ISLAND_SHOPPING_DONE] = function(arg0_4, arg1_4)
			...
			arg0_4.viewComponent:refreshAllGoodsCard()
			arg0_4.viewComponent:setPlayer(getProxy(PlayerProxy):getData())
		end,
		[GAME.USE_ITEM_DONE] = function(arg0_7, arg1_7)
			local var0_7 = arg1_7:getBody().drops
