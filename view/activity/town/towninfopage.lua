...
function var0_0.OnLoaded(arg0_2)
	arg0_2.togglesTF = arg0_2._tf:Find("frame/toggles")

	eachChild(arg0_2.togglesTF, function(arg0_3)
		onToggle(arg0_2, arg0_3, function(arg0_4)
			setImageColor(arg0_3:Find("name"), Color.NewHex(arg0_4 and "F5ECDD" or "796464"))
		end, SFX_PANEL)
	end)

	arg0_2.townTip = arg0_2.togglesTF:Find("town/tip")
	arg0_2.placeTip = arg0_2.togglesTF:Find("place/tip")
	arg0_2.shipTip = arg0_2.togglesTF:Find("ship/tip")
	arg0_2.townPanel = arg0_2._tf:Find("frame/panels/town_panel")
	arg0_2.townLevelNow = arg0_2.townPanel:Find("lvmask/level_now")
	arg0_2.townLevelNext = arg0_2.townPanel:Find("lvmask/level_next")
	arg0_2.curExp = arg0_2.townPanel:Find("infos/exp/value/cur")
	arg0_2.needExp = arg0_2.townPanel:Find("infos/exp/value/need")
	arg0_2.goldOutput = arg0_2.townPanel:Find("infos/output/value")
	arg0_2.goldLimit = arg0_2.townPanel:Find("infos/limit/value")
	arg0_2.townUpgradeTF = arg0_2.townPanel:Find("upgrade_status")
	arg0_2.shipPanel = arg0_2._tf:Find("frame/panels/ship_panel")
	arg0_2.shipUIList = UIItemList.New(arg0_2.shipPanel:Find("content"), arg0_2.shipPanel:Find("content/tpl"))
	...
	arg0_2.placePanel = arg0_2._tf:Find("frame/panels/place_panel")

	setText(arg0_2.placePanel:Find("view/content/tpl/next/title"), i18n("town_place_next_title"))

	arg0_2.placeUIList = UIItemList.New(arg0_2.placePanel:Find("view/content"), arg0_2.placePanel:Find("view/content/tpl"))
...
function var0_0.OnInit(arg0_8)
	...
	triggerToggle(arg0_8.togglesTF:Find("town"), true)
end
...
function var0_0.UpdateTownStatus(arg0_17)
	...
	onButton(arg0_17, arg0_17.townUpgradeTF:Find("normal"), function()
	...
	if var1_17 == "no_story" then
		setText(arg0_17.townUpgradeTF:Find("no_story/content/value/cur"), var2_17[1])
		setText(arg0_17.townUpgradeTF:Find("no_story/content/value/need"), "/" .. var2_17[2])
	elseif var1_17 == "no_exp_or_gold" then
		setTextColor(arg0_17.townUpgradeTF:Find("no_exp_or_gold/cost/Text"), Color.NewHex(var2_17 == "no_gold" and "FF756E" or "FFEBC9"))
	end
end
...
function var0_0.FlushTownWithoutLv(arg0_20)
	...
	setText(arg0_20.townUpgradeTF:Find("normal/cost/Text"), var2_20)
	setText(arg0_20.townUpgradeTF:Find("no_exp_or_gold/cost/Text"), var2_20)
...
function var0_0.UpdateShip(arg0_23, arg1_23, arg2_23)
	...
	setActive(arg2_23:Find("lock"), var1_23)

	if var1_23 then
		setText(arg2_23:Find("lock/Text"), i18n("town_lock_level", "LV" .. arg0_23.slotUnlockLv[var0_23]))
	end

	local var2_23 = arg0_23.shipIds[var0_23]
	local var3_23 = not var2_23 or var2_23 == 0

	setActive(arg2_23:Find("empty"), var3_23)
	setActive(arg2_23:Find("mask"), not var3_23)
	...
	if not var3_23 then
		...
		if var5_23 then
			...
			setImageSprite(arg2_23:Find("mask/icon"), var6_23, true)
		else
			setActive(arg2_23:Find("empty"), true)
			setActive(arg2_23:Find("mask"), false)
		end
	end
...
function var0_0.UpdatePlaceStatus(arg0_28, arg1_28, arg2_28)
	local var0_28 = arg2_28:Find("upgrade_status")
	local var1_28 = TownActivity.GoldToShow(arg1_28:GetCostGold())

	setText(var0_28:Find("normal/cost/Text"), var1_28)
	setText(var0_28:Find("no_gold/cost/Text"), var1_28)
	...
	onButton(arg0_28, var0_28:Find("normal"), function()
	...
	if var3_28 == "no_level" then
		setText(var0_28:Find("no_level/Text"), i18n("town_lock_level", "LV" .. arg1_28:GetNeedTownLv()))
	end
end
...
function var0_0.UpdatePlace(arg0_31, arg1_31, arg2_31)
	...
	setImageSprite(arg2_31:Find("info/icon"), GetSpriteFromAtlas("ui/townui_atlas", var0_31:GetIcon()), true)
	setText(arg2_31:Find("info/name"), var0_31:GetName())
	setText(arg2_31:Find("info/gold/Text"), var0_31:GetEffectStr())
	seriesAsync({
		function(arg0_32)
		...
		function(arg0_35)
			...
			setActive(arg2_31:Find("next"), not var1_35)

			if not var1_35 then
				setText(arg2_31:Find("next/infos/exp/value"), "+" .. var0_31:GetAddExp())

				local var2_35 = TownWorkplace.New(var0_35)

				setText(arg2_31:Find("next/infos/gold/value"), var2_35:GetEffectStr())
			end
		end
	}, function()
		return
	end)
	setActive(arg2_31:Find("info/gold"), var0_31:GetGroup() ~= arg0_31.specialWorkGroup)
	setActive(arg2_31:Find("next/infos/gold"), var0_31:GetGroup() ~= arg0_31.specialWorkGroup)
...
function var0_0.OnUpdateTime(arg0_37)
	...
	for iter0_37, iter1_37 in ipairs(arg0_37.placeList) do
		arg0_37:UpdatePlaceStatus(iter1_37, arg0_37.placeUIList.container:Find(iter0_37))
	end
