local var0 = class("ActivityBossPreCombatMediator", import("view.base.ContextMediator"))
...
function var0.register(arg0)
	...
	local var3 = getProxy(ActivityProxy):getActivityById(arg0.contextData.actId):GetBossConfig():GetTicketID()

	arg0.viewComponent:SetTicketItemID(var3)
end
