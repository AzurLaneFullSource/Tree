local var0 = class("ActivityBossPreCombatLayer", import("view.battle.PreCombatLayer"))
...
function var0.CommonInit(arg0)
	...
	arg0._ticket = arg0._startBtn:Find("ticket")
	arg0._bonus = arg0._startBtn:Find("bonus")
	...
	setText(arg0._ticket:Find("title"), i18n("ex_pass_use"))
	setText(arg0._bonus:Find("title"), i18n("expedition_extra_drop_tip"))
end

function var0.Register(arg0)
	arg0._formationLogic:AddLoadComplete(function()
		if arg0._currentForm ~= PreCombatLayer.FORM_EDIT then
	...
	arg0._formationLogic:AddLongPress(function(arg0, arg1, arg2, arg3)
		arg0:emit(ActivityBossPreCombatMediator.OPEN_SHIP_INFO, arg1.id, arg2)
	end)
	...
	arg0._formationLogic:AddShiftOnly(function(arg0)
		arg0:emit(ActivityBossPreCombatMediator.CHANGE_FLEET_SHIPS_ORDER, arg0)
	end)
	...
	arg0._formationLogic:AddSwitchToDisplayMode(function()
		arg0._currentForm = PreCombatLayer.FORM_EDIT
	...
	arg0._formationLogic:AddSwitchToPreviewMode(function()
		arg0._currentForm = PreCombatLayer.FORM_PREVIEW
		arg0._checkBtn:GetComponent("Button").interactable = true
	...
	if arg0.contextData.system == SYSTEM_ACT_BOSS then
		arg0._formationLogic:DisableTip()
	end
end
...
function var0.SetTicketItemID(arg0, arg1)
	arg0._ticketItemID = arg1
end
...
function var0.UpdateFleetView(arg0, arg1)
	...
	arg0._formationLogic:ResetGrid(TeamType.Vanguard, arg0._currentForm ~= PreCombatLayer.FORM_EDIT)
	arg0._formationLogic:ResetGrid(TeamType.Main, arg0._currentForm ~= PreCombatLayer.FORM_EDIT)
	arg0._formationLogic:ResetGrid(TeamType.Submarine, arg0._currentForm ~= PreCombatLayer.FORM_EDIT)
...
function var0.quickExitFunc(arg0)
	if arg0._currentForm == PreCombatLayer.FORM_EDIT then
		arg0:emit(ActivityBossPreCombatMediator.ON_ABORT_EDIT)
	end
...
function var0.didEnter(arg0)
		...
		if arg0._currentForm == PreCombatLayer.FORM_EDIT then
			table.insert(var0, function(arg0)
				pg.MsgboxMgr.GetInstance():ShowMsgBox({
					...
					onYes = function()
						arg0:emit(ActivityBossPreCombatMediator.ON_COMMIT_EDIT, function()
	...
	onButton(arg0, arg0._startBtn, function()
		...
		seriesAsync(var0, function()
			arg0:emit(ActivityBossPreCombatMediator.ON_START, arg0._currentFleetVO.id)
		end)
	...
	onButton(arg0, arg0._checkBtn, function()
		...
		elseif arg0._currentForm == PreCombatLayer.FORM_PREVIEW then
	...
	onToggle(arg0, arg0._autoToggle, function(arg0)
		arg0:emit(ActivityBossPreCombatMediator.ON_AUTO, {
			isOn = not arg0,
		...
		if arg0 and arg0._subUseable == true then
			...
			onToggle(arg0, arg0._autoSubToggle, function(arg0)
				arg0:emit(ActivityBossPreCombatMediator.ON_SUB_AUTO, {
					isOn = not arg0,
	...
	local var1 = getProxy(ActivityProxy):getActivityById(arg0.contextData.actId)

	setActive(arg0._continuousBtn, arg0.contextData.system == SYSTEM_ACT_BOSS)

	local var2 = var1 and var1:IsOilLimit(var0)

	setActive(arg0._continuousBtn:Find("lock"), not var2)

	local var3 = var2 and Color.white or Color.New(0.298039215686275, 0.298039215686275, 0.298039215686275)

	setImageColor(arg0._continuousBtn, var3)
	setTextColor(arg0._continuousBtn:Find("text"), var3)
	setTextColor(arg0._continuousBtn:Find("text_en"), var3)
	onButton(arg0, arg0._continuousBtn, function()
		if var2 then
			arg0:emit(ActivityBossPreCombatMediator.SHOW_CONTINUOUS_OPERATION_WINDOW, arg0._currentFleetVO.id)
		else
...
function var0.displayFleetInfo(arg0)
	...
	setActive(arg0._costContainer, true)
	...
	local var8 = getProxy(ActivityProxy):getActivityById(arg0.contextData.actId):GetStageBonus(var7)

	setActive(arg0._bonus, var8 > 0)
	setActive(arg0._ticket, var8 <= 0)
	setText(arg0._bonus:Find("Text"), var8)

	if var8 <= 0 then
		local var9 = Drop.New({
			type = DROP_TYPE_RESOURCE,
			id = arg0._ticketItemID
		}):getIcon()
		local var10 = LoadSprite(var9, "")

		setImageSprite(arg0._ticket:Find("icon"), var10)

		local var11 = getProxy(PlayerProxy):getRawData():getResource(arg0._ticketItemID)
		local var12 = 1
		local var13 = arg0._ticket:Find("checkbox")

		if var5 == SYSTEM_BOSS_EXPERIMENT then
			var12 = 0

			triggerToggle(var13, false)
			setToggleEnabled(var13, false)
		elseif var5 == SYSTEM_HP_SHARE_ACT_BOSS then
			triggerToggle(var13, true)
			setToggleEnabled(var13, false)
		elseif var5 == SYSTEM_ACT_BOSS_SP then
			setActive(arg0._ticket, false)
		elseif var5 == SYSTEM_ACT_BOSS then
			local var14 = var11 > 0
			local var15 = getProxy(SettingsProxy):isTipActBossExchangeTicket() == 1

			setToggleEnabled(var13, var14)
			triggerToggle(var13, var14 and var15)
		end

		var11 = var11 < var12 and setColorStr(var11, COLOR_RED) or var11

		setText(arg0._ticket:Find("Text"), var12 .. "/" .. var11)
		onToggle(arg0, var13, function(arg0)
			getProxy(SettingsProxy):setActBossExchangeTicketTip(arg0 and 1 or 0)
		end, SFX_PANEL, SFX_CANCEL)
	end

	local var16 = pg.battle_cost_template[var5].oil_cost > 0
	local var17 = 0
	local var18 = 0
	local var19 = false

	for iter0, iter1 in ipairs({
		arg0.contextData.fleets[1]
	}) do
		local var20 = iter1:GetCostSum().oil
		...
		local var21 = iter0 == 1
		local var22 = arg0.contextData.costLimit[var21 and 1 or 2]

		if var22 > 0 then
			var19 = var19 or var22 < var20
			var20 = math.min(var20, var22)
		end

		var17 = var17 + var20
	end

	setTextColor(arg0._costText, var19 and Color(0.980392156862745, 0.392156862745098, 0.392156862745098) or Color.white)
	var1.tweenNumText(arg0._costText, var17)
	setActive(arg0._costTip, var19)

	if var19 then
		onButton(arg0, arg0._costTip, function()
			pg.MsgboxMgr.GetInstance():ShowMsgBox({
				hideNo = true,
				content = i18n("use_oil_limit_help", var18, var17),
				weight = LayerWeightConst.SECOND_LAYER
			})
		end)
	end

	setText(arg0._fleetNameText, Fleet.DEFAULT_NAME_BOSS_ACT[arg0._currentFleetVO.id])
end
