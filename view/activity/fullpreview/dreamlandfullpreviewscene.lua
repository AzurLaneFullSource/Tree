...
function var0_0.init(arg0_2)
	local var0_2 = arg0_2._tf:Find("btns")

	arg0_2.dreamlandBtn = var0_2:Find("dreamland")
	arg0_2.skinBtn = var0_2:Find("skin")
	arg0_2.buildBtn = var0_2:Find("build")
	arg0_2.battleBtn = var0_2:Find("battle")
	arg0_2.minigameBtn = var0_2:Find("minigame")

	setText(arg0_2._tf:Find("top/info/Text"), i18n("dreamland_main_desc"))
...
function var0_0.UpdateView(arg0_9)
	setActive(arg0_9.minigameBtn:Find("tip"), var0_0.MiniGameTip())
	setActive(arg0_9.dreamlandBtn:Find("dreamland/tip"), var0_0.DreamlandTip())

	arg0_9.isFinishPre = arg0_9:IsFinishPreAct()

	setActive(arg0_9.dreamlandBtn:Find("dreamland"), arg0_9.isFinishPre)
	setActive(arg0_9.dreamlandBtn:Find("pre_act"), not arg0_9.isFinishPre)

	local var0_9 = getProxy(ActivityProxy):getActivityById(arg0_9.preActId)

	setActive(arg0_9.dreamlandBtn:Find("pre_act/tip"), var0_0.ActivityTip(var0_9))
end
