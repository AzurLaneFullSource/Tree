local var0_0 = class("LittleMusashiPage", import(".TemplatePage.PtTemplatePage"))
...
function var0_0.OnUpdateFlush(arg0_4)
	...
	setText(arg0_4.step, setColorStr(var0_4, "#838fff") .. " / " .. setColorStr(var1_4, "#666176"))
	setText(arg0_4.progress, (var5_4 >= 1 and setColorStr(var3_4, COLOR_GREEN) or setColorStr(var3_4, "#7780d3")) .. "/" .. setColorStr(var4_4, "#666176"))
...
function var0_0.updateTaskList(arg0_12, arg1_12, arg2_12, arg3_12, arg4_12)
	...
	if arg4_12.subType ~= 33 then
		setText(findTF(var8_12, "pahase"), setColorStr(var1_12, "#19383") .. "/" .. setColorStr(var0_12, "#5c5967"))
	else
