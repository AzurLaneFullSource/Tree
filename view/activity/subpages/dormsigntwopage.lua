local var0_0 = class("DormSignTwoPage", import("view.base.BaseActivityPage"))
...
function var0_0.OnFirstFlush(arg0_7)
	...
	local var0_7 = pg.SystemOpenMgr.GetInstance():isOpenSystem(getProxy(PlayerProxy):getRawData().level, "SelectDorm3DMediator")

	setActive(arg0_7.goBtn, var0_7)
	setActive(arg0_7.lockTF, not var0_7)
	PlayerPrefs.SetString("DormSignTwoPage", var0_0.GetDate())
end
...
function var0_0.IsShowGoRed()
	return PlayerPrefs.GetString("DormSignTwoPage", "") ~= var0_0.GetDate()
end

function var0_0.IsShowAwardRed()
	local var0_15 = getProxy(ActivityTaskProxy):getTaskById(ActivityConst.DORM_SIGN_ID_2)
