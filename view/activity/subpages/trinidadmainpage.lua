...
function var0_0.updateUI(arg0_6)
	local var0_6, var1_6 = arg0_6.timeMgr:inTime(ShopConst.GetShopConfig(var1_0).time)
	local var2_6

	if var1_6 then
		local var3_6 = arg0_6.timeMgr:Table2ServerTime(var1_6)

		var2_6 = var0_0:TimeStamps(var3_6)
	end

	if var2_6 and var2_6 ~= 0 then
		setActive(arg0_6.shop_bgtime, true)
		setText(arg0_6.shop_time, var2_6)
	else
		setActive(arg0_6.shop_bgtime, false)
	end
	...
	if var5_6 then
		...
		var6_6 = var0_0:TimeStamps(var7_6)
	end

	if var6_6 and var6_6 ~= 0 then
		setActive(arg0_6.build_bgtime, true)
		setText(arg0_6.build_time, i18n("tolovemainpage_build_countdown"))
	else
		setActive(arg0_6.build_bgtime, false)
	end
	...
	onButton(arg0_6, arg0_6.fightbtn, function()
		arg0_6:emit(ActivityMediator.BATTLE_OPERA)
	end)
end

function var0_0.TimeStamps(arg0_10, arg1_10)
	...
	if math.floor(var1_10 / 86400) > 0 then
		...
		if var2_10 > 0 then
			return i18n("time_remaining_tip") .. var2_10 .. i18n("word_hour")
		else
			local var3_10 = math.floor(var1_10 / 60)

			if var3_10 > 0 then
				return i18n("time_remaining_tip") .. var3_10 .. i18n("word_minute")
			else
				return i18n("time_remaining_tip") .. var1_10 .. i18n("word_second")
			end
		end
	end
end
