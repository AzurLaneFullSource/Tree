local var0_0 = class("USSkirmishRePage", import("...base.BaseActivityPage"))
...
function var0_0.initData(arg0_5)
	arg0_5.taskGroup = Clone(pg.activity_template[ActivityConst.ACTIVITY_ID_US_SKIRMISH_RE].config_data)
