local var0 = class("USSkirmishRePage", import("...base.BaseActivityPage"))
...
function var0.initData(arg0)
	arg0.taskGroup = Clone(pg.activity_template[ActivityConst.ACTIVITY_ID_US_SKIRMISH_RE].config_data)
