local var0 = class("MonopolyCar2Game")
local var1 = 100
local var2 = 50
local var3 = "xinnongpaoche"
local var4 = {
	"yuekegongjue_2",
	"dafeng_5",
	"baerdimo_6"
...
local var8 = 0.6
local var9 = "ui/activityuipage/monopolycar2_atlas"
local var10 = "B-stand"
local var11 = "F-stand"
local var12 = "B-walk"
local var13 = "F-walk"
local var14 = "typeMoveUp"
local var15 = "typeMoveDown"
local var16 = "typeMoveLeft"
local var17 = "typeMoveRight"
local var18 = {
	{
		5006,
		5007,
...
function var0.initData(arg0)
	...
	if var4 and #var4 > 0 then
		table.insert(arg0.showCharNames, Clone(var4[math.random(1, #var4)]))
	end

	if var5 and #var5 > 0 then
		table.insert(arg0.showCharNames, Clone(var5[math.random(1, #var5)]))
	end

	if var6 and #var6 > 0 then
		table.insert(arg0.showCharNames, Clone(var6[math.random(1, #var6)]))
	end
end
...
function var0.initUI(arg0)
	...
	for iter0 = 1, 3 do
		table.insert(arg0.showChars, findTF(arg0._tf, "showChar" .. iter0))
	end
...
function var0.initEvent(arg0)
	onButton(arg0._binder, arg0.btnStart, function()
		...
		arg0._event:emit(MonopolyCar2Page.ON_START, arg0.activity.id, function(arg0)
	...
	for iter0 = 1, #arg0.showChars do
		local var0 = arg0.showChars[iter0]

		onButton(arg0._binder, var0, function()
	...
	onButton(arg0._binder, arg0.btnRp, function()
		if arg0.leftAwardCnt > 0 then
			arg0._event:emit(MonopolyCar2Page.ON_AWARD)
		end
	end, SFX_PANEL)
end
...
function var0.showRollAnimated(arg0, arg1)
	...
	seriesAsync({
		...
		if arg0.step > 0 then
			local var0 = GetSpriteFromAtlas(var9, arg0.step)
		end
	...
	for iter0 = 1, #var0 do
		...
		for iter1 = 1, #var3 do
			...
			if var5 > 0 then
				...
				local var9 = GetSpriteFromAtlas(var9, var8)
...
function var0.initChar(arg0)
	...
	for iter0 = 1, #arg0.showCharNames do
		local var0 = arg0.showCharNames[iter0]
		...
		PoolMgr.GetInstance():GetSpineChar(var0, true, function(arg0)
			...
			arg0.transform:SetParent(arg0.showChars[iter0], false)

			local var0 = arg0:GetComponent(typeof(SpineAnimUI))

			if var7[var0] then
				var0:SetAction(var7[var0], 0)
			else
				var0:SetAction("stand", 0)
			end

			table.insert(arg0.showCharMods, arg0)
		end)
	end
end
...
function var0.getMoveType(arg0, arg1, arg2, arg3)
	...
	if var2.y > var1.y then
		var5 = arg3 and var13 or var11
		var6 = var8
	elseif var2.y < var1.y then
		var5 = arg3 and var12 or var10
		var6 = var8
...
function var0.checkStep(arg0, arg1)
	if arg0.step > 0 then
		arg0._event:emit(MonopolyCar2Page.ON_MOVE, arg0.activity.id, function(arg0, arg1, arg2)
			arg0.step = arg0
			arg0.pos = arg1[#arg1]
			arg0.effectId = arg2
...
function var0.triggerEfeect(arg0, arg1)
	arg0._event:emit(MonopolyCar2Page.ON_TRIGGER, arg0.activity.id, function(arg0, arg1)
		if arg0 and #arg0 >= 0 then
			arg0.effectId = arg1
			arg0.pos = arg0[#arg0]
...
function var0.dispose(arg0)
	PoolMgr.GetInstance():ReturnSpineChar(var3, arg0.showModel)

	for iter0 = 1, 3 do
		if arg0.showCharNames[iter0] then
			PoolMgr.GetInstance():ReturnSpineChar(arg0.showCharNames[iter0], arg0.showCharMods[iter0])
		end
	end
end
