local var0 = class("AprilFoolDiscovery2023Page", import(".AprilFoolDiscoveryRePage"))
local var1 = "superburin"

function var0.OnInit(arg0)
	arg0.bg = arg0:findTF("AD")

	local var0 = arg0:findTF("AD/list1")

	arg0.items = CustomIndexLayer.Clone2Full(var0, 5)

	table.insertto(arg0.items, CustomIndexLayer.Clone2Full(arg0:findTF("AD/list2"), 5))
	...
	for iter0 = 1, #var1 do
		arg0.loader:GetSprite("ui/activityuipage/aprilfooldiscovery2023page_atlas", string.sub(var1, iter0, iter0), arg0.items[iter0]:Find("character"))
	end
...
function var0.OnUpdateFlush(arg0)
	...
	setGray(arg0.btnBattle, not var1)
	arg0:UpdateSelection()
