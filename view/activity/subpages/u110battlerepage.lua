local var0 = class("U110BattleRePage", import("...base.BaseActivityPage"))
...
function var0.OnFirstFlush(arg0)
	onButton(arg0, arg0.battleBtn, function()
		local var0 = arg0.activity:getConfig("config_client").fightLinkActID
	...
	onButton(arg0, arg0.buildBtn, function()
		local var0 = arg0.activity:getConfig("config_client").buildLinkActID
		local var1 = var0 and getProxy(ActivityProxy):getActivityById(var0)
