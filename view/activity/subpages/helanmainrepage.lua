local var0_0 = class("HeLanMainRePage", import("...base.BaseActivityPage"))
local var1_0 = 71132
local var2_0 = 5901
local var3_0 = 5901
...
function var0_0.updateUI(arg0_7)
	local var0_7 = false
	local var1_7, var2_7 = arg0_7.timeMgr:inTime(ShopConst.GetShopConfig(var1_0).time)
	local var3_7
	...
	arg0_7.btnFuncList = {
		...
		fight = function(arg0_12)
			onButton(arg0_7, arg0_12, function()
				local var0_13 = pg.activity_template[arg0_7.activity.id].config_client.fightLinkActID

				if var0_13 then
					arg0_7:emit(ActivityMediator.SKIP_ACTIVITY_MAP, var0_13)
				else
