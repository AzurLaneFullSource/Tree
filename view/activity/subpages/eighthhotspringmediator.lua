local var0_0 = class("EighthHotSpringMediator", import("view.activity.BackHills.NewYearFestival.NewYearHotSpringMediator"))
...
function var0_0.register(arg0_1)
	arg0_1:bind(var0_0.UNLOCK_SLOT, function(arg0_2, arg1_2)
		...
		MsgboxMediator.ShowMsgBox({
			...
			content = i18n("eighth_spring_cost", var1_2),
			contextSprites = {
				{
