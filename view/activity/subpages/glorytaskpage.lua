local var0_0 = class("GloryTaskPage", import("...base.BaseActivityPage"))
...
function var0_0.OnFirstFlush(arg0_3)
	onButton(arg0_3, arg0_3.displayBtn, function()
		arg0_3:emit(ActivityMediator.SHOW_AWARD_WINDOW, GloryAwardWindow, {
			taskList = arg0_3.taskList,
			taskVO = arg0_3.taskVO
		})
	end, SFX_PANEL)
