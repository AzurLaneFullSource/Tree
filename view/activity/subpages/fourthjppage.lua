local var0 = class("FourthJpPage", import("...base.BaseActivityPage"))
local var1 = 3
local var2 = 6
...
function var0.findUI(arg0)
	...
	local var0 = arg0.btnContainer.childCount / var1
	...
	for iter3 = 1, var0 * var1 do
		if table.contains(arg0.hideIndex, iter3 % var2) or not arg0.scrollAble and iter3 > var2 then
...
function var0.initData(arg0)
	...
	arg0.paintNamePrefix = "fourthJp"
	arg0.btnCount = arg0.btnContainer.childCount / var1
	arg0.btnSpeed = 50
...
function var0.initBtnList(arg0, arg1)
	...
	onButton(arg0, arg1[3], function()
		arg0:emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.RETUREN_AWARD_1)
	end, SFX_PANEL)
	onButton(arg0, arg1[4], function()
		arg0:emit(ActivityMediator.GO_MINI_GAME, 30)
	end, SFX_PANEL)
	...
	onButton(arg0, arg1[6], function()
		arg0:emit(ActivityMediator.EVENT_GO_SCENE, SCENE.AMUSEMENT_PARK2)
	end, SFX_PANEL)
end
