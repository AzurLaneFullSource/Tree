local var0_0 = class("XiaoAiJiErPage", import(".TemplatePage.PtTemplatePage"))
...
function var0_0.OnUpdateFlush(arg0_3)
	...
	setText(arg0_3.step, setColorStr(var0_3, "#f0d1c6") .. " / " .. var1_3)
	setText(arg0_3.progress, (var5_3 >= 1 and setColorStr(var3_3, COLOR_GREEN) or setColorStr(var3_3, "#f0d1c6")) .. "/" .. var4_3)
...
function var0_0.tryClaimTaskReward(arg0_8)
	local var0_8 = {}

	for iter0_8 = 1, #arg0_8.taskGroups do
		local var1_8 = arg0_8.taskGroups[iter0_8].tasks

		for iter1_8, iter2_8 in ipairs(var1_8) do
			local var2_8 = iter2_8.targetNum
			local var3_8 = iter2_8.progress
			local var4_8 = iter2_8.finish == 1

			if var2_8 <= var3_8 and not var4_8 then
				local var5_8 = arg0_8.taskProxy:getTaskById(iter2_8.id)
	...
	if #var0_8 > 0 then
		arg0_8:emit(ActivityMediator.ON_TASK_SUBMIT_ONESTEP, var0_8)
	end
end
...
function var0_0.updateTaskList(arg0_11, arg1_11, arg2_11, arg3_11, arg4_11)
	...
	if arg4_11.subType ~= 33 then
		setText(findTF(var8_11, "pahase"), setColorStr(var1_11, "#957b01") .. "/" .. var0_11)
	else
