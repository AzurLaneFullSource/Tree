local var0 = class("SignHalloweenPage", import("...base.BaseActivityPage"))
local var1 = 15
...
function var0.SetData(arg0)
	...
	local var1 = var0:GetHubByHubId(arg0.hubId)

	arg0.data = var1
	arg0.ultimate = var1.ultimate
	arg0.usedtime = var1.usedtime
	arg0.count = var1.count
end
