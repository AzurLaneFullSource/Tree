local var0 = class("BeachGamePage", import("view.base.BaseActivityPage"))

var0.MINIGAME_HUB_ID = 37
var0.MINIGAME_ID = 44
...
function var0.OnInit(arg0)
	...
	for iter0 = 1, 7 do
		...
		setActive(var0:Find("open"), iter0 ~= 7)
		setActive(var0:Find("openL"), iter0 == 7)
...
function var0.FlushMarks(arg0, arg1)
	...
	for iter0, iter1 in ipairs(arg0.markTrs) do
		...
		setActive(iter1:Find("finish"), iter0 <= var0 and iter0 ~= 7)
		setActive(iter1:Find("finishL"), iter0 <= var0 and iter0 == 7)
	end
end
