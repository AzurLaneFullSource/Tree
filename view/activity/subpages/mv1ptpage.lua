local var0 = class("Mv1PtPage", import(".TemplatePage.SkinTemplatePage"))
local var1 = 3
local var2
...
function var0.initMv(arg0)
	...
	onButton(arg0, arg0.btnPlay, function()
		if var2 and Time.realtimeSinceStartup - var2 < 1 then
			return
		end
	...
	onButton(arg0, findTF(arg0._tf, "AD/chapter"), function()
		arg0:displayWindow(true)
	end, SFX_PANEL)
	onButton(arg0, findTF(arg0._tf, "AD/left"), function()
		if arg0.mvIndex > 1 and not arg0.isLoading then
			arg0.mvIndex = arg0.mvIndex - 1
	...
	onButton(arg0, findTF(arg0._tf, "AD/right"), function()
		if arg0.mvIndex < arg0.showItemNum and not arg0.isLoading then
			arg0.mvIndex = arg0.mvIndex + 1
...
function var0.UpdateTask(arg0, arg1, arg2)
	local var0 = arg1 + 1
	local var1 = arg0:findTF("itemMask/item", arg2)
	...
	local var8, var9 = arg0:GetProgressColor()
	local var10
	...
	var11 = var9 and setColorStr("/" .. var7, var9) or "/" .. var7

	setText(arg0:findTF("progressText", arg2), var10 .. var11)
	setSlider(arg0:findTF("progress", arg2), 0, var7, var6)

	local var12 = arg0:findTF("go_btn", arg2)
	local var13 = arg0:findTF("get_btn", arg2)
	local var14 = arg0:findTF("got_btn", arg2)
	local var15 = var3:getTaskStatus()

	setActive(var12, var15 == 0)
	setActive(var13, var15 == 1)
	setActive(var14, var15 == 2)
	...
	local var16 = arg0:findTF("get_btn", arg2)
	local var17 = arg1 + 1
	local var18 = arg0.taskGroup[arg0.nday][var17]
	local var19 = arg0.taskProxy:getTaskById(var18) or arg0.taskProxy:getFinishTaskById(var18)

	onButton(arg0, var16, function()
		if arg0.nday <= var1 then
			arg0.mvIndex = arg0.nday

			arg0:emit(ActivityMediator.ON_TASK_SUBMIT, var19)
		else
	...
	local var20 = arg0:findTF("got_btn", arg2)
...
function var0.pageUpdate(arg0)
	...
	for iter1 = 1, var1 do
		setActive(findTF(arg0._tf, "AD/page/" .. iter1 .. "/selected"), arg0.mvIndex == iter1)
	end

	for iter2 = 1, var1 do
		setActive(findTF(arg0._tf, "AD/chapter/" .. iter2), arg0.mvIndex == iter2)
	end

	setActive(findTF(arg0._tf, "AD/right"), arg0.mvIndex ~= arg0.showItemNum)
	setActive(findTF(arg0._tf, "AD/left"), arg0.mvIndex ~= 1)
end
...
function var0.loadMv(arg0)
	...
	local var0 = "psplive_" .. arg0.mvIndex
