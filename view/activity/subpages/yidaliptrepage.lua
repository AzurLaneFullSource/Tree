local var0 = class("YidaliPTRePage", import(".TemplatePage.PtTemplatePage"))
...
function var0.OnUpdateFlush(arg0)
	...
	setText(arg0.progress_l, var7 >= 1 and setColorStr(var5, COLOR_GREEN) or var5)
	setText(arg0.progress_r, "/" .. var6)
