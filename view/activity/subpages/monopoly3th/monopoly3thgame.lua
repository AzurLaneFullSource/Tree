local var0 = class("Monopoly3thGame")
local var1 = 502041
local var2 = 502041
local var3
local var4
...
function var0.initEvent(arg0)
	onButton(arg0._binder, arg0.btnStart, function()
		...
		arg0._event:emit(Monopoly3thPage.ON_START, arg0.activity.id, function(arg0)
	...
	onButton(arg0._binder, arg0.btnRp, function()
		if arg0.leftAwardCnt > 0 then
			arg0._event:emit(Monopoly3thPage.ON_AWARD)
		end
	end, SFX_PANEL)
end
...
function var0.checkLastBonus(arg0)
	if (not arg0.lastBonusFlag or arg0.lastBonusFlag == 0) and arg0.useCount and arg0.useCount >= arg0.lastBonusTimes then
		arg0._event:emit(Monopoly3thPage.MONOPOLY_OP_LAST, arg0.activity.id, function(arg0)
...
function var0.checkStep(arg0, arg1)
	if arg0.step > 0 then
		arg0._event:emit(Monopoly3thPage.ON_MOVE, arg0.activity.id, function(arg0, arg1, arg2)
			arg0.step = arg0
			arg0.pos = arg1[#arg1]
			arg0.effectId = arg2
...
function var0.triggerEfect(arg0, arg1)
	arg0._event:emit(Monopoly3thPage.ON_TRIGGER, arg0.activity.id, function(arg0, arg1)
		if arg0 and #arg0 >= 0 then
			arg0.effectId = arg1
			arg0.pos = arg0[#arg0]
...
function var0.createCell(arg0, arg1)
	...
	local var3 = GetSpriteFromAtlas("ui/activityuipage/monopoly3th_atlas", var1)
