local var0 = class("SkinMagazineTemplatePage", import("view.base.BaseActivityPage"))
...
function var0.OnFirstFlush(arg0)
	...
	arg0:RefreshData()
	setText(arg0.awardTf:Find("get/tip/Text"), i18n(arg0.TIP_KEY))
	...
	for iter1 = 1, arg0.items.childCount do
		...
		var0:GetComponent(typeof(LayoutElement)).preferredWidth = iter1 == arg0.index and arg0.EXPAND_WIDTH or arg0.CLOSE_WIDTH
...
function var0.SelectItem(arg0, arg1)
	...
	for iter2 = 1, arg0.items.childCount do
		...
		local var3 = iter2 == arg1 and arg0.EXPAND_WIDTH or arg0.CLOSE_WIDTH

		if var2 ~= var3 then
			local var4 = math.abs(var3 - var2) / arg0.DURATION_PARAMETER
...
function var0.UpdateDrop(arg0)
	...
	local var1 = Drop.Create(var0:getConfig("award_display")[1])
