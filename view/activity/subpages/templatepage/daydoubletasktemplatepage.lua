local var0_0 = class("DayDoubleTaskTemplatePage", import("view.base.BaseActivityPage"))
...
function var0_0.PlayStory(arg0_13)
	local var0_13 = arg0_13.activity:getConfig("config_client").story
...
function var0_0.OnDestroy(arg0_14)
	eachChild(arg0_14.items, function(arg0_15)
		Destroy(arg0_15)
	end)
end
