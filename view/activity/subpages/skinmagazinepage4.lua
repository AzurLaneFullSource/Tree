local var0 = class("SkinMagazinePage4", import("...base.BaseActivityPage"))
...
function var0.OnFirstFlush(arg0)
	...
	setText(arg0.rtAward:Find("get/click/desc"), i18n(var0.TIP_KEY))

	local var3 = arg0.activity:getConfig("config_client").firstStory

	if var3 then
		pg.NewStoryMgr.GetInstance():Play(var3)
	end
end
