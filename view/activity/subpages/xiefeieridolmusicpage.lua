local var0 = class("XiefeierIdolMusicPage", import("...base.BaseActivityPage"))
local var1 = {
	0.08,
	0.19,
	0.4,
...
function var0.OnUpdateFlush(arg0)
	...
	if arg0.finish_times > 0 then
		setSlider(arg0.slider, 0, 1, var1[arg0.finish_times])
	else
		setSlider(arg0.slider, 0, 1, 0)
	end
	...
	setActive(arg0.bg:Find("got_icon"), arg0.hubData.ultimate ~= 0)
end
