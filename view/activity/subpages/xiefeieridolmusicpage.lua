local var0_0 = class("XiefeierIdolMusicPage", import("...base.BaseActivityPage"))
local var1_0 = {
	0.08,
	0.19,
	0.4,
...
function var0_0.OnUpdateFlush(arg0_5)
	...
	if arg0_5.finish_times > 0 then
		setSlider(arg0_5.slider, 0, 1, var1_0[arg0_5.finish_times])
	else
		setSlider(arg0_5.slider, 0, 1, 0)
	end
	...
	setActive(arg0_5.bg:Find("got_icon"), arg0_5.hubData.ultimate ~= 0)
end
