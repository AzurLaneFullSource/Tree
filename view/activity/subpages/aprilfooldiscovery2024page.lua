...
function var0_0.OnInit(arg0_1)
	...
	for iter0_1 = 1, #var1_0 do
		arg0_1.loader:GetSprite("ui/activityuipage/AprilFoolDiscovery2024Page_atlas", string.sub(var1_0, iter0_1, iter0_1), arg0_1.items[iter0_1]:Find("Character"))
	end
...
function var0_0.OnUpdateFlush(arg0_8)
	...
	setActive(arg0_8.btnBattle:Find("Lock"), not var1_8)
	arg0_8:UpdateSelection()
