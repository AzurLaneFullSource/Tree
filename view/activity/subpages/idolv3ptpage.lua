...
function var0_0.OnInit(arg0_1)
	...
	arg0_1.trainEntranceBtn = arg0_1.bg:Find("train_btn")
	arg0_1.skills = arg0_1.bg:Find("skill")
	arg0_1.skillBtns = {}
	...
	arg0_1.idol1 = arg0_1.bg:Find("idol1")
	arg0_1.buffInfoBox = arg0_1._tf:Find("BuffInfoBox")
	arg0_1.mask = arg0_1.buffInfoBox:Find("mengban")
	arg0_1.buffWindow = arg0_1.buffInfoBox:Find("panel")
	arg0_1.buffName = arg0_1.buffWindow:Find("title/name")
	arg0_1.titleLv = arg0_1.buffWindow:Find("title/lv")
	arg0_1.titleIcon = arg0_1.buffWindow:Find("title/icon")
	arg0_1.buffTip = arg0_1.buffWindow:Find("content/tip")
	arg0_1.desc = arg0_1.buffWindow:Find("content/desc")
	arg0_1.buffAwardTF = arg0_1.buffWindow:Find("award_bg/award")
	arg0_1.trainWindow = arg0_1._tf:Find("IdolTrainWindow")
	arg0_1.trainTitle = arg0_1.trainWindow:Find("panel/title/Text")
	...
	arg0_1.info = arg0_1.trainWindow:Find("panel/info")
	arg0_1.curBuff = arg0_1.info:Find("preview/current")
	arg0_1.nextBuff = arg0_1.info:Find("preview/next")
	arg0_1.msgBox = arg0_1._tf:Find("MsgBox")
	arg0_1.msgIcon = arg0_1.msgBox:Find("panel/title/icon")

	setText(arg0_1.msgBox:Find("panel/title/Text"), i18n("title_info"))
...
function var0_0.OnUpdateFlush(arg0_12)
	...
	for iter0_12, iter1_12 in ipairs(arg0_12.ptData:GetCurBuffInfos()) do
		setActive(arg0_12.skillBtns[iter1_12.group]:Find("lv1"), false)
		setActive(arg0_12.skillBtns[iter1_12.group]:Find("lv2"), false)
		setActive(arg0_12.skillBtns[iter1_12.group]:Find("lv3"), false)

		if iter1_12.next then
			setActive(arg0_12.skillBtns[iter1_12.group]:Find("lv" .. iter1_12.lv), true)
		else
			setActive(arg0_12.skillBtns[iter1_12.group]:Find("lv3"), true)
		end

		local var13_12 = pg.benefit_buff_template[iter1_12.id].icon

		setImageSprite(arg0_12.skillBtns[iter1_12.group]:Find("icon"), LoadSprite(var13_12))
	end
end
...
function var0_0.flushTrainPanel(arg0_19)
	...
	if var0_19 then
		for iter0_19, iter1_19 in ipairs(var0_19) do
			setActive(arg0_19.trainSkillBtns[iter1_19.group]:Find("lv1"), false)
			setActive(arg0_19.trainSkillBtns[iter1_19.group]:Find("lv2"), false)
			setActive(arg0_19.trainSkillBtns[iter1_19.group]:Find("lv3"), false)

			if iter1_19.next then
				setActive(arg0_19.trainSkillBtns[iter1_19.group]:Find("lv" .. iter1_19.lv), true)
			else
				setActive(arg0_19.trainSkillBtns[iter1_19.group]:Find("lv3"), true)
			end

			local var1_19 = pg.benefit_buff_template[iter1_19.id].icon

			setImageSprite(arg0_19.trainSkillBtns[iter1_19.group]:Find("icon"), LoadSprite(var1_19))
			setText(arg0_19.trainSkillBtns[iter1_19.group]:Find("name"), shortenString(pg.benefit_buff_template[iter1_19.id].name, 7))
		end
	end

	for iter2_19, iter3_19 in ipairs(arg0_19.trainSkillBtns) do
		if iter2_19 == arg0_19.selectIndex then
			setActive(iter3_19:Find("selected"), true)
			setActive(iter3_19:Find("name"), true)
		else
			setActive(iter3_19:Find("selected"), false)
			setActive(iter3_19:Find("name"), false)
		end
	end
...
function var0_0.showBuffInfoBox(arg0_20, arg1_20)
	...
	if arg1_20.next then
		...
		setActive(arg0_20.buffAwardTF:Find("icon_bg/got_mask"), false)
	else
		setText(arg0_20.titleLv, "MAX")
		setActive(arg0_20.buffAwardTF:Find("icon_bg/got_mask"), true)
