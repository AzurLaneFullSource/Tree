...
function var0_0.OnFirstFlush(arg0_1)
	...
	GetComponent(arg0_1._tf:Find("AD/switcher/phase2/Image"), typeof(Image)):SetNativeSize()
	GetComponent(arg0_1._tf:Find("AD/switcher/phase1/Image"), typeof(Image)):SetNativeSize()
end
