...
function var0_0.OnFirstFlush(arg0_1)
	...
	GetComponent(arg0_1:findTF("AD/switcher/phase2/Image"), typeof(Image)):SetNativeSize()
	GetComponent(arg0_1:findTF("AD/switcher/phase1/Image"), typeof(Image)):SetNativeSize()
end
