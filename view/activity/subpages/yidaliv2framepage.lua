local var0_0 = class("YidaliV2framePage", import(".TemplatePage.PtTemplatePage"))
...
function var0_0.UpdateAwardGot(arg0_7)
	...
	setActive(arg0_7.step, not var1_7)
	setActive(arg0_7.progress, not var1_7)
end
...
function var0_0.OnUpdateFlush(arg0_8)
	...
	setText(arg0_8.step, var4_8 >= 1 and setColorStr(var2_8, COLOR_GREEN) or var2_8)
