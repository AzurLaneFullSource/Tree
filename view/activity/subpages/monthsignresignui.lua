...
function var0_0.InitUI(arg0_3)
	...
	setText(arg0_3._tf:Find("frame/title_text/Text"), i18n("month_sign_resign"))
	onButton(arg0_3, arg0_3._tf:Find("frame/top/btnBack"), function()
		arg0_3:Destroy()
	end, SFX_CANCEL)
	onButton(arg0_3, arg0_3._tf:Find("frame/actions/confirm_btn"), function()
		arg0_3:Destroy()
