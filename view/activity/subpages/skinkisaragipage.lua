local var0 = class("SkinKisaragiPage", import("view.base.BaseActivityPage"))

function var0.OnInit(arg0)
	arg0.bg = arg0:findTF("AD")
	arg0.textProgress = arg0.bg:Find("progress_text")
	arg0.btnGo = arg0.bg:Find("btn_go")
	arg0.markGot = arg0.bg:Find("got")
end
...
function var0.OnUpdateFlush(arg0)
	...
	setActive(arg0.btnGo, arg0.taskIndex < #arg0.taskList)
	setActive(arg0.markGot, arg0.taskIndex == #arg0.taskList)
end
