local var0 = class("Doa2MedalCollectionView", import("view.base.BaseUI"))

var0.FADE_OUT_TIME = 1
var0.PAGE_NUM = 9
var0.MEDAL_NUM_PER_PAGE = 2

local var1 = "ui/doa2medalcollectionui_atlas"
...
function var0.initData(arg0)
	...
	arg0.activatableIDList = arg0.activityData and arg0.activityData.data1_list or {}
	arg0.activeIDList = arg0.activityData and arg0.activityData.data2_list
	arg0.curPage = nil
	arg0.newMedalID = nil
end
...
function var0.findUI(arg0)
	...
	setActive(arg0.tplButtom, false)
	...
	for iter0 = 1, var0.PAGE_NUM do
		...
		LoadSpriteAtlasAsync(var1, "ship" .. iter0 .. "Icon", function(arg0)
			if var2 then
				setImageSprite(findTF(var2, "icon"), arg0, true)
			end
		end)
		LoadSpriteAtlasAsync(var1, "ship" .. iter0 .. "Name", function(arg0)
			if var2 then
				setImageSprite(findTF(var2, "name"), arg0, true)
			end
		end)
		LoadSpriteAtlasAsync(var1, "ship" .. iter0 .. "NameSelect", function(arg0)
			if var2 then
...
function var0.updateMedalContainerView(arg0, arg1, arg2)
	if arg2 then
		...
		LoadSpriteAtlasAsync(var1, "pictureImage" .. arg1, function(arg0)
	...
	LoadSpriteAtlasAsync(var1, "pictureName" .. arg1, function(arg0)
		setImageSprite(arg0.pictureName, arg0, true)
	end)

	for iter0 = 1, #arg0.medalTfList do
		local var0 = (arg1 - 1) * var0.MEDAL_NUM_PER_PAGE
		local var1 = (arg1 - 1) * var0.MEDAL_NUM_PER_PAGE + var0.MEDAL_NUM_PER_PAGE

		if var0 < iter0 and iter0 <= var1 then
	...
	if arg0.pageIDList then
		local var2 = arg0.pageIDList[arg1]

		for iter1, iter2 in ipairs(var2) do
			arg0:updateMedalView(var2, iter2)
		end
	end
end
...
function var0.updateAfterSubmit(arg0, arg1)
	arg0.activityProxy = getProxy(ActivityProxy)
	arg0.activityData = arg0.activityProxy:getActivityById(ActivityConst.DOA2_MEDAL_ACT_ID)
...
function var0.caculateActivatable(arg0, arg1)
	...
	if not arg0.pageIDList then
		return var0
	end

	local var1 = arg0.pageIDList[arg1]
...
function var0.checkAward(arg0)
	if not arg0.activeIDList then
		return
	end

	setActive(arg0.imgGot, #arg0.activeIDList == #arg0.allIDList and arg0.activityData.data1 == 1)

	if #arg0.activeIDList == #arg0.allIDList and arg0.activityData.data1 ~= 1 and not arg0.awardFlag then
