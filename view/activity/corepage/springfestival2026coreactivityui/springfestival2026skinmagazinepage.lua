local var0_0 = class("SpringFestival2026SkinMagazinePage", import("view.activity.CorePage.CoreActivityPage"))
...
function var0_0.OnFirstFlush(arg0_4)
	...
	local var3_4 = arg0_4.activity:getConfig("config_client").firstStory

	if var3_4 then
		pg.NewStoryMgr.GetInstance():Play(var3_4)
	end
end
