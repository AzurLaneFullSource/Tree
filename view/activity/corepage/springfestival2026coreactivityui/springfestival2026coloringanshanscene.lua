local var0_0 = class("SpringFestival2026ColoringAnshanscene", import("view.base.BaseUI"))
local var1_0 = 387
local var2_0 = 467
local var3_0 = 812.5
local var4_0 = 1200
...
function var0_0.init(arg0_5)
	arg0_5.rtAdapt = arg0_5._tf:Find("adapt")
		...
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			...
			onYes = function()
				...
				if var0_18:canBeCustomised() then
					arg0_16:emit(SpringFestival2026ColoringAnshanMediator.EVENT_COLORING_CLEAR, {
			...
			if var0_22:getState() == ColorGroup.StateColoring and not var0_22:canBeCustomised() then
				...
				if var2_22 ~= 0 then
					...
					if var3_22 and #var3_22 > 0 then
						arg0_20:emit(SpringFestival2026ColoringAnshanMediator.EVENT_COLORING_CELL, {
	...
	var3_27:AddPointClickFunc(function(arg0_28, arg1_28)
		...
		if var0_27:getState() == ColorGroup.StateColoring then
			local function var3_28()
				arg0_27:emit(SpringFestival2026ColoringAnshanMediator.EVENT_COLORING_CELL, {
