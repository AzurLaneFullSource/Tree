local var0_0 = class("SpringFestival2026PacGamePage", import("view.activity.CorePage.CoreActivityPage"))
local var1_0 = 81
...
function var0_0.OnFirstFlush(arg0_2)
	arg0_2.highScore = findTF(arg0_2._tf, "ad/title/text")
...
function var0_0.OnUpdateFlush(arg0_6)
	...
	local var2_6 = getProxy(MiniGameProxy):GetHighScore(var1_0)
	local var3_6 = var2_6 and #var2_6 > 0 and var2_6[1] or 0

	setText(arg0_6.highScore, i18n("pac_game_high_score_tip", var3_6))
end
