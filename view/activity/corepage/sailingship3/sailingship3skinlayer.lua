local var0_0 = class("SailingShip3SkinLayer", import("view.base.BaseUI"))
local var1_0
...
function var0_0.init(arg0_2)
	var1_0 = ActivityConst.SAILING_SHIP_3_SKIN_ACT_ID
	...
	arg0_2.item = arg0_2._tf:Find("task/item")
	arg0_2.items = arg0_2._tf:Find("task/items")
	...
	setText(arg0_2._tf:Find("task/taskAll/taskallReward/hasRewardText"), i18n("activity_1024_memory_get"))
end
...
function var0_0.UpdateTask(arg0_7, arg1_7, arg2_7)
	...
	setActive(arg2_7:Find("progressText"), false)

	local var11_7 = var3_7:getConfig("desc") .. " (" .. var9_7 .. var10_7 .. ")"

	setText(arg2_7:Find("description"), var11_7)
	setSlider(arg2_7:Find("progress"), 0, var6_7, var5_7)

	local var12_7 = arg2_7:Find("go_btn")
	local var13_7 = arg2_7:Find("get_btn")
	local var14_7 = arg2_7:Find("got_btn")
	...
	onButton(arg0_7, var12_7, function()
		arg0_7:emit(SailingShip3SkinMediator.ON_TASK_GO, var3_7)
	end, SFX_PANEL)
	onButton(arg0_7, var13_7, function()
		...
		seriesAsync(var0_10, function()
			arg0_7:emit(SailingShip3SkinMediator.ON_TASK_SUBMIT, var3_7)
		end)
	end, SFX_PANEL)

	local var16_7 = arg0_7.allCompleteCount < 8 and var15_7 == 1
	local var17_7 = arg2_7:Find("reddot")
...
function var0_0.DisplayBigTask(arg0_13)
	...
	local var2_13 = arg0_13._tf:Find("task/allTaskItem")
	...
	setActive(arg0_13._tf:Find("task/taskAll/taskallReward"), var4_13 == 2)
end
...
function var0_0.ShouldRewardAll(arg0_25, arg1_25)
	...
	if var0_25() and var1_25() then
		...
		seriesAsync(var2_25, function()
			arg0_25:emit(SailingShip3SkinMediator.ON_TASK_SUBMIT, var4_25)
		end)
	end
end
...
function var0_0.ShouldShowTip()
	...
	local var1_34 = getProxy(ActivityProxy):getActivityById(ActivityConst.SAILING_SHIP_3_SKIN_ACT_ID):getConfig("config_client")
	local var2_34 = 0
	local var3_34 = false
