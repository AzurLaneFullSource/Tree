local var0_0 = class("HelenaScenarioPage", import("view.activity.CorePage.CoreScenarioTemplatePage"))
...
function var0_0.OnInit(arg0_2)
	...
	setText(arg0_2.top:Find("top/deco/Text"), i18n("HelenaPTPage_title"))
	setText(arg0_2.top:Find("top/deco/Text/Text_1"), i18n("HelenaPTPage_title2"))
end
