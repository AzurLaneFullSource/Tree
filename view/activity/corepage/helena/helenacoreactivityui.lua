local var0_0 = class("HelenaCoreActivityUI", import("view.activity.CorePage.CoreActivityMainScene"))
...
function var0_0.OnToggleName(arg0_9, arg1_9, arg2_9)
	setText(arg1_9:Find("on/name"), i18n(arg2_9:getConfig("title_res_tag")))
	setText(arg1_9:Find("name"), i18n(arg2_9:getConfig("title_res_tag")))
end

function var0_0.OnAnimations(arg0_10, arg1_10, arg2_10)
	SetActive(arg0_10._tf:Find("adapt/decorate"), id == 50261 or id == 0)
end
