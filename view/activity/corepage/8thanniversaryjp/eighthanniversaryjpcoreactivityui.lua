...
function var0_0.CustomInit(arg0_2)
	...
	setText(arg0_2._tf:Find("adapt/TopPage/top/deco/Text"), i18n("activity_ninjia_main_title"))
	setText(arg0_2._tf:Find("adapt/TopPage/top/deco/Text/Text_1"), i18n("activity_ninjia_main_title_en"))
end
