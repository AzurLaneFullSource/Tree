local var0_0 = class("WillOfDeathPage", import("..CoreActivityPage"))

function var0_0.OnInit(arg0_1)
	arg0_1.bg = arg0_1._tf:Find("AD")
	arg0_1.rtTask = arg0_1.bg:Find("task")
	arg0_1.slider = arg0_1.rtTask:Find("slider")
	arg0_1.step = arg0_1.rtTask:Find("step")
	arg0_1.progress = arg0_1.rtTask:Find("progress")
	arg0_1.displayBtn = arg0_1.rtTask:Find("display_btn")
	arg0_1.awardTF = arg0_1.rtTask:Find("award")
	arg0_1.battleBtn = arg0_1.rtTask:Find("battle_btn")
	arg0_1.getBtn = arg0_1.rtTask:Find("get_btn")
	arg0_1.gotBtn = arg0_1.rtTask:Find("got_btn")
end
...
function var0_0.OnFirstFlush(arg0_3)
	setText(arg0_3.rtTask:Find("taskDesc"), i18n("brs_dmact_tip"))
...
function var0_0.OnUpdateFlush(arg0_9)
	...
	if arg0_9.step then
		...
		setText(arg0_9.step, string.format("<size=52>%s</size><size=32><color=#ffffff33>/%s</color></size>", var2_9, var3_9))
	end

	local var5_9, var6_9, var7_9 = arg0_9.ptData:GetResProgress()

	setText(arg0_9.progress, string.format("%s<color=#ffffff33>/%s</color>", var7_9 >= 1 and setColorStr(var5_9, COLOR_GREEN) or var5_9, var6_9))
