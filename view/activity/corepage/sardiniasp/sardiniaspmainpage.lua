local var0_0 = class("SardiniaSPMainPage", import("view.activity.CorePage.Helena.HelenaMainPage"))
...
function var0_0.updateUI(arg0_3)
	if arg0_3.shop_id then
		local var0_3, var1_3 = arg0_3.timeMgr:inTime(ShopConst.GetShopConfig(arg0_3.shop_id).time)
		local var2_3
		...
		onButton(arg0_3, arg0_3.shop, function()
			if var2_3 == nil or not arg0_3.shop_id then
