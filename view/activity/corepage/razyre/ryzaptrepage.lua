local var0_0 = class("RyzaPtRePage", import("view.activity.CorePage.CorePtTemplatePage"))
local var1_0 = 9
...
function var0_0.OnDestroy(arg0_20)
	if isActive(arg0_20.clickMask) then
		setActive(arg0_20.clickMask, false)
		pg.UIMgr.GetInstance():UnOverlayPanel(arg0_20.clickMask, arg0_20.bg)
	end
end
