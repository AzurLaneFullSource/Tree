local var0_0 = class("ShadowCityPtPage", import("view.activity.CorePage.CorePageNewPtTemplatePage"))

function var0_0.UpdateAward(arg0_1, arg1_1, arg2_1)
	local var0_1 = arg1_1 + 1
	local var1_1 = arg0_1.awardList[var0_1].drop

	updateDrop(arg2_1:Find("mask/IconTpl"), var1_1)

	GetComponent(arg2_1:Find("mask/IconTpl/icon_bg/frame"), typeof(Image)).enabled = false
	...
	setActive(arg2_1:Find("lock"), not var3_1)
