local var0_0 = class("PSSCoreActivityUI", import("view.activity.CorePage.CoreActivityMainScene"))
...
function var0_0.init(arg0_2, ...)
	...
	setText(arg0_2._tf:Find("adapt/TopPage/top/deco/Text"), i18n("yumia_main_tip_5"))
	...
	arg0_2.tabsList:make(function(arg0_3, arg1_3, arg2_3)
		if arg0_3 == UIItemList.EventUpdate then
			...
			elseif not arg0_2.pageDic[var0_3.id] then
				...
				arg0_2:OnToggleName(arg2_3, var0_3:getConfig("is_show"))
					...
					onToggle(arg0_2, arg2_3, function(arg0_5)
						if arg0_5 then
							if var0_2 ~= var0_3.id then
								...
								arg0_2:OnAnimations(arg2_3, var0_3.id)
							end
...
function var0_0.OnToggleName(arg0_9, arg1_9, arg2_9)
	setText(arg1_9:Find("on/name"), i18n("general_activity_side_bar" .. arg2_9))
	setText(arg1_9:Find("name"), i18n("general_activity_side_bar" .. arg2_9))
end

function var0_0.OnAnimations(arg0_10, arg1_10, arg2_10)
	SetActive(arg0_10._tf:Find("adapt/l"), arg2_10 == 50234)
	SetActive(arg0_10._tf:Find("adapt/r"), arg2_10 == 50234)
	SetActive(arg0_10._tf:Find("adapt/below"), arg2_10 == 50234)
end

function var0_0.willExit(arg0_11)
	var0_0.super.willExit(arg0_11)

	if arg0_11.camEventId then
		pg.CameraFixMgr.GetInstance():disconnect(arg0_11.camEventId)

		arg0_11.camEventId = nil
	end
end
