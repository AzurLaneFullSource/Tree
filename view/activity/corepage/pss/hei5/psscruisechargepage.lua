...
function var0_0.OnInit(arg0_3)
	...
	setText(arg0_3.buyWindow:Find("left/got/desc"), i18n("blackfriday_battlepass_pay_acquire"))

	local var0_3 = arg0_3.buyWindow:Find("right/items/scrollview/list")

	setText(arg0_3.buyWindow:Find("right/items/Text"), i18n("blackfriday_battlepass_pay_tip"))
	...
	onButton(arg0_3, arg0_3.confirmBtn, function()
		if ChargeConst.isNeedSetBirth() then
			arg0_3:emit(PSSHei5Mediator.EVENT_OPEN_BIRTHDAY)
		else
...
function var0_0.GetPassID()
	local var0_10 = getProxy(ActivityProxy):getAliveActivityByType(ActivityConst.ACTIVITY_TYPE_PT_HEI5)
