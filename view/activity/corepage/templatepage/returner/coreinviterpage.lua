local var0_0 = class("CoreInviterPage")
...
function var0_0.Ctor(arg0_1, arg1_1, arg2_1)
	...
	arg0_1.ptTxt = arg0_1._tf:Find("bg1/pt_panel/slider/Text"):GetComponent(typeof(Text))
	arg0_1.phaseTotalTxt = arg0_1._tf:Find("bg1/pt_panel/total_progress"):GetComponent(typeof(Text))
	arg0_1.phaseTxt = arg0_1._tf:Find("bg1/pt_panel/progress"):GetComponent(typeof(Text))
	arg0_1.progress = arg0_1._tf:Find("bg1/pt_panel/slider")
	arg0_1.getBtn = arg0_1._tf:Find("bg1/pt_panel/get")
	arg0_1.awardTF = arg0_1._tf:Find("bg1/pt_panel/item")
	arg0_1.awardOverView = arg0_1._tf:Find("bg1/pt_panel/award_overview")
	arg0_1.bg = arg0_1._tf:Find("bg"):GetComponent(typeof(Image))
	arg0_1.returnerList = UIItemList.New(arg0_1._tf:Find("bg1/returners/content"), arg0_1._tf:Find("bg1/returners/content/tpl"))
	arg0_1.help = arg0_1._tf:Find("bg1/help")
	arg0_1.pushBtn = arg0_1._tf:Find("bg1/push_btn")
	arg0_1.pushedBtn = arg0_1._tf:Find("bg1/pushed_btn")
	arg0_1.pushDisBtn = arg0_1._tf:Find("bg1/push_btn_dis")
	arg0_1.codeTxt = arg0_1._tf:Find("bg1/code"):GetComponent(typeof(Text))
	arg0_1.taskLockPanel = arg0_1._tf:Find("bg1/task_lock_panel")

	setText(arg0_1.taskLockPanel:Find("Text"), i18n("word_sell_lock"))

	arg0_1.taskPanel = arg0_1._tf:Find("bg1/task_panel")
	arg0_1.taskItemTF = arg0_1._tf:Find("bg1/task_panel/item")
	arg0_1.taskProgress = arg0_1._tf:Find("bg1/task_panel/progress")
	arg0_1.taskDesc = arg0_1._tf:Find("bg1/task_panel/desc")
	arg0_1.taskGoBtn = arg0_1._tf:Find("bg1/task_panel/go")
	arg0_1.taskGotBtn = arg0_1._tf:Find("bg1/task_panel/got")
	arg0_1.taskGetBtn = arg0_1._tf:Find("bg1/task_panel/get")
	arg0_1.taskProgressTxt = arg0_1._tf:Find("bg1/task_panel/p"):GetComponent(typeof(Text))

	setText(arg0_1._tf:Find("bg1/pt_panel/title"), i18n("activity_return_reward_pt"))
	arg0_1:Init()
end
