local var0_0 = class("DOAYearHotSpringShipSelectLayer", import("view.base.BaseUI"))
local var1_0 = import("view.activity.BackHills.NewYearFestival.NewYearHotSpringFormationCard")
...
function var0_0.AddCard(arg0_9, arg1_9, arg2_9, arg3_9)
	...
	if arg2_9 == 0 and arg3_9 then
		...
		onButton(arg0_9, var1_9, function()
			arg0_9:emit(DOAYearHotSpringShipSelectMediator.OPEN_CHUANWU, arg1_9, arg3_9)
		end, SFX_PANEL)
		...
		var3_9.onLongPressed:AddListener(function()
			...
			arg0_9:emit(DOAYearHotSpringShipSelectMediator.LOOG_PRESS_SHIP, arg1_9, arg3_9)
		end)
		...
		if arg2_9 == 0 then
			onButton(arg0_9, var6_9, function()
				arg0_9:emit(DOAYearHotSpringShipSelectMediator.OPEN_CHUANWU, arg1_9)
			end, SFX_PANEL)
		elseif arg2_9 == 1 then
			onButton(arg0_9, var6_9, function()
				arg0_9:emit(DOAYearHotSpringShipSelectMediator.EXTEND, arg1_9)
			end, SFX_PANEL)
...
function var0_0.willExit(arg0_16)
	arg0_16:UnOverlayPanel(arg0_16._tf)
	arg0_16:CleanCards()
end
