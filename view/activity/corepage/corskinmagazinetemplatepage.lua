local var0_0 = class("SkinMagazineTemplatePage", import("view.activity.CorePage.CoreActivityPage"))
...
function var0_0.OnFirstFlush(arg0_4)
	...
	arg0_4:RefreshData()
	setText(arg0_4.awardTf:Find("get/tip/Text"), i18n(arg0_4.TIP_KEY))
	...
	for iter1_4 = 1, arg0_4.items.childCount do
		...
		var0_4:GetComponent(typeof(LayoutElement)).preferredWidth = iter1_4 == arg0_4.index and arg0_4.EXPAND_WIDTH or arg0_4.CLOSE_WIDTH
...
function var0_0.SelectItem(arg0_7, arg1_7)
	...
	for iter2_7 = 1, arg0_7.items.childCount do
		...
		local var3_7 = iter2_7 == arg1_7 and arg0_7.EXPAND_WIDTH or arg0_7.CLOSE_WIDTH

		if var2_7 ~= var3_7 then
			local var4_7 = math.abs(var3_7 - var2_7) / arg0_7.DURATION_PARAMETER
...
function var0_0.UpdateDrop(arg0_9)
	...
	local var1_9 = Drop.Create(var0_9:getConfig("award_display")[1])
