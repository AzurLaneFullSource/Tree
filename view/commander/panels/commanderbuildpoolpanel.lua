...
function var0_0.OnLoaded(arg0_2)
	...
	setText(arg0_2._tf:Find("frame/bg/content/Text"), i18n("commander_use_box_tip"))
	setText(arg0_2._tf:Find("frame/bg/content/queue/title/Text"), i18n("commander_use_box_queue"))
end
