local var0 = class("CommanderFormationPage", import("...base.BaseSubView"))
...
function var0.OnInit(arg0)
	...
	onButton(arg0, arg0.restAllBtn, function()
		arg0:emit(FormationMediator.COMMANDER_FORMATION_OP, {
	...
	setText(arg0:findTF("record_panel/current/title/Text"), i18n("commander_formation_prefab_fleet"))
end
...
function var0.updateSkillTF(arg0, arg1, arg2)
	...
	if arg1 then
		...
		onButton(arg0, arg2, function()
			arg0:emit(FormationMediator.ON_CMD_SKILL, var0)
		end, SFX_PANEL)
	else
		removeOnButton(arg2)
	end
...
function var0.updateCommander(arg0, arg1, arg2, arg3, arg4)
	...
	if arg4 then
		onButton(arg0, var1, function()
			arg0:emit(FormationMediator.ON_SELECT_COMMANDER, arg2, arg0.fleet.id)
		end, SFX_PANEL)
