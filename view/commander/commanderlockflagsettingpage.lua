...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.allBtn = arg0_2._tf:Find("frame/title/all_btn")
	arg0_2.allSel = arg0_2.allBtn:Find("Image")
	arg0_2.ssrToggle = arg0_2._tf:Find("frame/toggles/rarity/ssr")
	arg0_2.srToggle = arg0_2._tf:Find("frame/toggles/rarity/sr")
	arg0_2.rToggle = arg0_2._tf:Find("frame/toggles/rarity/r")
	arg0_2.talentUIlist = UIItemList.New(arg0_2._tf:Find("frame/toggles/scrollrect/content/talent"), arg0_2._tf:Find("frame/toggles/scrollrect/content/talent/tpl"))
	arg0_2.descTxt = arg0_2._tf:Find("frame/desc/Text"):GetComponent(typeof(Text))

	setText(arg0_2._tf:Find("frame/title/rarity"), i18n("word_rarity") .. ": ")
	setText(arg0_2._tf:Find("frame/title/talent"), i18n("word_talent") .. ": ")
	setText(arg0_2._tf:Find("frame/desc/Text"), i18n("commander_lock_setting_title"))
end
