...
function var0_0.init(arg0_2)
	arg0_2.bgTF = arg0_2._tf:Find("main/bg")
	arg0_2.clickTF = arg0_2._tf:Find("click")
	arg0_2.paintTF = arg0_2._tf:Find("main/paint")
	arg0_2.paintTFCG = arg0_2.paintTF:GetComponent(typeof(CanvasGroup))
	arg0_2.infoTF = arg0_2._tf:Find("main/info")
	arg0_2.leftPanel = arg0_2._tf:Find("left_panel")
	arg0_2.lockBtn = arg0_2._tf:Find("left_panel/btns/lock")
	arg0_2.unlockBtn = arg0_2._tf:Find("left_panel/btns/unlock")
	arg0_2.shareBtn = arg0_2._tf:Find("left_panel/btns/share")
	arg0_2.nameTF = arg0_2.infoTF:Find("content/name/value"):GetComponent(typeof(Text))
	arg0_2.nationTF = arg0_2.infoTF:Find("content/nation/value"):GetComponent(typeof(Text))
	arg0_2.rarityTF = arg0_2.infoTF:Find("content/rarity/value"):GetComponent(typeof(Image))
	arg0_2.skillTF = arg0_2.infoTF:Find("content/skill/value"):GetComponent(typeof(Text))
	arg0_2.abilitysTF = arg0_2.infoTF:Find("content/abilitys/attrs")
	arg0_2.talentsTF = arg0_2.infoTF:Find("content/talents")
	arg0_2.talentsList = UIItemList.New(arg0_2.talentsTF, arg0_2.talentsTF:Find("talent"))
	arg0_2.dateTF = arg0_2.infoTF:Find("content/copyright/Text")
	...
	arg0_2.getEffect = arg0_2._tf:Find("main/effect")
	...
	setText(arg0_2._tf:Find("main/info/content/abilitys/attrs/command/name/Text"), i18n("commander_command_ability"))
	setText(arg0_2._tf:Find("main/info/content/abilitys/attrs/tactic/name/Text"), i18n("commander_tactical_ability"))
	setText(arg0_2._tf:Find("main/info/content/abilitys/attrs/support/name/Text"), i18n("commander_logistics_ability"))
	setText(arg0_2._tf:Find("main/info/content/copyright/title"), i18n("commander_get_commander_coptyright"))
end
