...
function var0_0.OnLoaded(arg0_2)
	...
	arg0_2.addBtn = arg0_2._tf:Find("frame/content/count/add")
	arg0_2.reduceBtn = arg0_2._tf:Find("frame/content/count/reduce")
	arg0_2.valueTxt = arg0_2._tf:Find("frame/content/count/Text"):GetComponent(typeof(Text))
	arg0_2.time1Txt = arg0_2._tf:Find("frame/content/time/Text"):GetComponent(typeof(Text))
	arg0_2.maxTxt = arg0_2._tf:Find("frame/total/Text"):GetComponent(typeof(Text))

	setText(arg0_2._tf:Find("frame/content/label1"), i18n("commander_box_quickly_tool_tip_1"))
	setText(arg0_2._tf:Find("frame/content/label2"), i18n("commander_box_quickly_tool_tip_2"))
	setText(arg0_2._tf:Find("frame/content/time/label"), i18n("commander_box_quickly_tool_tip_3"))
end
