...
function var0_0.OnLoaded(arg0_2)
	arg0_2.usageList = UIItemList.New(arg0_2._tf:Find("bg/frame/bg/talents/content"), arg0_2._tf:Find("bg/frame/bg/talents/content/talent"))
	arg0_2.usageCancelBtn = arg0_2._tf:Find("bg/frame/cancel_btn")
	arg0_2.usageConfirmBtn = arg0_2._tf:Find("bg/frame/confirm_btn")
	arg0_2.usageConfirmUpgrade = arg0_2._tf:Find("bg/frame/confirm_btn/upgrade")
	arg0_2.usageConfirmILearned = arg0_2._tf:Find("bg/frame/confirm_btn/learned")
	arg0_2.usageTalent = arg0_2._tf:Find("bg/frame/bg/talent")
	arg0_2.usageCostIconTF = arg0_2._tf:Find("bg/frame/consume/Image")
	arg0_2.usageCostTxtTF = arg0_2._tf:Find("bg/frame/consume/Text")
	arg0_2.usageCostTxt = arg0_2.usageCostTxtTF:GetComponent(typeof(Text))
	arg0_2.usageCloseBtn = arg0_2._tf:Find("bg/frame/close_btn")
	arg0_2.replacePage = CommanderReplaceTalentPage.New(arg0_2._parentTf.parent, arg0_2.event)

	setText(arg0_2._tf:Find("bg/frame/bg/title/Text"), i18n("commander_choice_talent_1"))
	setText(arg0_2._tf:Find("bg/frame/bg/talents/title/Text"), i18n("commander_choice_talent_2"))
	setText(arg0_2._tf:Find("bg/frame/consume/label"), i18n("word_consume"))
end
