...
function var0_0.OnLoaded(arg0_2)
	arg0_2.skillTF = arg0_2._tf:Find("skill/frame")
	arg0_2.skillNameTxt = arg0_2.skillTF:Find("name"):GetComponent(typeof(Text))
	arg0_2.skillIcon = arg0_2.skillTF:Find("icon/Image")
	arg0_2.skillLvTxt = arg0_2.skillTF:Find("level_container/level"):GetComponent(typeof(Text))
	arg0_2.skillAdditionTxt = arg0_2.skillTF:Find("level_container/addition"):GetComponent(typeof(Text))
	arg0_2.expTxt = arg0_2.skillTF:Find("exp/Text"):GetComponent(typeof(Text))
	arg0_2.descBtn = arg0_2._tf:Find("skill/frame/desc")
	arg0_2.descPage = arg0_2._tf:Find("skill_desc")
	arg0_2.descToggle = arg0_2.descPage:Find("tags")
	arg0_2.descToggleMark = arg0_2.descToggle:Find("sel")
	arg0_2.skillDescList = UIItemList.New(arg0_2.descPage:Find("content/list"), arg0_2.descPage:Find("content/list/tpl"))

	setActive(arg0_2.descPage, false)

	arg0_2.commanderLvTxt = arg0_2._tf:Find("select_panel/exp_bg/level_bg/Text"):GetComponent(typeof(Text))
	arg0_2.levelAdditionTxt = arg0_2._tf:Find("select_panel/exp_bg/level_bg/addition"):GetComponent(typeof(Text))
	arg0_2.preExpSlider = arg0_2._tf:Find("select_panel/exp_bg/slider"):GetComponent(typeof(Slider))
	arg0_2.expSlider = arg0_2._tf:Find("select_panel/exp_bg/slider/exp"):GetComponent(typeof(Slider))
	arg0_2.sliderExpTxt = arg0_2._tf:Find("select_panel/exp_bg/slider/Text"):GetComponent(typeof(Text))
	arg0_2.uilist = UIItemList.New(arg0_2._tf:Find("select_panel/frame/list"), arg0_2._tf:Find("select_panel/frame/list/commandeTF"))
	arg0_2.consumeTxt = arg0_2._tf:Find("select_panel/consume/Text"):GetComponent(typeof(Text))
	arg0_2.confirmBtn = arg0_2._tf:Find("select_panel/confirm_btn")
	arg0_2.animation = CommanderCatPlayAnimation.New(arg0_2.expSlider)

	setText(arg0_2._tf:Find("select_panel/title"), i18n("commander_confirm_tip"))
	setText(arg0_2._tf:Find("skill_desc/title"), i18n("commander_skill_effect"))
end
