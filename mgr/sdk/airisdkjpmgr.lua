local var0 = {}
local var1 = AiriJPSdkMgr.inst
local var2 = AiriJPSdkMgr.AiriSDKInst
local var3 = AiriJPSdkMgr.AiriSdkDataInst
...
function var0.CheckPreAudit()
	local var0 = NetConst.GATEWAY_PORT == 30001 and NetConst.GATEWAY_HOST == "blhxjpauditapi.azurlane.jp"
	local var1 = NetConst.GATEWAY_PORT == 30101 and NetConst.GATEWAY_HOST == "blhxjpauditapi.azurlane.jp"
...
function var0.LoginWithDevice()
	pg.UIMgr.GetInstance():LoadingOn()
	var1:LoginWithDevice()
end
...
function var0.GetTransCode()
	if IsUnityEditor then
		return "NULL"
	else
		return var1.loginRet.MIGRATIONCODE
	end
end
...
function var0.CheckHadAccountCache()
	if var0.GetIsPlatform() then
		return var1:CheckHadAccountCache() or var0.isCache
	else
		return true
	end
end
