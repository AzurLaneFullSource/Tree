...
function var1_0.CheckGroupUpdateTip(arg0_11)
	local var0_11 = BundleWizard.Inst:GetGroupMgr(arg0_11)

	var0_11:CheckD()

	if var0_11.state == DownloadState.CheckToUpdate then
		return false
	else
		return not GroupHelper.IsGroupVerLastest(arg0_11)
	end
end
