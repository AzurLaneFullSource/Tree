...
function this.Tracking(arg0_2, arg1_2, arg2_2, arg3_2)
	...
	if arg1_2 == TRACKING_USER_LEVELUP then
		...
		local var1_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_PURCHASE_CLICK then
		local var2_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_PURCHASE_FIRST then
		...
		local var3_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_SHIP_INTENSIFY then
		local var6_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_SHIP_LEVEL_UP then
		local var7_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_SHIP_HIGHEST_LEVEL then
		local var8_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_CUBE_ADD then
		local var9_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_CUBE_CONSUME then
		local var10_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_PROPOSE_SHIP then
		local var11_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_REMOULD_SHIP then
		local var12_2 = YoStarUserEvent.New(var0_2)
	...
	elseif arg1_2 == TRACKING_HARD_CHAPTER then
		local var13_2 = YoStarUserEvent.New(var0_2)
