...
function var0_0.GetCurrentGuideName(arg0_30)
	return arg0_30.currentGuideName
end

function var0_0.Exit(arg0_31)
	arg0_31:Clear()
	arg0_31.uiFinder:Clear()
	arg0_31.uiDuplicator:Clear()
	arg0_31.uiLoader:Clear()
	arg0_31.uiFloatCollctor:Clear()

	arg0_31.state = var7_0
end
