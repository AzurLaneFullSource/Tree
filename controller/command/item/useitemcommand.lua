...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(15002, {
		...
		if arg0_2.result == 0 then
			...
			elseif var6_1 == ItemUsage.DROP or var6_1 == ItemUsage.DROP_TEMPLATE or var6_1 == ItemUsage.DROP_APPOINTED or var6_1 == ItemUsage.INVITATION or var6_1 == ItemUsage.SKIN_SELECT or var6_1 == ItemUsage.RANDOM_SKIN or var6_1 == ItemUsage.SHIP_GIFT or var6_1 == ItemUsage.REPAIR_LOVE_LETTER then
			...
			elseif var6_1 == ItemUsage.EX_RE_MAP then
				var0_2 = PlayerConst.addTranDrop(arg0_2.drop_list)

				getProxy(ChapterProxy):addRemasterPassCount(var3_1[1], ChapterConst.GetActivityIDByReChapterID(var3_1[1]), var2_1)
			else
