...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29064, {
		...
		if arg0_2.result == 0 then
			...
			local var4_2 = var3_2:GetState(NewEducateFSM.SYSTEM.MAP)
			...
			local var5_2 = NewEducateDropHelper.HandleDrops(arg0_2.drop)
			...
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_MapEvent: " .. arg0_2.result)
		end
	end)
end
