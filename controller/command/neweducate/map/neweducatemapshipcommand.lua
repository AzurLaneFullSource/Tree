...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29068, {
		...
		if arg0_2.result == 0 then
			...
			var5_2:SetSystemNo(NewEducateFSM.SYSTEM.MAP)

			local var6_2 = var5_2:GetState(NewEducateFSM.SYSTEM.MAP)
			...
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_MapShip: " .. arg0_2.result)
		end
	end)
end
