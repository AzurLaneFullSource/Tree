...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29040, {
		...
		if arg0_2.result == 0 then
			...
			var1_2:SetSystemNo(NewEducateFSM.SYSTEM.PLAN)

			local var2_2 = var1_2:GetState(NewEducateFSM.SYSTEM.PLAN)
			...
			local var7_2 = NewEducateDropHelper.HandleDrops(arg0_2.drop)
			...
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_Schedule: " .. arg0_2.result)
		end
	end)
end
