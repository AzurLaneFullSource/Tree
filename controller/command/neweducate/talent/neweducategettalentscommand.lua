...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29019, {
		...
		if arg0_2.result == 0 then
			...
			var0_2:SetSystemNo(NewEducateFSM.SYSTEM.TALENT)
			...
			var0_2:SetState(NewEducateFSM.SYSTEM.TALENT, var1_2)
			...
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_GetTalents: " .. arg0_2.result)
		end
	end)
end
