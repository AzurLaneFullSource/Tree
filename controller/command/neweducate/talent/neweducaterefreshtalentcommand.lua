...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29021, {
		...
		if arg0_2.result == 0 then
			getProxy(NewEducateProxy):GetCurChar():GetFSM():GetState(NewEducateFSM.SYSTEM.TALENT):OnRefreshTalent(var2_1, arg0_2.talent)
			arg0_1:sendNotification(GAME.NEW_EDUCATE_REFRESH_TALENT_DONE, {
				idx = var3_1,
				newId = arg0_2.talent
			})
		else
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_RefreshTalent: " .. arg0_2.result)
		end
	end)
end
