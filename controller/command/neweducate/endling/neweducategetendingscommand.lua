...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29003, {
		...
		if arg0_2.result == 0 then
			...
			var1_2:SetSystemNo(NewEducateFSM.SYSTEM.ENDING)
			...
			var1_2:SetState(NewEducateFSM.SYSTEM.ENDING, var2_2)
			existCall(var1_1)
			NewEducateHelper.TrackRoundEnd()
		else
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_GetEndings: " .. arg0_2.result)
		end
	end)
end
