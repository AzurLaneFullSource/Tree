...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(29030, {
		...
		if arg0_2.result == 0 then
			...
			local var1_2 = getProxy(NewEducateProxy):GetCurChar():GetFSM()

			var1_2:SetCurNode(arg0_2.next_node)
			arg0_1:sendNotification(GAME.NEW_EDUCATE_NEXT_NODE, {
				node = arg0_2.next_node,
				drop = var0_2,
				noNextCb = function()
					if arg0_2.next_node == 0 then
						if var1_2:GetSystemNo() == NewEducateFSM.SYSTEM.PLAN then
							local var0_3 = var1_2:GetState(NewEducateFSM.SYSTEM.PLAN)
			...
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_TriggerNode: " .. arg0_2.result)
		end
	end)
end
