...
function var0_0.execute(arg0_1, arg1_1)
	...
	if var2_1:getApartment(var0_1.groupId):GetSetCallCd() > 0 then
		return
	end
	...
	pg.ConnectionMgr.GetInstance():Send(28021, {
		...
		if arg0_2.result == 0 then
			var2_1:ModifyApartment(var0_1.groupId, {
				callName = var0_1.callName,
				setCallCd = pg.TimeMgr.GetInstance():GetServerTime() + 172800
			})
			arg0_1:sendNotification(GAME.DORM_SET_CALL_DONE, {
				apartment = var2_1:getApartment(var0_1.groupId)
			})
		else
