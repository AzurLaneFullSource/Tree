...
function var0_0.execute(arg0_1, arg1_1)
	...
	local var6_1 = var1_1:GetCommodityById(var0_1.arg1):GetConsume()

	var6_1.count = var6_1.count * var4_1
	...
	if var3_1.commodity_type == DROP_TYPE_RESOURCE then
		if var3_1.commodity_id == 1 and var5_1:GoldMax(var3_1.num * var4_1) then
			pg.TipsMgr.GetInstance():ShowTips(i18n("gold_max_tip_title") .. i18n("resource_max_tip_shop"))

			return
		end

		if var3_1.commodity_id == 2 and var5_1:OilMax(var3_1.num * var4_1) then
