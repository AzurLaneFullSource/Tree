local var0_0 = class("PlayRoomSendChatCommand", pm.SimpleCommand)
...
function var0_0.execute(arg0_1, arg1_1)
	...
	if var1_1 == PlayRoomChatConst.CHANNEL_PLAYROOM then
		local var6_1 = getProxy(PlayRoomProxy):GetChatMsgs()

		for iter0_1 = #var6_1, 1, -1 do
			if var6_1[iter0_1].playerId == var4_1.id then
...
function var0_0.Send(arg0_2, arg1_2, arg2_2, arg3_2)
	...
	if arg1_2 == PlayRoomChatConst.CHANNEL_PLAYROOM then
		pg.ConnectionMgr.GetInstance():Send(23023, {
			type = arg2_2,
			content = var1_2
		}, 23024, function(arg0_3)
	...
	elseif arg1_2 == PlayRoomChatConst.CHANNEL_WORLD then
		arg0_2:sendNotification(GAME.SEND_MSG, var1_2)
	elseif arg1_2 == PlayRoomChatConst.CHANNEL_GUILD then
