...
local var3_0 = class("IslandTakePhotoUnit", import(".IslandSceneUnit"))
...
function var3_0.Move(arg0_7, arg1_7)
	...
	local var0_7 = arg0_7.gravityAcc * arg1_7

	arg0_7.gravitySpeed = arg0_7.gravitySpeed + var0_7
	arg0_7.onGroud = true

	local var1_7 = 0

	if arg0_7.gravitySpeed >= 0 then
		local var2_7, var3_7 = arg0_7:CalcGrounded()

		if var2_7 then
			arg0_7.gravitySpeed = 0
			var1_7 = var3_7
		else
			local var4_7, var5_7 = arg0_7:CalcNotFalling()
	...
	local var6_7 = Vector3(0, IslandConst.GRAVITYDIR.y * var1_7, 0)

	if arg0_7.ignoreStepdown then
		var6_7 = var2_0
	end

	local var7_7 = arg0_7.jumpVector + var6_7
	local var8_7 = Vector3(0, IslandConst.GRAVITYDIR.y * arg0_7.gravitySpeed, 0)

	arg0_7.characterController:Move((arg0_7.velocity + var8_7) * Time.deltaTime + var7_7 + arg0_7.extraVelocity * Time.deltaTime)
end
...
function var3_0.OnStopPlayerSprint(arg0_11)
	if arg0_11.isSprint and arg0_11.targetSpeed ~= 0 then
		arg0_11.targetSpeed = arg0_11.lastTargetSpeed
		arg0_11.speed = arg0_11.lastTargetSpeed
		arg0_11.isSprint = false
	end
end

function var3_0.MoveHandle(arg0_12, arg1_12, arg2_12)
	arg0_12.orginTargetDir = arg1_12
	arg0_12.lastTargetSpeed = arg2_12 * arg0_12.maxSpeed
	arg0_12.targetSpeed = arg0_12.isSprint and arg0_12.sprintSpeed or arg0_12.lastTargetSpeed
end

function var3_0.StopMoveHandle(arg0_13)
	arg0_13.targetSpeed = 0
	arg0_13.speed = 0
	arg0_13.orginTargetDir = var2_0
	arg0_13.isSprint = false
end
