...
function var0_0.OnLoaded(arg0_2)
	arg0_2.backBtn = arg0_2._tf:Find("frame/back")
	arg0_2.levelTxt = arg0_2._tf:Find("frame/left/level"):GetComponent(typeof(Text))
	arg0_2.expTxt = arg0_2._tf:Find("frame/left/objective/exp"):GetComponent(typeof(Text))
	arg0_2.goldTxt = arg0_2._tf:Find("frame/left/objective/gold"):GetComponent(typeof(Text))
	arg0_2.expProgress = arg0_2._tf:Find("frame/left/exp/bar")
	arg0_2.preViewBtn = arg0_2._tf:Find("frame/left/preview")
	arg0_2.prosperityLevel = arg0_2._tf:Find("frame/right/prosperity/level"):GetComponent(typeof(Text))
	arg0_2.prosperityExp = arg0_2._tf:Find("frame/right/prosperity/exp"):GetComponent(typeof(Text))
	arg0_2.prosperityIcon = arg0_2._tf:Find("frame/right/prosperity/icon")
	arg0_2.nameTxt = arg0_2._tf:Find("frame/left/name/Text"):GetComponent(typeof(Text))
	arg0_2.editNameBtn = arg0_2._tf:Find("frame/left/name")
	arg0_2.uiShipList = UIItemList.New(arg0_2._tf:Find("frame/right/ships/list"), arg0_2._tf:Find("frame/right/ships/list/tpl"))
	arg0_2.upgradePreviewPanel = arg0_2._tf:Find("frame/left/upgrade_preview")
	arg0_2.upgradeAwardList = UIItemList.New(arg0_2._tf:Find("frame/left/upgrade_preview/content/awards/list/content"), arg0_2._tf:Find("frame/left/upgrade_preview/content/awards/list/content/tpl"))
	arg0_2.upgradeUnlockList = UIItemList.New(arg0_2._tf:Find("frame/left/upgrade_preview/content/unlock/list/content"), arg0_2._tf:Find("frame/left/upgrade_preview/content/awards/list/content/tpl"))
	arg0_2.prosperityLevelList = UIItemList.New(arg0_2._tf:Find("frame/right/prosperity/objective/content"), arg0_2._tf:Find("frame/right/prosperity/objective/content/tpl"))
	arg0_2.prosperityAwardList = UIItemList.New(arg0_2._tf:Find("frame/right/prosperity/objective/awards"), arg0_2._tf:Find("frame/right/prosperity/objective/awards/tpl"))
	arg0_2.getProsperityBtn = arg0_2._tf:Find("frame/right/prosperity/objective/get_btn")
	arg0_2.goProsperityBtn = arg0_2._tf:Find("frame/right/prosperity/objective/go_btn")
	arg0_2.goProsperityBtnTxt = arg0_2._tf:Find("frame/right/prosperity/objective/go_btn/Text"):GetComponent(typeof(Text))

	setText(arg0_2._tf:Find("frame/left/preview/Text"), i18n("island_upgrade_preview"))
	setText(arg0_2._tf:Find("frame/left/objective/label_exp"), i18n("island_upgrade_exp"))
	setText(arg0_2._tf:Find("frame/left/objective/label_gold"), i18n("island_upgrade_res"))
	setText(arg0_2._tf:Find("frame/left/upgrade_preview/content/awards/label"), i18n("island_word_award"))
	setText(arg0_2._tf:Find("frame/left/upgrade_preview/content/unlock/label"), i18n("island_word_unlock"))
	setText(arg0_2._tf:Find("frame/right/prosperity/objective/get_btn/Text"), i18n("island_word_get"))
end
