...
function var0_0.OnLoaded(arg0_2)
	arg0_2.uiStarPreList = UIItemList.New(arg0_2._tf:Find("frame_1/star/prev"), arg0_2._tf:Find("frame_1/star/prev/tpl"))
	arg0_2.uiStarNextList = UIItemList.New(arg0_2._tf:Find("frame_1/star/now"), arg0_2._tf:Find("frame_1/star/now/tpl"))
	arg0_2.prevLevelTxt = arg0_2._tf:Find("frame_1/level/prev"):GetComponent(typeof(Text))
	arg0_2.nextLevelTxt = arg0_2._tf:Find("frame_1/level/now"):GetComponent(typeof(Text))
	arg0_2.skillTxt = arg0_2._tf:Find("frame_1/skill/Text"):GetComponent(typeof(Text))
	arg0_2.skillLabelTxt = arg0_2._tf:Find("frame_1/skill/now"):GetComponent(typeof(Text))
	arg0_2.uiAttrList = UIItemList.New(arg0_2._tf:Find("frame_3/attrs"), arg0_2._tf:Find("frame_3/attrs/tpl"))
	arg0_2.uiConsumeList = UIItemList.New(arg0_2._tf:Find("frame_2/comsume"), arg0_2._tf:Find("frame_2/comsume/tpl"))
	arg0_2.upgradeBtn = arg0_2._tf:Find("btn_confirm")
	arg0_2.closeBtn = arg0_2._tf:Find("frame_1/close")

	setText(arg0_2._tf:Find("frame_1/title"), i18n("island_ship_breakout"))
	setText(arg0_2._tf:Find("frame_2/consume_title/Text"), i18n("island_ship_breakout_consume"))
