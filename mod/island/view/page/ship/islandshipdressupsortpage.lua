local var0_0 = class("IslandShipDressUpSortPage", import("view.base.BaseSubView"))
...
function var0_0.InitList(arg0_6)
	arg0_6.sortUIItemList:make(function(arg0_7, arg1_7, arg2_7)
		if arg0_7 == UIItemList.EventUpdate then
			local var0_7 = IslandShipDressUpPageNew.SORT_LIST[arg1_7 + 1]
			local var1_7 = arg0_6.indexData.sortKey == var0_7

			setText(arg2_7:Find("Text"), setColorStr(IslandShipDressUpPageNew.Sort2CN(var0_7), var1_7 and "#393a3c" or "#7c7e81"))
	...
	arg0_6.sortUIItemList:align(#IslandShipDressUpPageNew.SORT_LIST)
end
