...
function var0_0.OnLoaded(arg0_2)
	arg0_2.skillIcon = arg0_2._tf:Find("adapt/attr_panel/skill/icon")
	arg0_2.skillName = arg0_2._tf:Find("adapt/attr_panel/skill/name"):GetComponent(typeof(Text))
	arg0_2.skillLv = arg0_2._tf:Find("adapt/attr_panel/skill/level"):GetComponent(typeof(Text))
	arg0_2.descTxt = arg0_2._tf:Find("adapt/attr_panel/desc/Text"):GetComponent(typeof(Text))
	arg0_2.descList = UIItemList.New(arg0_2._tf:Find("adapt/attr_panel/desc/list"), arg0_2._tf:Find("adapt/attr_panel/desc/list/tpl"))
	arg0_2.consumeList = UIItemList.New(arg0_2._tf:Find("adapt/attr_panel/consume/list"), arg0_2._tf:Find("adapt/attr_panel/consume/list/tpl"))
	arg0_2.upgradeBtn = arg0_2._tf:Find("adapt/attr_panel/consume/upgrade")
	arg0_2.tipTxt = arg0_2._tf:Find("adapt/attr_panel/consume/tip"):GetComponent(typeof(Text))
	arg0_2.goldTr = arg0_2._tf:Find("adapt/attr_panel/consume/label")
	arg0_2.goldTxt = arg0_2._tf:Find("adapt/attr_panel/consume/label/Text"):GetComponent(typeof(Text))
	arg0_2.goldIco = arg0_2._tf:Find("adapt/attr_panel/consume/label/icon")

	setText(arg0_2._tf:Find("adapt/attr_panel/consume/label/label1"), i18n("island_ship_breakout_consume"))
end
