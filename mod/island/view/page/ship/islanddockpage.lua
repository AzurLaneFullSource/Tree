...
function var0_0.Show(arg0_15, arg1_15)
	arg0_15.hideUnlockShip = arg1_15
...
local function var1_0(arg0_22, arg1_22)
	...
	local var1_22 = IslandShip.StaticGetName(arg0_22)
...
function var0_0.ToVShip(arg0_23, arg1_23)
	if not arg0_23.vship then
		...
		function arg0_23.vship.getTeamType()
			return ShipType.GetTeamFromShipType(arg0_23.vship.config.type)
		end
...
function var0_0.GetShips(arg0_29)
	local var0_29 = {}
	local var1_29 = {}
	local var2_29 = arg0_29.characterAgency:GetUnlockOrCanUnlockShipConfigIds()
	...
	for iter0_29, iter1_29 in ipairs(var2_29) do
		if var1_0(iter1_29, arg0_29.searchKey) and var2_0(arg0_29, iter1_29, arg0_29.sortData) then
			local var3_29 = arg0_29.characterAgency:GetShipById(iter1_29)

			if var3_29 then
				table.insert(var1_29, var3_29)
			else
	...
	local var4_29 = IslandShipIndexLayer.getSortFuncAndName(arg0_29.sortData.sortIndex, arg0_29.selectAsc)

	table.sort(var1_29, CompareFuncs(var4_29))

	for iter2_29, iter3_29 in ipairs(var1_29) do
		table.insert(var0_29, iter3_29.configId)
	end

	if arg0_29.hideUnlockShip then
		for iter4_29 = #var0_29, 1, -1 do
			local var5_29 = var0_29[iter4_29]

			if var5_29 and getProxy(IslandProxy):GetIsland():GetCharacterAgency():GetShipById(var5_29) == nil then
				table.remove(var0_29, iter4_29)
			end
		end
	end
...
function var0_0.Hide(arg0_30)
	...
	pg.UIMgr.GetInstance():UnOverlayPanel(arg0_30.frameTr, arg0_30._tf)
	arg0_30:emit(IslandShipMainPage.CLOSE_DOCK)
end
