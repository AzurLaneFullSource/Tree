local var0_0 = class("IslandSettings3DPage", import("view.base.BaseSubView"))
...
function var0_0.OnBindEvent(arg0_3)
	arg0_3:bind(IslandSettingsOtherGraphicsPanle.EVT_UPDTAE, function()
		local var0_4 = arg0_3:GetPanel(IslandSettingsOtherGraphicsPanle)
	...
	arg0_3:bind(IslandSettingsGraphicsPanle.EVT_UPDTAE, function()
		local var0_6 = arg0_3:GetPanel(IslandSettingsGraphicsPanle)
...
function var0_0.GetPanels(arg0_7)
	...
	if arg0_7:NeedAdjustScreen() then
		table.insert(var0_7, 1, IslandSettingsAdjustScreenPanle)
	end
