...
function var0_0.execute(arg0_1, arg1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21501, {
		...
		if arg0_2.result == 0 then
			...
			local var2_2 = var0_2:GetDelegationSlotData(arg0_2.ship_appoint.id):GetRoleDelegateFinishTime()

			var1_2:UpdateEnergyBeginRecoverTime(var2_2)

			local var3_2 = var1_1 == IslandTechnologyAgency.PLACE_ID and IslandShip.STATE_DELEGATION or IslandShip.STATE_TECHNOLOGY

			var1_2:UpdateState(var3_2, var1_1)

			local var4_2 = pg.island_formula[var4_1].commission_cost

			for iter0_2, iter1_2 in ipairs(var4_2) do
				var8_1:RemoveItem(iter1_2[1], iter1_2[2] * var5_1)
			end
