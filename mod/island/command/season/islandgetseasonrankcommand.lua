local var0_0 = class("IslandGetSeasonRankCommand", pm.SimpleCommand)
local var1_0 = 100
local var2_0 = 5
...
function var0_0.execute(arg0_1, arg1_1)
	...
	local var2_1 = var0_1.seasonId
	local var3_1 = {}

	local function var4_1(arg0_2, arg1_2)
		if #var3_1 < (arg0_2 - 1) * (var1_0 / var2_0) then
			arg1_2()
	...
	local function var6_1(arg0_4)
		pg.ConnectionMgr.GetInstance():Send(18203, {
			...
			local var3_5 = {
				...
				icon = var1_5:getConfig("id"),
				skin_id = var1_5.skinId,
				propose = var1_5.propose and 1 or 0,
	...
	for iter0_1 = 1, var2_0 do
		table.insert(var7_1, function(arg0_6)
			var4_1(iter0_1, arg0_6)
		end)
	end

	table.insert(var7_1, function(arg0_7)
		var6_1(arg0_7)
	end)
	seriesAsync(var7_1, function()
		if #var3_1 > 0 then
			arg0_1:HandleSamePoint(var2_1, var3_1)
		end

		local var0_8 = getProxy(BillboardProxy)

		var0_8:setRankList(var1_1, var2_1, var3_1)
		var0_8:setPlayerRankData(var1_1, var2_1, var5_1)
		arg0_1:sendNotification(GAME.ISLAND_GET_SEASON_RANK_DONE, {
			seasonId = var2_1,
			list = var3_1,
			playerInfo = var5_1
		})
