...
function var3.Cast(arg0, arg1, arg2)
	...
	if arg0._tempData.focus_duration then
		arg1:DispatchCutIn(arg0._tempData)
	end
	...
	if arg0._tempData.sfx then
		var0.Battle.PlayBattleSFX(arg0._tempData.sfx)
	end
	...
	for iter0, iter1 in ipairs(arg0._effectList) do
		...
		if iter1:IsFinaleEffect() then
			arg0._finaleEffectCount = arg0._finaleEffectCount + 1

			local function var7()
				arg0:callbackCount(arg1)
			end

			iter1:SetFinaleCallback(var7)
		end

		iter1:Effect(arg1, var6, var5)
	end

	local var8 = arg0._tempData.aniEffect
	...
	if var8 and var8 ~= "" then
		...
		arg1:DispatchEvent(var0.Event.New(var0.Battle.BattleUnitEvent.ADD_EFFECT, var9))
	end

	if arg0._tempData.action then
		arg1:StateChange(var0.Battle.UnitState.STATE_SKILL_START)
	end
end
...
function var3.callbackCount(arg0, arg1)
	arg0._finaleEffectCount = arg0._finaleEffectCount - 1

	if arg0._finaleEffectCount == 0 and arg0._tempData.action then
		arg1:StateChange(var0.Battle.UnitState.STATE_SKILL_END)
	end
end
