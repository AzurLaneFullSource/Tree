...
local var3_0 = var0_0.Battle.BattleSkillSummon
...
function var3_0.DoDataEffectWithoutTarget(arg0_2, arg1_2, arg2_2)
	arg0_2:DoSummon(arg1_2, arg2_2)
end

function var3_0.DoDataEffect(arg0_3, arg1_3, arg2_3, arg3_3)
	arg0_3:DoSummon(arg1_3, arg3_3)
end

function var3_0.DoSummon(arg0_4, arg1_4, arg2_4)
	...
	if arg1_4:GetUnitType() == var1_0.UnitType.PLAYER_UNIT then
		...
		if arg0_4._spawnData.relativeCorrdinate then
			local var4_4 = arg1_4:GetPosition()
			local var5_4 = var2_0.RandomPos(arg0_4._spawnData.relativeCorrdinate)

			var5_4.x = var5_4.x + var4_4.x
			var5_4.y = var5_4.y + var4_4.y
			var5_4.z = var5_4.z + var4_4.z

			var2_4:SetPosition(var5_4)
		end
	end
