...
var0.Battle.CalmAntiSubState = class("CalmAntiSubState", var0.Battle.IAntiSubState)
var0.Battle.CalmAntiSubState.__name = "CalmAntiSubState"

local var1 = var0.Battle.CalmAntiSubState
