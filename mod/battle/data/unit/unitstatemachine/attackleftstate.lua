...
var0.Battle.AttackLeftState = class("AttackLeftState", var0.Battle.IUnitState)
var0.Battle.AttackLeftState.__name = "AttackLeftState"

local var2 = var0.Battle.AttackLeftState
...
function var2.OnTrigger(arg0, arg1)
	arg1:GetTarget():SendAttackTrigger()
end
