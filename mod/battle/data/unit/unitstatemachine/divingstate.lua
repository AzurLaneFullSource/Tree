...
var0.Battle.DivingState = class("DivingState", var0.Battle.IUnitState)
var0.Battle.DivingState.__name = "DivingState"

local var2 = var0.Battle.DivingState
...
function var2.OnEnd(arg0, arg1)
	arg1:ChangeOxyState(var0.Battle.OxyState.STATE_DIVE)
