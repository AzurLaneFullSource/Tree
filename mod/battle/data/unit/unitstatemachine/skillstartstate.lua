...
var0.Battle.SkillStartState = class("SkillStartState", var0.Battle.IUnitState)
var0.Battle.SkillStartState.__name = "SkillStartState"

local var2 = var0.Battle.SkillStartState
