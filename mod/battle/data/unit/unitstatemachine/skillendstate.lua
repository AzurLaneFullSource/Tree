...
var0.Battle.SkillEndState = class("SkillEndState", var0.Battle.IUnitState)
var0.Battle.SkillEndState.__name = "SkillEndState"

local var2 = var0.Battle.SkillEndState
