...
var0.Battle.RaidLeftState = class("RaidLeftState", var0.Battle.IUnitState)
var0.Battle.RaidLeftState.__name = "RaidLeftState"

local var2 = var0.Battle.RaidLeftState
