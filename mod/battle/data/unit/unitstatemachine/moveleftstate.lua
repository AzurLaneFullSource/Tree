...
var0.Battle.MoveLeftState = class("MoveLeftState", var0.Battle.IUnitState)
var0.Battle.MoveLeftState.__name = "MoveLeftState"

local var2 = var0.Battle.MoveLeftState
