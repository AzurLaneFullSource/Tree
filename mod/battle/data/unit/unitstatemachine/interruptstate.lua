...
var0_0.Battle.InterruptState = class("InterruptState", var0_0.Battle.IUnitState)
var0_0.Battle.InterruptState.__name = "InterruptState"

local var2_0 = var0_0.Battle.InterruptState
...
function var2_0.OnTrigger(arg0_18, arg1_18)
	arg1_18:GetTarget():SetInterruptSickness(true)
end
...
function var2_0.OnEnd(arg0_20, arg1_20)
	arg1_20:GetTarget():SetInterruptSickness(false)
