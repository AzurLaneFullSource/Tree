...
var0_0.Battle.SkillState = class("SkillState", var0_0.Battle.IUnitState)
var0_0.Battle.SkillState.__name = "SkillState"

local var2_0 = var0_0.Battle.SkillState
...
function var2_0.OnEnd(arg0_20, arg1_20)
	if arg1_20:GetTarget():IsMoving() then
		arg1_20:OnMoveState()
	else
		arg1_20:OnIdleState()
	end
