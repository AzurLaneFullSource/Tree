...
var0.Battle.SkillState = class("SkillState", var0.Battle.IUnitState)
var0.Battle.SkillState.__name = "SkillState"

local var2 = var0.Battle.SkillState
...
function var2.OnEnd(arg0, arg1)
	if arg1:GetTarget():IsMoving() then
		arg1:OnMoveState()
	else
		arg1:OnIdleState()
	end
