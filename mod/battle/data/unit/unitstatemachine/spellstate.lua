...
var0_0.Battle.SpellState = class("SpellState", var0_0.Battle.IUnitState)
var0_0.Battle.SpellState.__name = "SpellState"

local var2_0 = var0_0.Battle.SpellState
...
function var2_0.AddAttackState(arg0_5, arg1_5, arg2_5)
	if arg1_5:GetTarget():GetSpeed().x >= 0 then
