...
local var0_0 = ys
local var1_0 = class("AutoPilotRelativeBrownian", var0_0.Battle.IPilot)

var0_0.Battle.AutoPilotRelativeBrownian = var1_0
var1_0.__name = "AutoPilotRelativeBrownian"
...
function var1_0.Active(arg0_3, arg1_3)
	...
	local var0_3 = Clone(arg1_3:GetPosition())

	arg0_3._relativePoint = {
		X1 = arg0_3._randomPoint.X1 + var0_3.x,
		X2 = arg0_3._randomPoint.X2 + var0_3.x,
		Z1 = arg0_3._randomPoint.Z1 + var0_3.z,
		Z2 = arg0_3._randomPoint.Z2 + var0_3.z
	}
	arg0_3._referencePoint = var0_0.Battle.BattleFormulas.RandomPos(arg0_3._relativePoint)
...
function var1_0.GetDirection(arg0_4, arg1_4)
	...
	if var0_4.magnitude < 0.4 or arg0_4._randomCount > arg0_4._random then
		if arg0_4._move < arg0_4._moveCount then
			...
			local var1_4 = var0_0.Battle.BattleFormulas.RandomPos(arg0_4._relativePoint)
			local var2_4 = 0

			while Vector3.SqrDistance(var1_4, arg1_4) < 5 do
				var1_4 = var0_0.Battle.BattleFormulas.RandomPos(arg0_4._relativePoint)
				var2_4 = var2_4 + 1
			end
