...
var0.Battle.FreeBenchOxyState = class("FreeBenchOxyState", var0.Battle.IOxyState)
var0.Battle.FreeBenchOxyState.__name = "FreeBenchOxyState"

local var3 = var0.Battle.FreeBenchOxyState
...
function var3.DoUpdateOxy(arg0, arg1)
	arg1:OxyRecover(var0.Battle.OxyState.STATE_FREE_BENCH)
end
