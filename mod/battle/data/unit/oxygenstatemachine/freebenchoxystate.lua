...
var0_0.Battle.FreeBenchOxyState = class("FreeBenchOxyState", var0_0.Battle.IOxyState)
var0_0.Battle.FreeBenchOxyState.__name = "FreeBenchOxyState"

local var3_0 = var0_0.Battle.FreeBenchOxyState
...
function var3_0.DoUpdateOxy(arg0_6, arg1_6)
	arg1_6:OxyRecover(var0_0.Battle.OxyState.STATE_FREE_BENCH)
end
