...
var0.Battle.FreeFloatOxyState = class("FreeFloatOxyState", var0.Battle.IOxyState)
var0.Battle.FreeFloatOxyState.__name = "FreeFloatOxyState"

local var3 = var0.Battle.FreeFloatOxyState
...
function var3.DoUpdateOxy(arg0, arg1)
	arg1:OxyRecover(var0.Battle.OxyState.STATE_FREE_FLOAT)
end
