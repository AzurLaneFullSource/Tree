...
var0_0.Battle.FloatOxyState = class("FloatOxyState", var0_0.Battle.IOxyState)
var0_0.Battle.FloatOxyState.__name = "FloatOxyState"

local var3_0 = var0_0.Battle.FloatOxyState
...
function var3_0.DoUpdateOxy(arg0_6, arg1_6)
	arg1_6:OxyRecover(var0_0.Battle.OxyState.STATE_FLOAT)
end
...
function var3_0.UpdateDive(arg0_10)
	return true
end
