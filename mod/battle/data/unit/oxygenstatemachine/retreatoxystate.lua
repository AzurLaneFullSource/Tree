...
var0.Battle.RetreatOxyState = class("RetreatOxyState", var0.Battle.IOxyState)
var0.Battle.RetreatOxyState.__name = "RetreatOxyState"

local var3 = var0.Battle.RetreatOxyState
