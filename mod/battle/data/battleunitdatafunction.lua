...
function var33_0.AttachWeather(arg0_4, arg1_4)
	if table.contains(arg1_4, var1_0.WEATHER.NIGHT) then
		...
		if arg0_4:GetFleetVO() then
			...
			if table.contains(ShipType.VanguardShipType, var0_4) then
			...
			elseif table.contains(ShipType.MainShipType, var0_4) then
				var1_4:AttachCloak(arg0_4)
			elseif table.contains(ShipType.SubShipType, var0_4) then
		...
		elseif arg0_4:GetUnitType() == var1_0.UnitType.ENEMY_UNIT or arg0_4:GetUnitType() == var1_0.UnitType.MINION_UNIT or arg0_4:GetUnitType() == var1_0.UnitType.BOSS_UNIT then
			...
			if table.contains(ShipType.SubShipType, var0_4) then
...
function var33_0.SkillTranform(arg0_43, arg1_43)
	local var0_43 = var33_0.GetSkillDataTemplate(arg1_43)

	if not var0_43 then
		return arg1_43
	end

	local var1_43 = var0_43.system_transform

	if var1_43[arg0_43] == nil then
		return arg1_43
	else
		return var1_43[arg0_43]
	end
end
