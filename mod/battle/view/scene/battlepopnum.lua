...
local var2_0 = var0_0.Battle.BattlePopNum

var2_0.NUM_INIT_OFFSET = Vector3(0, 1.6, 0)

local var3_0 = Vector3(10000, 10000)
local var4_0 = Vector2(1, 1)
...
function var2_0.SetParent(arg0_3, arg1_3)
	arg0_3._tf:SetParent(arg1_3, false)
end

function var2_0.SetText(arg0_4, arg1_4)
	arg0_4.textCom.text = tostring(arg1_4)
end

function var2_0.SetReferenceCharacter(arg0_5, arg1_5, arg2_5)
	arg0_5._offsetVector.x = arg2_5.x

	local var0_5 = arg1_5:GetReferenceVector(arg0_5._offsetVector)

	var0_5:Add(var2_0.NUM_INIT_OFFSET)

	arg0_5._tf.position = var0_5
end

function var2_0.Play(arg0_6)
	arg0_6._animator.enabled = true
end

function var2_0.SetScale(arg0_7, arg1_7)
	arg0_7._tf.localScale = Vector2(arg1_7, arg1_7)
end

function var2_0.Init(arg0_8)
	arg0_8._go:SetActive(true)
end

function var2_0.Recycle(arg0_9)
	arg0_9._animator.enabled = false
	arg0_9._tf.position = var3_0
	arg0_9._tf.localScale = var4_0
end

function var2_0.Dispose(arg0_10)
