...
local var0_0 = ys
local var1_0 = singletonClass("BattleSupportCharacterFactory", var0_0.Battle.BattleCharacterFactory)

var0_0.Battle.BattleSupportCharacterFactory = var1_0
var1_0.__name = "BattleSupportCharacterFactory"
...
function var1_0.MakeCharacter(arg0_2)
	return var0_0.Battle.BattleSupportCharacter.New()
end
