...
local var3 = class("BattleGuildBossCommand", var0.Battle.BattleSingleDungeonCommand)

var0.Battle.BattleGuildBossCommand = var3
var3.__name = "BattleGuildBossCommand"
...
function var3.onInitBattle(arg0)
	...
	arg0._specificEnemyList = var0.Battle.BattleDataFunction.GetSpecificGuildBossEnemyList(var0.ActID, var0.StageTmpId)
end
...
function var3.calcDamageData(arg0)
	...
	arg0._dataProxy:CalcGuildBossEnemyInfo(var0.ActID)
end
