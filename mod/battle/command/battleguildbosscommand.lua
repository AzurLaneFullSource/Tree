...
local var3_0 = class("BattleGuildBossCommand", var0_0.Battle.BattleSingleDungeonCommand)

var0_0.Battle.BattleGuildBossCommand = var3_0
var3_0.__name = "BattleGuildBossCommand"
...
function var3_0.onInitBattle(arg0_7)
	...
	arg0_7._specificEnemyList = var0_0.Battle.BattleDataFunction.GetSpecificGuildBossEnemyList(var0_7.ActID, var0_7.StageTmpId)
end
...
function var3_0.calcDamageData(arg0_11)
	...
	arg0_11._dataProxy:CalcGuildBossEnemyInfo(var0_11.ActID)
end
