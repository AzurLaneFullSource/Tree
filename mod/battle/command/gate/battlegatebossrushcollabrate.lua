local var0_0 = class("BattleGateBossRushCollabrate")

ys.Battle.BattleGateBossRushCollabrate = var0_0
var0_0.__name = "BattleGateBossRushCollabrate"
...
function var0_0.Entrance(arg0_1, arg1_1)
	...
	local var4_1 = pg.battle_cost_template[SYSTEM_BOSS_RUSH_COLLABRATE]
	...
	BeginStageCommand.SendRequest(SYSTEM_BOSS_RUSH_COLLABRATE, var15_1, {
		var8_1
	}, var20_1, var21_1)
end

function var0_0.Exit(arg0_4, arg1_4)
	local var0_4 = pg.battle_cost_template[SYSTEM_BOSS_RUSH_COLLABRATE]
...
function var0_0.GetPreloadList(arg0_8)
	local var0_8, var1_8 = ys.Battle.BattleGateBossRush.GetPreloadList(arg0_8)
	local var2_8 = getProxy(ActivityProxy):getActivityById(arg0_8.actId):GetSeriesData()
	local var3_8 = var2_8:getConfig("aid_buff")

	if var2_8:GetBossHpRate() <= var3_8[1] then
		t = resMgr.GetResFromBuffIDList({
			var3_8[2]
		})

		for iter0_8, iter1_8 in ipairs(t) do
