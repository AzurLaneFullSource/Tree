...
local var3_0 = class("BattleWorldBossCommand", var0_0.Battle.BattleSingleDungeonCommand)

var0_0.Battle.BattleWorldBossCommand = var3_0
var3_0.__name = "BattleWorldBossCommand"
...
function var3_0.onInitBattle(arg0_7)
	...
	arg0_7._specificEnemyList = var0_0.Battle.BattleDataFunction.GetSpecificWorldJointEnemyList(var0_7.ActID, var0_7.bossConfigId, var0_7.bossLevel)
end
...
function var3_0.onPlayerShutDown(arg0_9, arg1_9)
	...
	if arg1_9.Data.unit == arg0_9._userFleet:GetFlagShip() and arg0_9._dataProxy:GetInitData().battleType ~= SYSTEM_PROLOGUE and arg0_9._dataProxy:GetInitData().battleType ~= SYSTEM_PERFORM then
		arg0_9._dataProxy:TriggerFinishBattle()
...
function var3_0.calcDamageData(arg0_11)
	...
	arg0_11._dataProxy:CalcWorldBossDamageInfo(var0_11.ActID, var0_11.bossConfigId, var0_11.bossLevel)
end
