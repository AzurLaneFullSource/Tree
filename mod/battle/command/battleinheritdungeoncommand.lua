...
local var3 = class("BattleInheritDungeonCommand", var0.Battle.BattleSingleDungeonCommand)

var0.Battle.BattleInheritDungeonCommand = var3
var3.__name = "BattleInheritDungeonCommand"
...
function var3.onInitBattle(arg0)
	...
	arg0._specificEnemyList = var0.Battle.BattleDataFunction.GetSpecificEnemyList(var0.ActID, var0.StageTmpId)
end
...
function var3.calcDamageData(arg0)
	...
	arg0._dataProxy:CalcActBossDamageInfo(var0.ActID)
end
