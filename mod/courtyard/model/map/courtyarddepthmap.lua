local var0 = class("CourtYardDepthMap")
...
function var0.SetAfterFunc(arg0, arg1)
	arg0.afterSortFunc = arg1
end

function var0.GetDepth(arg0, arg1, arg2)
	return arg0.depths[arg0:GetIndex(arg1, arg2)]
end

function var0.InsertChar(arg0, arg1)
...
function var0.CheckCharByIndex(arg0)
...
function var0.GetIndex(arg0, arg1, arg2)
	return (arg2 - 1) * arg0.sizeX + arg1
end

function var0.ResetDepth(arg0)
...
function var0.AddDepth(arg0, arg1, arg2, arg3)
	local var0 = arg0.depths
...
function var0.ModifyDepth(arg0, arg1)
	local var0 = arg0.depths
...
function var0.PlaceItem(arg0, arg1)
	local var0 = arg1.maxX
	local var1 = arg1.maxY
	local var2 = arg1.posX
	local var3 = arg1.posY
	local var4 = {}

	arg0.dependInfo[arg1] = var4

	for iter0, iter1 in ipairs(arg0.allItems) do
		if var2 <= iter1.maxX and var3 <= iter1.maxY then
			var4[#var4 + 1] = iter1
		elseif var0 >= iter1.posX and var1 >= iter1.posY then
			table.insert(arg0.dependInfo[iter1], arg1)
		end
	end

	table.insert(arg0.allItems, arg1)

	arg1.sortedFlag = arg0.sortedFlag

	arg0:SortAndCalcDepth()

	local var5 = arg0.afterSortFunc

	if var5 then
		var5(arg0.sortedItems)
	end
end

function var0.sortItemByDepth(arg0, arg1)
	return arg0.posZ > arg1.posZ
end

function var0.SortAndCalcDepth(arg0)
	local var0 = {}
	...
	table.sort(var0, var0.sortItemByDepth)
end

function var0.AddItemAndDepend(arg0, arg1)
	...
	assert(arg1.sortedFlag ~= sortedFlag, "依赖关系产生了循环！")
